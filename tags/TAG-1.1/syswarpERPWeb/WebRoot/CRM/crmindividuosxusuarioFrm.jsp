...
<html>
<%-- INSTANCIAR BEAN --%>  
<jsp:useBean id="BCF"  class="ar.com.syswarp.web.ejb.BeanCrmindividuosxusuarioFrm"   scope="page"/>
<head>
...
function cambiarAccion(){
  window.location='crmindividuosxusuarioFrm.jsp' ;
}
...
<div id="popupcalendar" class="text"></div>
 ...
 BCF.setUsu( session.getAttribute("usuario").toString() ); 
 BCF.ejecutarValidacion();
 String titulo = BCF.getAccion().toUpperCase() + " DE Gestion de individuos" ; 
 %>
<form action="crmindividuosxusuarioFrm.jsp" method="post" name="frm">
     ...
     <tr>
       <td>
         <table width="100%"  border="0" cellspacing="0" cellpadding="0" align="center">
            ...
            <td>&nbsp;<%= titulo %>  
						<% if (BCF.getAccion().equalsIgnoreCase("Modificacion")){%>
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="94%">
									 <table width="69" border="0" cellspacing="0">
                    <tr>
                      <td width="22"><img src="../imagenes/default/gnome_tango/apps/config-users.png" width="22" height="22" border="0" alt="Familiares" onClick="mostrarLOVDETA('crmfamiliaresxusuarioAbm.jsp?idindividuos=<%=BCF.getIdindividuos()%>&razon_nombre=<%=str.esNulo(BCF.getRazon_nombre())%>')" style="cursor:pointer" ></td>
                      <td width="22"><img src="../imagenes/default/gnome_tango/apps/calc.png" width="22" height="22" border="0" alt="Cotizaciones" onClick="mostrarLOVDETA('crmcotizacionesxusuarioAbm.jsp?idindividuos=<%=BCF.getIdindividuos()%>&razon_nombre=<%=str.esNulo(BCF.getRazon_nombre())%>')" style="cursor:pointer" ></td>
                      <td width="19"><img src="../imagenes/default/gnome_tango/phone.jpg" width="19" height="19" border="0" alt="Llamadas" onClick="mostrarLOVDETA('crmllamadosxusuarioAbm.jsp?idindividuos=<%=BCF.getIdindividuos()%>&razon_nombre=<%=str.esNulo(BCF.getRazon_nombre())%>')" style="cursor:pointer" ></td>
                    </tr>
                   </table>
									</td>
                  <td width="6%"><img src="../imagenes/default/btn_add_over.gif" alt="Nuevo Registro" width="22" height="21" border="0" style="cursor:pointer" onClick="cambiarAccion();"></a></td>
                </tr>
              </table>
							<%}%>
							</td>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
              ...
              <tr class="fila-det">
                ...
                <td width="74%" class="fila-det-border"><input name="razon_nombre" type="text" value="<%=str.esNulo(BCF.getRazon_nombre())%>" class="campo" size="50" maxlength="100"  ></td>
              </tr>
              <tr class="fila-det">
                <td width="26%" class="fila-det-border">Telefonos particular: (*) </td>
                <td width="74%" class="fila-det-border"><input name="telefonos_part" type="text" class="campo" value="<%=str.esNulo(BCF.getTelefonos_part())%>" size="50" maxlength="70"></td>
              </tr>
              <tr class="fila-det">
              ...
              <tr class="fila-det">
                ...
                <td width="74%" class="fila-det-border"><input name="domicilio_part" type="text" class="campo" value="<%=str.esNulo(BCF.getDomicilio_part())%>" size="50" maxlength="70"></td>
              </tr>
              <tr class="fila-det">
...
<a class="so-BtnLink" href="javascript:calClick();return false;"
              ...
              <tr class="fila-det">
                ...
                <td width="74%" class="fila-det-border"><input name="domicilio_laboral" type="text" class="campo" value="<%=str.esNulo(BCF.getDomicilio_laboral())%>" size="50" maxlength="70"></td>
              </tr>
              <tr class="fila-det">
                <td width="26%" class="fila-det-border">Telefonos empresa:  </td>
                <td width="74%" class="fila-det-border"><input name="telefonos_empr" type="text" class="campo" value="<%=str.esNulo(BCF.getTelefonos_empr())%>" size="50" maxlength="70"></td>
              </tr>
              <tr class="fila-det">
              ...
              <tr class="fila-det">
                ...
                <td width="74%" class="fila-det-border"><input name="deportes" type="text" value="<%=str.esNulo(BCF.getDeportes())%>" class="campo" size="50" maxlength="100"  ></td>
              </tr>
              <tr class="fila-det">
                <td width="26%" class="fila-det-border">Hobbies:  </td>
                <td width="74%" class="fila-det-border"><input name="hobbies" type="text" value="<%=str.esNulo(BCF.getHobbies())%>" class="campo" size="50" maxlength="100"  ></td>
              </tr>
              <tr class="fila-det">
                <td width="26%" class="fila-det-border">Actividad social:  </td>
                <td width="74%" class="fila-det-border"><input name="actividad_social" type="text" value="<%=str.esNulo(BCF.getActividad_social())%>" class="campo" size="50" maxlength="100"  ></td>
              </tr>
              <tr class="fila-det">
                <td width="26%" class="fila-det-border">Diario lectura:  </td>
                <td width="74%" class="fila-det-border"><input name="diario_lectura" type="text" value="<%=str.esNulo(BCF.getDiario_lectura())%>" class="campo" size="50" maxlength="30"  ></td>
              </tr>
              <tr class="fila-det">
                <td width="26%" class="fila-det-border">Revista lectura:  </td>
                <td width="74%" class="fila-det-border"><input name="revista_lectura" type="text" value="<%=str.esNulo(BCF.getRevista_lectura())%>" class="campo" size="50" maxlength="30"  ></td>
              </tr>
              <tr class="fila-det">
                <td width="26%" class="fila-det-border">Lugar veraneo:  </td>
                <td width="74%" class="fila-det-border"><input name="lugar_veraneo" type="text" value="<%=str.esNulo(BCF.getLugar_veraneo())%>" class="campo" size="50" maxlength="100"  ></td>
              </tr>
              <tr class="fila-det">
                <td class="fila-det-border">Datos Vehiculo </td>
                <td class="fila-det-border"><input name="datosvehiculo" type="text" class="campo" id="datosvehiculo" value="<%=str.esNulo(BCF.getDatosvehiculo())%>" size="50" maxlength="100"  ></td>
              </tr>
              <tr class="fila-det">
                <td width="26%" class="fila-det-border">Obseravaciones:  </td>
                <td width="74%" class="fila-det-border"><textarea name="obseravaciones" cols="70" rows="3" class="campo"><%=str.esNulo(BCF.getObseravaciones())%></textarea></td>
              </tr>
              <tr class="fila-det">
