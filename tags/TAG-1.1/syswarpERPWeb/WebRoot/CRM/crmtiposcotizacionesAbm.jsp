...
/*  
   Grilla para la entidad: crmtiposcotizaciones
...
String color_fondo ="";
String titulo = "Tipos de cotizacion";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterCrmtiposcotizaciones   = null;
...
%>
<html>
<jsp:useBean id="BCA"  class="ar.com.syswarp.web.ejb.BeanCrmtiposcotizacionesAbm"   scope="page"/>
...
tituCol[0] = "Codigo";
tituCol[1] = "Tipo cotizacion";
tituCol[2] = "idempresa";
tituCol[3] = "Valor Unidad Sup.";
java.util.List Crmtiposcotizaciones = new java.util.ArrayList();
Crmtiposcotizaciones= BCA.getCrmtiposcotizacionesList();
iterCrmtiposcotizaciones = Crmtiposcotizaciones.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="crmtiposcotizacionesAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
     ...
     <td width="57%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[1]%></td>
     <td width="33%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[3]%></td>	 
</tr>
   <%int r = 0; 
   while(iterCrmtiposcotizaciones.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterCrmtiposcotizaciones.next(); 
      // estos campos hay que setearlos segun la grilla 
      if (color_fondo.equals("fila-det-verde")) color_fondo = "fila-det";
      else color_fondo = "fila-det-verde";%>
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="idtipocotizacion" value="<%= sCampos[0]%>"></td>
