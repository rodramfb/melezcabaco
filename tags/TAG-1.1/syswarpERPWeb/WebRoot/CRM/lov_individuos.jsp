...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanCrmindividuosAbm"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idindividuos, razon_nombre){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idindividuos)
			break;
	opener.document.forms[i].idindividuos.value = idindividuos;
	opener.document.forms[i].razon_nombre.value = razon_nombre; 
	window.close();
}
 </script>
</head>
...
tituCol[0] = "Codigo";
tituCol[1] = "Razon nombre";

java.util.List individuos = new java.util.ArrayList();
individuos= BFFF.getCrmindividuosList();
iterIndividuos = individuos.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_individuos.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   while(iterIndividuos.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterIndividuos.next(); 
