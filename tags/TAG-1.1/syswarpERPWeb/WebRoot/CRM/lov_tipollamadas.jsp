...
String color_fondo ="";
String titulo = "Tipo llamadas";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterTipollamadas   = null;
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanCrmtiposllamadasAbm"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idtipollamada, tipollamada){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idtipollamada)
			break;
	opener.document.forms[i].idtipollamada.value = idtipollamada;
	opener.document.forms[i].tipollamada.value = tipollamada; 
	window.close();
}
 </script>
</head>
...
java.util.List tipollamada = new java.util.ArrayList();
tipollamada= BFFF.getCrmtiposllamadasList();
iterTipollamadas = tipollamada.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_tipollamadas.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterTipollamadas.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterTipollamadas.next(); 
