...
<html>
<%-- INSTANCIAR BEAN --%>   
<jsp:useBean id="BCF"  class="ar.com.syswarp.web.ejb.BeanCrmresultadoscotizacionesFrm"   scope="page"/>
<head>
...
<div id="popupcalendar" class="text"></div>
 ...
 <% 
 String titulo = BCF.getAccion().toUpperCase() + " DE Resultados de cotizaciones" ;
 ...
 %>
<form action="crmresultadoscotizacionesFrm.jsp" method="post" name="frm">
<input name="accion" type="hidden" value="<%=BCF.getAccion()%>" >
<input name="idresultadocotizacion" type="hidden" value="<%=BCF.getidresultadocotizacion()%>" >
       ...
       <td>
         <table width="100%"  border="0" cellspacing="0" cellpadding="0" align="center">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
              ...
              <tr class="fila-det">
                <td width="30%" class="fila-det-border">Resultado cotizacion: (*) </td>
              <td width="70%" class="fila-det-border"><input name="resultadocotizacion" type="text" value="<%=BCF.getresultadocotizacion() %>" class="campo" size="50" maxlength="50"  ></td>
              </tr>
              <tr class="fila-det">
              <tr class="fila-det">
                <td class="fila-det-border">&nbsp;</td>
