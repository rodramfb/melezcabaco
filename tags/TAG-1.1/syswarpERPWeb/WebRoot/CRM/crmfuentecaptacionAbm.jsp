...
/*  
   Grilla para la entidad: crmfuentecaptacion
...
String color_fondo ="";
String titulo = "Fuentes de Captacion";
...
%>
<html>
<jsp:useBean id="BCA"  class="ar.com.syswarp.web.ejb.BeanCrmfuentecaptacionAbm"   scope="page"/>
...
tituCol[0] = "Codigo";
tituCol[1] = "Fuente";
tituCol[2] = "C.C. Presupuesto";
tituCol[3] = "C.C. Contrapartida";
java.util.List Crmfuentecaptacion = new java.util.ArrayList();
Crmfuentecaptacion= BCA.getCrmfuentecaptacionList();
iterCrmfuentecaptacion = Crmfuentecaptacion.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="crmfuentecaptacionAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="idfuente" value="<%= sCampos[0]%>"></td>
