...
Objetivo: Grilla de cuentas contables
Sistema : Syswarp ERP
...
String action = "CONTABLEccontables.jsp";
String formulario = "frmCONTABLEccontables.jsp";
...
String fechaalt   = "";
String fechaact   = "";
String ayudalink  = "ayuda.jsp?idayuda=1";  // link a las ayudas en linea de cada punto
...
tituCol[5] = "Ajustable";
tituCol[6] = "Resultado";
tituCol[7] = "Centro de Costo 1";
tituCol[8] = "Centro de Costo 2";
tituCol[9] = "Audit";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class=color-tabletrim>
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
    <tr class="fila-encabezado">
      ...
      <td width="20%" onClick="javascript:sortTable(<%=totCol+1-4%>, rsTable);"><%=tituCol[2]%></td>
      <td width="7%"  onClick="javascript:sortTable(<%=totCol+1-4%>, rsTable);"><%=tituCol[3]%></td>
      <td width="8%"  onClick="javascript:sortTable(<%=totCol+1-4%>, rsTable);"><%=tituCol[4]%></td>
      <td width="10%" onClick="javascript:sortTable(<%=totCol+1-4%>, rsTable);"><%=tituCol[5]%></td>
      <td width="10%" onClick="javascript:sortTable(<%=totCol+1-4%>, rsTable);"><%=tituCol[6]%></td>
      <td width="11%" onClick="javascript:sortTable(<%=totCol+1-4%>, rsTable);"><%=tituCol[7]%></td>
      <td width="12%" onClick="javascript:sortTable(<%=totCol+1-4%>, rsTable);"><%=tituCol[8]%></td>
      <td width="6%"  onClick="javascript:sortTable(<%=totCol+1-4%>, rsTable);"><%=tituCol[9]%></td>
	    </tr>
    <%int r = 0;
    while(iterCuentas.hasNext()){      
	 ...
	 if ( r >= posIni && r <= posFin ){
	    ...
	    String cmp_codigo = sCampos[0];
	           usuarioalt = sCampos[8] ;
	           usuarioact = sCampos[9] ;
	           fechaalt   = sCampos[10] ;
   	         fechaact   = sCampos[11] ;	 
