...
/*
Programa reportesTablasAbm.jsp
...
String color_fondo ="";
String titulo = "TABLAS ASOCIADAS AL REPORTE ";
...
<html>
  <jsp:useBean id="BRTA"  class="ar.com.syswarp.web.ejb.report.BeanReportesTablasAbm"   scope="page"/>
<head>
...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
  ...
  EJECUTAR SETEO DE PROPIEDADES
	--%>
  <jsp:setProperty name="BRTA" property="*" />  	
  <%  
  BRTA.setResponse(response);    
	BRTA.setRequest(request);  		
  BRTA.ejecutarValidacion();
	%>
<%
...
<form action="reportesTablasAbm.jsp" method="POST" name="frm">
     <table width="100%" border="0" cellspacing="0" cellpadding="0" class=color-tabletrim>
	      <tr class="text-globales">
          <td width="100%" height="24" colspan="10" background="imagenes/dialogtop.gif">
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td colspan="2"  class="text-globales"><%=titulo + ": " +  BRTA.getReporte() %></td>
              </tr>
              <tr>
                    ...
                    <tr>    
                      ...
                      <td width="54%"><input type="submit" name="volver_reportes" value="Volver" class="boton"></td>
                    </tr>
                  </table>
								</td>
                <td width="81%">
									<table width="100%" border="0">
										<tr> 
											...
											<td width="3%"> 
                        <input name="ocurrencia" type="hidden" value="<%=BRTA.getOcurrencia()%>" id="ocurrencia" size="30" maxlength="30">                      </td>
											<td width="95%"> 
														...
														<td>
															<table width="100%" border="0" cellpadding="0" cellspacing="0">
																<tr class="text-globales">
																	...
																	<td width="30%" >&nbsp;Total de registros:&nbsp;<%=BRTA.getTotalRegistros()%>  </td>
																	...
																	<td width="15%" > 
																		<select name="limit" >
																			<%for(i=15; i<= 150 ; i+=15){%>
																			 ...
																			 <%}
																			 if( i >= BRTA.getTotalRegistros() ) break;
																			 %>
																			<%}%>
																			<option value="<%= BRTA.getTotalRegistros()%>">Todos</option>
																		</select> 
																	</td>
																	<td width="11%">&nbsp;P&aacute;gina:</td>
																	<td width="16%"> 
																	<select name="paginaSeleccion" >
																			<%for(i=1; i<= BRTA.getTotalPaginas(); i++){%>
																			<%if ( i==BRTA.getPaginaSeleccion() ){%>
																					<option value="<%=i%>" selected><%=i%></option>
																			<%}else{%>
																					<option value="<%=i%>"><%=i%></option>
																				<%}%>
		...
		<table width="100%"  border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td class="fila-det-bold-rojo"><jsp:getProperty name="BRTA" property="mensaje"/>&nbsp;</td>
			</tr>
		</table>
  ...
  <%int r = 0;
    while(iterTablas.hasNext()){      
	    ...
	    if (color_fondo.equals("fila-det-verde")) color_fondo = "fila-det";
			...
			<tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
				<td class="fila-det-border" ><input type="radio" name="idtabla" value="<%= sCampos[0]%>"></td>
    ...
    <%
		...
		<input name="idreporte" value="<%= BRTA.getIdreporte() %>" type="hidden">
</form>
</body>
</html>
<% 
