				 ...
				 <tr > 
						<td class="fila-det-border" >
							<table width="100%"  border="1" cellspacing="0" cellpadding="0">
								...
								<tr>
									<td width="54%" height="21" class="fila-det"> Tipo: <%=sCampos[5]%> (<%=sCampos[4]%>) </td>
								  <td width="7%" class="fila-det"><div align="center">Unidad</div></td>
								  <td width="8%" class="fila-det"><div align="center">Total</div></td>
								  <td width="7%" class="fila-det"><div align="center">Parcial</div></td>
								  <td width="8%" class="fila-det"><div align="center">Total</div></td>
								  <td width="8%" class="fila-det"><div align="center">Existente</div></td>
								  <td width="8%" class="fila-det"><div align="center">Excedente</div></td>
							  </tr>
								<tr>
									<td class="fila-det">C&oacute;digo: <%=sCampos[2]%></td> 
								  <td width="7%" class="fila-det"><div align="right"><%=sCampos[6]%></div></td>
								  <td width="8%" class="fila-det"><div align="right"><%=sCampos[7]%></div></td>
								  <td width="7%" class="fila-det"><div align="right"><%=sCampos[8]%></div></td>
								  <td width="8%" class="fila-det"><div align="right"><%=sCampos[9]%></div></td>
								  <td width="8%" class="<%=Double.parseDouble(sCampos[10])<0 ? "fila-det-bold-rojo": "fila-det" %>"><div align="right"><%=sCampos[10]%></div></td>
								  <td width="8%" class="<%=Double.parseDouble(sCampos[11])<0 ? "fila-det-bold-rojo": "fila-det" %>"><div align="right"><%=sCampos[11]%></div></td>
							  </tr>							
								<tr class="fila-det">
