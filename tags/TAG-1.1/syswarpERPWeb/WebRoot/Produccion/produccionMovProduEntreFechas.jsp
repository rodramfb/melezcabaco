...
String color_fondo ="";
String titulo = "ORDENES DE PRODUCCION ENTRE FECHAS";
...
%>
<html>
<jsp:useBean id="BPMPA"  class="ar.com.syswarp.web.ejb.BeanProduccionMovProduEntreFechas"   scope="page"/>
...
<form action="produccionMovProduEntreFechas.jsp" method="POST" name="frm" onSubmit="evitarCheck();">
                ...
                <tr>
                  <td width="89%" height="38">
                     <table width="100%" border="0">
                                  ...
                                  <td>
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                       <tr class="text-globales">
                                         ...
                                         <td width="47%">&nbsp;Total de registros:&nbsp;<%=BPMPA.getTotalRegistros()%></td>
                        ...
                        <tr>
                          <td height="26" class="text-globales">F. Emisi&oacute;n Desde: </td>
                          <td height="26" class="text-globales"><input class="campo" onFocus="this.blur()" size="12" readonly type="text" name="fechaDesde" value="<%=BPMPA.getFechaDesde()%>" maxlength="12">
                        ...
                        <tr>
                          <td height="26" class="text-globales">F. Emisi&oacute;n Hasta:</td>
                          <td height="26" class="text-globales"><input class="campo" onFocus="this.blur()" size="12" readonly type="text" name="fechaHasta" value="<%=BPMPA.getFechaHasta()%>" maxlength="12">
                            <a class="so-BtnLink" href="javascript:calClick();return false;"
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
     ...
     <td width="8%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);">%</td>
   ...
   while(iterProduccionMovProdu.hasNext()){
      ...
      if (color_fondo.equals("fila-det-verde")) color_fondo = "fila-det";
			...
			float realizado = Float.parseFloat( gb.getNumeroFormateado(Float.parseFloat(sCampos[3]) , 10, 2) );
			float estimado = Float.parseFloat( gb.getNumeroFormateado(Float.parseFloat(sCampos[4]), 10, 2 ) );
			float xciento  =  100 ;
			float porcentaje =  Float.parseFloat( gb.getNumeroFormateado( (realizado*xciento)/estimado , 10,2 ));
			%>
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><%=sCampos[0]%>&nbsp;</td> 
      <td class="fila-det-border" ><%=sCampos[8]%>&nbsp;</td>
      <td class="fila-det-border" ><%=sCampos[9]%>&nbsp;</td>  
      <td class="fila-det-border" ><%=realizado%>&nbsp;</td>
      <td class="fila-det-border" ><%=estimado%>&nbsp;</td>
