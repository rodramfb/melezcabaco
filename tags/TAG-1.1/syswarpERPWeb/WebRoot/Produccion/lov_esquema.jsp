...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(esquemadesde, d_esquemadesde){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].esquemadesde)
			break;
	if(opener.document.forms[i].esquemadesde)		
	  opener.document.forms[i].esquemadesde.value = esquemadesde;
  if(opener.document.forms[i].d_esquemadesde)		
	  opener.document.forms[i].d_esquemadesde.value = d_esquemadesde; 
	window.close();
}
 </script>
</head>
...
<form action="lov_esquema.jsp" method="POST" name="frm">
