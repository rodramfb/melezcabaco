...
<html>
<%-- INSTANCIAR BEAN --%>  
<jsp:useBean id="BPAO"  class="ar.com.syswarp.web.ejb.BeanProduccionAnulaOrden"   scope="page"/>
<head>
 <title></title>
...
<div id="popupcalendar" class="text"></div>
 ...
 <% 
 String titulo = "ANULACION DE ORDEN DE PRODUCCION: " ;
 ...
 %>
<form action="produccionAnulaOrden.jsp" method="post" name="frm">
