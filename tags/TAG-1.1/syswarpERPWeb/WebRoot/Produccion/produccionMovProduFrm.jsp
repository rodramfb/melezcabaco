...
<html>
<%-- INSTANCIAR BEAN --%>  
<jsp:useBean id="BPMPF"  class="ar.com.syswarp.web.ejb.BeanProduccionMovProduFrm"   scope="page"/>
<head>
...
<div id="popupcalendar" class="text"></div>
 ...
 <% 
 String titulo = BPMPF.getAccion().toUpperCase() + " DE ORDENES DE PRODUCCION" ;
 ...
 %>
<form action="produccionMovProduFrm.jsp" method="post" name="frm">
              ...
              <tr class="text-catorce">
                ...
                <td >
                    ...
                    <tr class="text-catorce"> 
                      ...
                      <td width="13%"> <img src="../imagenes/default/gnome_tango/actions/document-print-preview.png" width="22" height="22" onClick="abrirVentana('produccionCalculoNecesidadFrame.jsp?idop=<%= BPMPF.getIdop()%>&tipoPedido=N');" style="cursor:pointer" title="Impresi&oacute;n de orden con costos inclu&iacute;dos."></td>
                      <td width="39%"><div align="right">Sin Costos&nbsp; </div> </td>
                      <td width="9%"> <img src="../imagenes/default/gnome_tango/devices/yast_printer.png" width="22" height="22" onClick="abrirVentana('produccionCalculoNecesidadSinCostoFrame.jsp?idop=<%= BPMPF.getIdop()%>&tipoPedido=N');" style="cursor:pointer" title="Impresi&oacute;n de orden sin costos."></td>
                    </tr>
                  </table>
								</td> 
                <td >&nbsp;</td>
