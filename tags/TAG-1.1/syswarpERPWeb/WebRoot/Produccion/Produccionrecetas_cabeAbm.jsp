...
/* 
   Grilla para la entidad: produccionRecetas_cabe
...
String color_fondo ="";
String titulo = "RECETAS DE PRODUCCION";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterProduccionRecetas_cabe   = null;
...
%>
<html>
<jsp:useBean id="BPRA"  class="ar.com.syswarp.web.ejb.BeanProduccionrecetas_cabeAbm"   scope="page"/>
...
tituCol[1] = "Articulo";
tituCol[2] = "Receta de producción";
tituCol[3] = "Medida";
java.util.List ProduccionRecetas_cabe = new java.util.ArrayList();
ProduccionRecetas_cabe= BPRA.getProduccionRecetas_cabeList();
iterProduccionRecetas_cabe = ProduccionRecetas_cabe.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="Produccionrecetas_cabeAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterProduccionRecetas_cabe.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterProduccionRecetas_cabe.next(); 
      // estos campos hay que setearlos segun la grilla 
      if (color_fondo.equals("fila-det-verde")) color_fondo = "fila-det";
      else color_fondo = "fila-det-verde";%>
   <%
     String imagen_detalle = "imagenes/default/gnome_tango/categories/package_settings.png";
     if (!sCampos[8].equalsIgnoreCase("0"))
        imagen_detalle = "imagenes/default/gnome_tango/categories/redhat-system_tools.png";
   %>
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      ...
      <td class="fila-det-border" ><img src="<%=imagen_detalle%>" width="22" height="22" border="0" title="Administrar detalle de la receta de produccion" onClick="mostrarLOVDETA('Produccionrecetas_detaAbm.jsp?codigo_st_cabe=<%=sCampos[0]%>&descrip_st=<%=sCampos[1]%>')" style="cursor:pointer" ></td>
