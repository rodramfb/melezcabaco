...
<html>
<%-- INSTANCIAR BEAN --%>  
<jsp:useBean id="BPMPAF"  class="ar.com.syswarp.web.ejb.BeanProveedoMovProvAsientoFrmUpd"   scope="page"/>
<head>
...
<div id="popupcalendar" class="text"></div>
 ...
 BPMPAF.setEjercicioActivo( Integer.parseInt(  session.getAttribute("ejercicioActivo").toString()  )  ); 
 BPMPAF.ejecutarValidacion();
 // EJV 20081103 - SIN USO APRARENTE
 //Hashtable htCP = BPMPAF.getHtCP();
 //Enumeration enumCP = htCP.keys();
 
 Hashtable htStock = new Hashtable();
 %>
<form action="proveedoMovProvAsientoFrmUpd.jsp" method="post" name="frm">
  <div align="right">
  <input name="accion" type="hidden" value="<%=BPMPAF.getAccion()%>" >
  <input name="nrointerno" type="hidden" value="<%=BPMPAF.getNrointerno()%>" >
	<input name="iniciarDatosAsiento" type="hidden" value="false" >
...
<input name="dproveedor"  type="hidden" value="<%=BPMPAF.getDproveedor()%>" ></td>
                ...
                <tr class="fila-det-bold">
                  ...
                  <td class="fila-det-border"><%=  BPMPAF.getDcondicionpago() %>
<input name="idcondicionpago" type="hidden" value="<%=BPMPAF.getIdcondicionpago().longValue()%>"  >
<input name="dcondicionpago" type="hidden" value="<%=BPMPAF.getDcondicionpago()%>"  ></td>
                  <td class="fila-det-border">Factura Stock:</td>
<td class="fila-det-border"><%=  BPMPAF.getStock_fact() %></td>
                </tr>
                <tr class="fila-det-bold"> 
                <td height="25" class="fila-det-border">Fecha movimiento:</td>
                  <td class="fila-det-border"><%=BPMPAF.getFechamov()%> <input  type="hidden" name="fechamov" value="<%=BPMPAF.getFechamov()%>" >&nbsp;</td>
                  <td class="fila-det-border">Fecha Vencimiento:</td>
<td class="fila-det-border"><%= BPMPAF.getFechavto () %><input  type="hidden" name="fechavto" value="<%=BPMPAF.getFechavto()%>" >&nbsp;</td>
<td width="0%" class="fila-det-border">&nbsp;</td>
   ...
   if(BPMPAF.getTipomovs().equalsIgnoreCase("C")) out.write("C"); %></td>
                ...
                <td width="34%" class="fila-det-border"><%=BPMPAF.getObservacionesContables()%>&nbsp;</td>
              ...
              <tr class="text-globales" height="3">
                ...
                <td colspan="4" class="fila-det-border" ></td>
							  ...
							  <% 
									...
									//if( !str.esNulo(BPMPAF.getStock_fact()).equalsIgnoreCase("N") ||  BPMPAF.getTipomov().intValue()== 3) {
									if( 1!=1) {%>								 
                <tr >
							  ...
							  <% 
									...
									if(BPMPAF.getStock_fact().equalsIgnoreCase("S") || session.getAttribute("htArticulosConfirmados") != null){%>
                ...
                <tr class="fila-det"> 
								  ...
								  <td colspan="3" class="fila-det-border">
								    <table width="100%" border="0">
											<tr>
												<td width="8%">&nbsp;</td>
												<td width="16%"><div align="right"><span class="fila-det"><%=BPMPAF.getSubTotalGravado()+""%></span>
...
<input name="porcentajeBonificacion" type="hidden" class="campo" id="porcentajeBonificacion" value="<%=BPMPAF.getPorcentajeBonificacion()%>" size="7" maxlength="6"  >
												%</td>
												<td width="16%"><div align="right"><span class="fila-det"><%=BPMPAF.getBonificacion()+""%></span>
                          <input name="bonificacion" type="hidden" value="<%=BPMPAF.getBonificacion()%>" class="campo" size="20" maxlength="20"  readonly >
											  </div></td>
											  <td width="76%">&nbsp;</td>
											</tr>
										</table>									</td>
                ...
                <tr class="fila-det">
								...
								<td colspan="3" class="fila-det-border">
									<table width="100%" border="0" cellpadding="0" cellspacing="0">
										<tr>
											<td width="8%">&nbsp;</td>
											<td width="16%"><div align="right"><span class="fila-det"><%=BPMPAF.getNetoGravado()+""%></span>
              ...
              <tr class="fila-det">
								...
								<td colspan="3" class="fila-det-border">
										<table width="100%" border="0" cellpadding="0" cellspacing="0">
											<tr>
												<td width="8%">&nbsp;</td>
												<td width="16%"><div align="right"><span class="fila-det"><%=BPMPAF.getNetoExento()+""%></span>
              ...
              <tr  height="10" class="permiso-cinco">
                  ...
                  <td width="16%" class="fila-det-border">IVA :  </td>
									...
									<table width="100%" border="0" cellpadding="0" cellspacing="0">
										<tr>
											...
											%</td>
											<td width="16%"><div align="right"><span class="fila-det"><%=BPMPAF.getIva()+""%></span>
									...
									<table width="100%" border="0" cellpadding="0" cellspacing="0">
										<tr>
									      ...
									      <input name="provPorcEspecialIvaPercep" type="hidden" class="campo" id="provPorcEspecialIvaPercep" value="<%=BPMPAF.getProvPorcEspecialIvaPercep()%>" >
											%</td>
											<td width="16%"><div align="right"><span class="fila-det"><%=BPMPAF.getPercepcionIva()+""%></span>
                ...
                <td colspan="3" class="fila-det-border">
									<table width="100%" border="0" cellpadding="0" cellspacing="0">
										<tr>
											<td width="8%">&nbsp;</td>
											<td width="16%"><div align="right"><span class="fila-det"><%=Common.getNumeroFormateado(BPMPAF.getImporte().doubleValue(), 10, 2)%></span>
										    <input name="importe" type="hidden" value="<%=Common.getNumeroFormateado(BPMPAF.getImporte().doubleValue(), 10, 2)%>">
											  </div></td>
                      <td width="76%">&nbsp;</td>
										</tr>
									</table>									</td>
									...
									<table width="100%" border="0" cellpadding="0" cellspacing="0">
										...
										<tr >
										  ...
										  <td width="80%" class="text-globales">
											  ...
											  <a href="javascript:abreVentana('lov_cuentas_gravadoUpd.jsp?TNGravado=<%= BPMPAF.getNetoGravado() %>', 700, 500)"><img src="../imagenes/default/gnome_tango/actions/gnome-searchtool.png" width="18" height="18" title="Cuentas" border="0"></a>
												<% 
												//} %>&nbsp;											</td>
										</tr>
											...
											<td colspan="2">
												<table width="100%" border="0" cellpadding="0" cellspacing="0">
													<tr  class="fila-det">
														...
														<td width="20%" class="fila-det-bold"><div align="right">Debe														</div></td>			
														<td width="20%" class="fila-det-bold"><div align="right">Haber														</div></td>																										
													</tr>
													<tr >
                         ...
                         <% 
												 ...
												 %>
													<tr class="fila-det">
														...
														<td class="fila-det-border"><div align="right"><%= tipomov != 3 ? datosAsiento[2]  : "0"%></div></td>
														<td class="fila-det-border"><div align="right"><%= tipomov == 3 ? datosAsiento[2]  : "0" %></div></td>				
													</tr>
											<%
												 }  
										...
										<tr>
										  ...
										  <td class="text-globales" ><a href="javascript:abreVentana('lov_cuentas_exentoUpd.jsp?TNExento=<%= BPMPAF.getNetoExento() %>', 700, 500)"><img src="../imagenes/default/gnome_tango/actions/gnome-searchtool.png" width="18" height="18" title="Cuentas" border="0"></a></td>
										</tr>
										<tr>
											<td colspan="2">
												<table width="100%" border="0" cellpadding="0" cellspacing="0">
												 ...
												 %>
													<tr class="fila-det">
														...
														<td class="fila-det-border">
														  <div align="right"><%= tipomov == 3 ? datosAsiento[2]  : "0" %></div></td>				
													</tr>
											<%
												 }  
											%>
                         ...
                         <%
												 ...
												 while(enumIVATotal.hasMoreElements()){
												   ...
												   String [] datosAsiento = (String [])htIvaTotal.get(keyAsiento); 
													 //for(int x =0;x<datosAsiento.length;x++) System.out.println("PAGE datosAsiento["+x+"]: " + datosAsiento[x]);
													 
												 %>
													<tr class="fila-det">
														<td class="fila-det-border"><%= datosAsiento[0] + " - " + datosAsiento[1]%>&nbsp;</td>
														<td class="fila-det-border"><div align="right"><%= ( datosAsiento[3].equalsIgnoreCase("T") ?  (tipomov == 3 ? datosAsiento[2]  : "0" ) : (tipomov != 3 ? datosAsiento[2]  : "0" ))%></div></td>
														<td class="fila-det-border"><div align="right"><%= (!datosAsiento[3].equalsIgnoreCase("T") ? (tipomov == 3 ? datosAsiento[2]  : "0" ) : (tipomov != 3 ? datosAsiento[2]  : "0" ))%></div></td>
													</tr>
											<%
												 }  
                  ...
                  <td height="35" class="fila-det-border">&nbsp;</td>
                	<td colspan="3" class="fila-det-border">
										<table width="100%" border="0">
											<tr>
												<td width="15%">&nbsp;</td>
												<td width="85%"><input name="aceptar" type="submit" value="Aceptar Modificación" class="boton">
