...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idretencion4, d_idretencion4){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idretencion4)
			break;
	opener.document.forms[i].idretencion4.value = idretencion4;
	opener.document.forms[i].d_idretencion4.value = d_idretencion4; 
	window.close();
}
 </script>
</head>
...
<form action="lov_retenciones4.jsp" method="POST" name="frm">
