...
<html>
<%-- INSTANCIAR BEAN --%>  
<jsp:useBean id="BPMPAF"  class="ar.com.syswarp.web.ejb.BeanProveedoMovProvAsientoFrm"   scope="page"/>
<head>
...
<div id="popupcalendar" class="text"></div>
 ...
 %>
<form action="proveedoMovProvAsientoFrm.jsp" method="post" name="frm">
  <div align="right">
...
<td width="26%" class="fila-det-border"><%=  BPMPAF.getStock_fact() %></td>
                </tr> 
                <tr class="fila-det-bold"> 
								...
								if(BPMPAF.getTipomov().longValue() > 0) {%>
                                  ...
                                  <tr class="text-globales" height="3">
							       ...
							       <% // SI LA FACTURA DEL PROVEEDOR AFECTA STOCK O LO PERMITE
									if( (!str.esNulo(BPMPAF.getStock_fact()).equalsIgnoreCase("N") &&  !str.esNulo(BPMPAF.getStock_fact()).equalsIgnoreCase("C") ) ||  BPMPAF.getTipomov().intValue()== 3) {%>								 
                <tr >
...
<input name="porcentajeBonificacion" type="hidden" class="campo" id="porcentajeBonificacion" value="<%=BPMPAF.getPorcentajeBonificacion()%>" size="7" maxlength="6"  >
            ...
            <%if( BPMPAF.getStock_fact().equalsIgnoreCase("C") ) {  // solo aplicaciones contables puras
            ...
            <%}%>   								 
			<%if( BPMPAF.getStock_fact().equalsIgnoreCase("S") || BPMPAF.getStock_fact().equalsIgnoreCase("N") ){  %> 					 
                <tr class="fila-det">
...
-->
                   ...
                   if(BPMPAF.getImporte().doubleValue()>0){%>										
                         ...
                         <% 
						                         System.out.println(" BPMPAF.getHtIvaTotal(): " +  BPMPAF.getHtIvaTotal().size() );
												 ...
												 while(enumIVATotal.hasMoreElements()){
												   ...
												   System.out.println(" datosAsiento[0]: " +  datosAsiento[0] );
