...
function validarCampos() {
	...
	if (document.forms[0].ctaactivo12.value == "") {
...
function passBack(ctaactivo1, d_cContable) {  
  var opcion = "<%= opcion %>";
  var id     =  "<%= id %>";
  if(opcion == "byId"){
    opener.document.getElementById(id).value = ctaactivo1 ;
		id = (parseInt(id)+1) + "" ;
    opener.document.getElementById(id).value = d_cContable ;		
		...
		var i = 0;
		 for(i=0;i<10;i++)
			 if(opener.document.forms[i].ctaactivo1)
				 break;    
		 opener.document.forms[i].ctaactivo1.value = ctaactivo1; 
	}
   close();
}
  ...
  <table width="59%" border="0" cellspacing="0" cellpadding="0" height="23">
    <tr> 
      ...
      <td width="54%" height="39"> 
        <input name="ctaactivo12" type="text" class="campo" id="ctaactivo12" value="<%=ctaactivo1%>" size="25">
      </td>
...
if (!ctaactivo12.equals("*")) {
  ...
  <table width="100%"  cellPadding=0 cellSpacing=0  border="0">
	...
	<input type="hidden" name="ctaactivo1" value="<%=ctaactivo1%>">
</form>
