...
String color_fondo ="";
String titulo = "Asientos contables: pagos";
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanProveedoConsultaCtaCteLovPago"   scope="page"/>
...
<input type="text" name="idcliente" value="<%=BFFF.getIdcliente()%>">
<input type="text" name="nrointerno" value="<%=BFFF.getNrointerno()%>">
<input type="text" name="tipomov" value="<%=BFFF.getTipomov()%>">
