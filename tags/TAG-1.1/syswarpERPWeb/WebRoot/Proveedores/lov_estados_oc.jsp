...
String color_fondo ="";
String titulo = "Estados de Ordenes de Compras";
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanProveedoresEstadosOCLov"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idestadooc, estadooc){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idestadooc)
			break;
	opener.document.forms[i].idestadooc.value = idestadooc;
	opener.document.forms[i].estadooc.value = estadooc; 
	window.close();
}
 </script>
</head>
...
<form action="lov_estados_oc.jsp" method="POST" name="frm">
