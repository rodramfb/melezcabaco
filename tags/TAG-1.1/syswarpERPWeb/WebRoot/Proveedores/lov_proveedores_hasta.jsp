...
<title><%=titulo%></title>
 ...
 <script>
 function passBack(idproveedorhasta, dproveedorhasta) {
  var openhasta = (opener.location + "").substring(( opener.location + "" ).lastIndexOf("/") + 1 ).toLowerCase();
  var i = 0;
   for(i=0;i<10;i++)
     if(opener.document.forms[i].idproveedorhasta)
       break;    
   opener.document.forms[i].idproveedorhasta.value = idproveedorhasta;
   if(opener.document.forms[i].dproveedorhasta)
     opener.document.forms[i].dproveedorhasta.value = dproveedorhasta;
   if(opener.document.forms[i].proveedor)
	   opener.document.forms[i].proveedor.value = dproveedorhasta;
	 if(openhasta == "cajapagosabm.jsp") opener.document.frm.submit();
...
<form action="lov_proveedores_hasta.jsp" method="POST" name="frm">
