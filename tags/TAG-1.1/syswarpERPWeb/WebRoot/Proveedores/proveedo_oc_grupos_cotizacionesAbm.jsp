...
%>
<html>
<jsp:useBean id="BPA"  class="ar.com.syswarp.web.ejb.BeanProveedo_oc_grupos_cotizacionesAbm"   scope="page"/>
...
Proveedo_oc_grupos_cotizaciones= BPA.getProveedo_oc_grupos_cotizacionesList();
iterProveedo_oc_grupos_cotizaciones = Proveedo_oc_grupos_cotizaciones.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="proveedo_oc_grupos_cotizacionesAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="idgrupooc" value="<%= sCampos[0]%>"></td>
      <td class="fila-det-border" >&nbsp;<%= sCampos[0]%></td>
      <td class="fila-det-border" >&nbsp;<%= sCampos[1]%></td>
      <td class="fila-det-border" >&nbsp;<%= Common.setObjectToStrOrTime(java.sql.Date.valueOf(sCampos[2]), "JSTsToStr")%></td>
      <td class="fila-det-border" >&nbsp;<%= Common.setObjectToStrOrTime(java.sql.Date.valueOf(sCampos[3]), "JSTsToStr")%></td>
   </tr>
<%
   }%>
   </table>
