...
/* 
   Grilla para la entidad: proveedo_oc_estados
...
String color_fondo ="";
String titulo = "ESTADOS DE ORDENES DE COMPRA";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterProveedo_oc_estados   = null;
...
%>
<html>
<jsp:useBean id="BPA"  class="ar.com.syswarp.web.ejb.BeanProveedo_oc_estadosAbm"   scope="page"/>
...
tituCol[0] = "Codigo";
tituCol[1] = "Estado";
java.util.List Proveedo_oc_estados = new java.util.ArrayList();
Proveedo_oc_estados= BPA.getProveedo_oc_estadosList();
iterProveedo_oc_estados = Proveedo_oc_estados.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="proveedo_oc_estadosAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterProveedo_oc_estados.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterProveedo_oc_estados.next(); 
      // estos campos hay que setearlos segun la grilla 
      if (color_fondo.equals("fila-det-verde")) color_fondo = "fila-det";
      else color_fondo = "fila-det-verde";%>
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="idestadooc" value="<%= sCampos[0]%>"></td>
