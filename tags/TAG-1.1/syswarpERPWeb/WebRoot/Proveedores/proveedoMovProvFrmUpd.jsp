                    ...
                    <tr class="fila-det">
                      <td width="13%" height="30">
												<select name="tipomov" class="campo" onChange="document.frm.submit();">
													...
													<option value="2" <% if(BPMPF.getTipomov().intValue()== 2) out.write("selected"); %>>Nota Débito</option>
													<option value="3" <% if(BPMPF.getTipomov().intValue()== 3) out.write("selected"); %>>Nota Crédito</option>
