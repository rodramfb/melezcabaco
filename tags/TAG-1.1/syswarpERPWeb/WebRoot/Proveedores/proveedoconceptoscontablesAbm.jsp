...
String color_fondo ="";
String titulo = "Conceptos Contables";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterconceptoscontables   = null;
...
%>
<html>
<jsp:useBean id="BPRA"  class="ar.com.syswarp.web.ejb.BeanProveedoconceptoscontablesAbm"   scope="page"/>
...
<%
 ...
 BPRA.setEjercicio( new BigDecimal( (String)session.getAttribute("ejercicioActivo") )  );
...
tituCol[2] = "Orden";
tituCol[3] = "Letra";
tituCol[4] = "Tipo Comprobante";
tituCol[5] = "Tipo";
java.util.List ProveedoRetenciones = new java.util.ArrayList();
ProveedoRetenciones= BPRA.getProveedoProveedList();
iterconceptoscontables = ProveedoRetenciones.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="proveedoconceptoscontablesAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterconceptoscontables.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterconceptoscontables.next(); 
