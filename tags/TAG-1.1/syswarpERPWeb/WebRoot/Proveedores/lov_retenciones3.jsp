...
int i = 0;
Iterator iterProveedoresretenciones   = null;
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanProveedorRetencionesLov"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idretencion3, d_idretencion3){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idretencion3)
			break;
	opener.document.forms[i].idretencion3.value = idretencion3;
	opener.document.forms[i].d_idretencion3.value = d_idretencion3; 
	window.close();
}
 </script>
</head>
...
java.util.List proveedoresretenciones = new java.util.ArrayList();
proveedoresretenciones= BFFF.getretencionesList();
iterProveedoresretenciones = proveedoresretenciones.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_retenciones3.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterProveedoresretenciones.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterProveedoresretenciones.next(); 
