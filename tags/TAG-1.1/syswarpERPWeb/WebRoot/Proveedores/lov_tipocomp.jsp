...
String color_fondo ="";
String titulo = "Tipo comprobante";
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanClientesTipocompLov"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idtipocomp, tipocomp){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idtipocomp)
			break;
...
clientestipocomp= BFFF.getClientestipocompList();
iterClientestipocomp = clientestipocomp.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_tipocomp.jsp" method="POST" name="frm">
