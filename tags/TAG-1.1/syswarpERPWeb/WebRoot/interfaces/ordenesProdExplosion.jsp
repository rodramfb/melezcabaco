...
String color_fondo ="";
String titulo = "INTERFACES - ORDENES DE PRODUCCION PENDIENTES";
...
%>
<html>
<jsp:useBean id="BPMPA"  class="ar.com.syswarp.web.ejb.BeanINTERFACESProduccionExplosionOP"   scope="page"/>
...
<form action="ordenesProdExplosion.jsp" method="POST" name="frm" >
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      ...
      <td bgcolor="#E1EEF4" class="fila-det-border" ><img src="../imagenes/default/gnome_tango/devices/stock_printers.png" width="18" height="18" onClick="abrirVentana('produccionCalculoNecesidadFrame.jsp?idop=<%=sCampos[0]%>');" style="cursor:pointer"></td>
