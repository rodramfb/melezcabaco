...
String color_fondo ="";
String titulo = "INTERFACES - ORDENES DE PRODUCCION";
...
%>
<html>
<jsp:useBean id="BPMPA"  class="ar.com.syswarp.web.ejb.BeanINTERFACESProduccionMovProduAbm"   scope="page"/>
...
<form action="ordenesProdABM.jsp" method="POST" name="frm" onSubmit="evitarCheck();">
