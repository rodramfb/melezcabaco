...
<html>
	<%-- INSTANCIAR BEAN --%>
	<jsp:useBean id="BPF"
		class="ar.com.syswarp.web.ejb.BeanContableLibroMayorDetalle" scope="page" />
	<head>
	...
	<BODY>
		...
		<% 
 String titulo = "Consulta - Libro Mayor con Detalle";
 ...
 %>
		<form action="frmLibroMayorDetalleAnual.jsp" method="post" name="frm">
