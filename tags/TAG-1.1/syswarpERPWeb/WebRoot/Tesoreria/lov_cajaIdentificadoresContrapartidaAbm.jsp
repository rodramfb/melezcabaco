...
%>
<html>
<jsp:useBean id="BCIA"  class="ar.com.syswarp.web.ejb.BeanLovCajaIdentificadoresContraPartida"   scope="page"/>
...
<form action="lov_cajaIdentificadoresContrapartidaAbm.jsp" method="POST" name="frm">
