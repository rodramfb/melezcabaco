...
/* 
   Formulario de carga para la entidad: Cajaflujos
...
<html>
<%-- INSTANCIAR BEAN --%>  
<jsp:useBean id="BCF"  class="ar.com.syswarp.web.ejb.BeanCajaflujosFrm"   scope="page"/>
<head>
 <title>FRMCajaflujos.jsp</title>
...
<div id="popupcalendar" class="text"></div>
 ...
 <% 
 String titulo = BCF.getAccion().toUpperCase() + " DE Flujo de Fondos" ;
 ...
 %>
<form action="CajaflujosFrm.jsp" method="post" name="frm">
<input name="accion" type="hidden" value="<%=BCF.getAccion()%>" >
<input name="codigo_fl" type="hidden" value="<%=BCF.getCodigo_fl()%>" >
         ...
         <table width="100%"  border="0" cellspacing="0" cellpadding="0" align="center">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
              ...
              <tr class="fila-det">
                ...
                <td width="88%" class="fila-det-border">&nbsp;<input name="descri_fl" type="text" value="<%=BCF.getDescri_fl()%>" class="campo" size="50" maxlength="50"  ></td>
              </tr>
              <tr class="fila-det">
                <td class="fila-det-border">&nbsp;</td>
