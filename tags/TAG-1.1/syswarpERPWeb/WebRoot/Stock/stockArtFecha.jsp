...
String color_fondo ="";
String titulo = "STOCK A FECHA PARA TODOS LOS DEPOSITOS";
...
%>
<html>
<jsp:useBean id="BVMAFA"  class="ar.com.syswarp.web.ejb.BeanVMovArtFecha"   scope="page"/>
...
<form action="stockArtFecha.jsp" method="POST" name="frm">
                  ...
                  <td width="17%" height="38">
                    ...
                    <input class="cal-TextBox" onFocus="this.blur()" size="12" readonly type="text" name="fecha_ms" value="<%= BVMAFA.getFecha_ms() %>" maxlength="12">
											<a class="so-BtnLink" href="javascript:calClick();return false;" 
											 ...
											 onClick="calSwapImg('BTN_date_1', 'img_Date_DOWN');showCalendar('frm','fecha_ms','BTN_date_1');return false;"> <img align="absmiddle" border="0" name="BTN_date_1" src="vs/calendar/btn_date_up.gif" width="22" height="17">
											</a>
											</span></span> 
									 </td>
                   <td width="83%">
                      <table width="100%" border="0">
                         <tr>
                           ...
                           <td width="25%">
                              <input name="ocurrencia" type="text" value="<%=BVMAFA.getOcurrencia()%>" id="ocurrencia" size="30" maxlength="30">
                           </td>
                           <td width="69%">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
     ...
     <td width="61%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[1]%></td>
