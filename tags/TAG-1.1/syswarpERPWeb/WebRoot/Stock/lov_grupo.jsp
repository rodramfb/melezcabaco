...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanStockgruposLov" scope="page"/>
...
tituCol[0] = "Codigo";
tituCol[1] = "Grupo";
tituCol[2] = "Familia O Grupo Padre";
...
<form action="lov_grupo.jsp" method="POST" name="frm">
