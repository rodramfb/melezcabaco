...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(unialt1_st, d_unialt1_st){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].unialt1_st)
			break;
	opener.document.forms[i].unialt1_st.value = unialt1_st;
	opener.document.forms[i].d_unialt1_st.value = d_unialt1_st; 
	window.close();
}
 </script>
</head>
