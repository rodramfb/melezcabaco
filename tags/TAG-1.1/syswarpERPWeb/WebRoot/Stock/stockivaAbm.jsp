...
/* 
   Grilla para la entidad: stockiva
...
String color_fondo ="";
String titulo = "Iva para productos";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterStockiva   = null;
...
%>
<html>
<jsp:useBean id="BSA"  class="ar.com.syswarp.web.ejb.BeanStockivaAbm"   scope="page"/>
...
tituCol[2] = "Porcentaje";
java.util.List Stockiva = new java.util.ArrayList();
Stockiva= BSA.getStockivaList();
iterStockiva = Stockiva.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="stockivaAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
     ...
     <td width="64%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[2]%></td>
   </tr>
   <%int r = 0;
   while(iterStockiva.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterStockiva.next(); 
