...
<form action="stockRemitoInterno.jsp" method="POST" name="frm">
&nbsp;
<table width="90%" height="244"  border="0" align="center" cellpadding="0" cellspacing="0">
	...
	<tr class="fila-det">
    <td width="36%" height="32" ><%= genNombreEmpresa %>&nbsp;</td>
    <td width="64%">&nbsp;</td>
  </tr>		
  <tr class="fila-det">
    <td height="29"><%= genDomicilioLegalEmpresa %></td>
    <td>ORIGINAL (COMPROBANTE NO VALIDO COMO FACTURA)</td>
  </tr>

  <tr class="fila-det">
    <td height="35"><%= genLocalidadEmpresa %></td>
    <td>&nbsp;</td>
  </tr>
  <tr class="fila-det">
    <td height="36"><%= genProvinciaEmpresa %></td>
    <td>&nbsp;</td>
  </tr>
  <tr class="fila-det">
    <td height="29">&nbsp;</td>
    <td>FECHA : <%= str.esNulo(request.getParameter("fechamov")) %> </td>
  </tr>
  <tr class="fila-det">
    <td>&nbsp;</td>
    <td>Cambio de Dep&oacute;sito N&ordm; : <%= str.esNulo(request.getParameter("comprob_ms")) %></td>
  </tr>
  <tr class="fila-det">
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr class="fila-det">
    <td colspan="2">
		  <table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0">
			 ...
			 Vector vecSort = new Vector(htArticulosMovimiento.keySet());
			 Collections.sort(vecSort);
			 Enumeration en = vecSort.elements();
				while(en.hasMoreElements()){
					String key =  (String )en.nextElement() ;
					String[] datos =  (String[] )htArticulosMovimiento.get(key);
			 %>
				<tr class="fila-det">
  ...
  <tr class="fila-det">
    ...
    <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr class="fila-det">
        <td width="22%">Recibi Conforme </td>
        <td width="78%">........................................ </td>
      </tr>
    </table></td>
  </tr>
