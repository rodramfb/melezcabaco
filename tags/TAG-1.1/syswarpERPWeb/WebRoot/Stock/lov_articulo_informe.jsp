...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(codigo_st, descrip_st){
	for(var i = 0; i<10;i++)
...
<form action="lov_articulo_informe.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
     ...
     <td width="54%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[1]%></td>
