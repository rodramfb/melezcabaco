...
/* 
   Grilla para la entidad: clientesexpresos
...
int i = 0;
Iterator iterClientesexpresos   = null;
...
%>
<html>
<jsp:useBean id="BCA"  class="ar.com.syswarp.web.ejb.BeanClientesexpresosAbm"   scope="page"/>
...
tituCol[4] = "Localidad";
tituCol[5] = "Tipo iva";
tituCol[6] = "Valor seguro";
java.util.List Clientesexpresos = new java.util.ArrayList();
Clientesexpresos= BCA.getClientesexpresosList();
iterClientesexpresos = Clientesexpresos.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="clientesexpresosAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterClientesexpresos.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterClientesexpresos.next(); 
      // estos campos hay que setearlos segun la grilla 
      if (color_fondo.equals("fila-det-verde")) color_fondo = "fila-det";
      else color_fondo = "fila-det-verde";%>
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="idexpreso" value="<%= sCampos[0]%>"></td>
