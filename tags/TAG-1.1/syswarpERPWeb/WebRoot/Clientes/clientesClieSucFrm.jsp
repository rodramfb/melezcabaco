...
<html>
<%-- INSTANCIAR BEAN --%>  
<jsp:useBean id="BCCSF"  class="ar.com.syswarp.web.ejb.BeanClientesClieSucFrm"   scope="page"/>
<head>
...
<div id="popupcalendar" class="text"></div>
 ...
 %>
<form action="clientesClieSucFrm.jsp" method="post" name="frm">
         ...
         <table width="100%"  border="0" cellspacing="0" cellpadding="0" align="center">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
              ...
              <tr class="fila-det">
                ...
                <td width="86%" class="fila-det-border"><table width="23%" border="0">
                  <tr class="fila-det-border">
                    <td width="61%" >
                      <input name="cliente" type="text" class="campo" id="cliente" value="<%=BCCSF.getCliente()%>" size="30" readonly></td>
              ...
              <tr class="fila-det">
                ...
                <td width="86%" class="fila-det-border"><table width="23%" border="0">
                  <tr class="fila-det-border">
                    ...
                    <td width="39%"><img src="../imagenes/default/gnome_tango/actions/filefind.png" width="22" height="22" onClick="mostrarLOV('../Clientes/lov_tiposucursal.jsp')" style="cursor:pointer"></td>
              ...
              <tr class="fila-det">
                ...
                <td width="86%" class="fila-det-border"><table width="23%" border="0">
                    <tr class="fila-det-border">
                      <td width="61%" >                        <input name="localidad" type="text" class="campo" id="localidad2" value="<%=BCCSF.getLocalidad()%>" size="30" readonly></td>
                      <td width="39%"><img src="../imagenes/default/gnome_tango/actions/filefind.png" width="22" height="22" onClick="mostrarLOV('../Clientes/lov_localidades2.jsp')" style="cursor:pointer"></td>
