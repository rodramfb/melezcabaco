...
/* 
   Grilla para la entidad: sascanalescontactos
...
String color_fondo ="";
String titulo = "SAS - CANALES DE CONTACTOS";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterSascanalescontactos   = null;
...
%>
<html>
<jsp:useBean id="BSA"  class="ar.com.syswarp.web.ejb.BeanSascanalescontactosAbm"   scope="page"/>
...
tituCol[0] = "Cód.";
tituCol[1] = "Canal de contacto";
tituCol[2] = "Tipo de contacto";
java.util.List Sascanalescontactos = new java.util.ArrayList();
Sascanalescontactos= BSA.getSascanalescontactosList();
iterSascanalescontactos = Sascanalescontactos.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="sascanalescontactosAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
     <td width="3%" >&nbsp;</td>
     <td width="32%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[0]%></td>
   ...
   <%int r = 0;
   while(iterSascanalescontactos.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterSascanalescontactos.next(); 
      // estos campos hay que setearlos segun la grilla 
      if (color_fondo.equals("fila-det-verde")) color_fondo = "fila-det";
      else color_fondo = "fila-det-verde";%>
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="idcanalcontacto" value="<%= sCampos[0]%>"></td>
