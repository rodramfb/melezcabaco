...
/* 
   Grilla para la entidad: clienteszonas
...
String color_fondo ="";
String titulo = "Zonas";
//String titulo = "Distribuidor";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterClienteszonas   = null;
...
%>
<html>
<jsp:useBean id="BCA"  class="ar.com.syswarp.web.ejb.BeanClienteszonasAbm"   scope="page"/>
...
tituCol[0] = "Codigo";
tituCol[1] = "Zona";
//tituCol[1] = "Distribuidor";
java.util.List Clienteszonas = new java.util.ArrayList();
Clienteszonas= BCA.getClienteszonasList();
iterClienteszonas = Clienteszonas.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="clienteszonasAbm.jsp" method="POST" name="frm">
                   ...
                   <td width="11%" height="38">
                      <table width="36%" border="0">
                         <tr>
                            ...
                            <td width="27%">
														<input name="depositos" type="image" id="depositos" onClick="document.frm.accion.value = this.name"  value="depositos" src="../imagenes/default/gnome_tango/actions/stock_home.png" title="Asociar Dep&oacute;sitos" width="20" height="20"></td>
                         </tr>
                      </table>
                   </td>
                   <td width="89%">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterClienteszonas.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterClienteszonas.next(); 
      // estos campos hay que setearlos segun la grilla 
      if (color_fondo.equals("fila-det-verde")) color_fondo = "fila-det";
      else color_fondo = "fila-det-verde";%>
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="idzona" value="<%= sCampos[0]%>" onClick="document.frm.zona.value = '<%=sCampos[1]%>'"></td>
...
<%
   ...
   <input name="zona" value="" type="hidden">
</form>
  </body>
</html>
<% 
