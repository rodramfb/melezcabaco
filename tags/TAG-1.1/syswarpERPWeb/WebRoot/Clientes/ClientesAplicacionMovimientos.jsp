...
String color_fondo ="";
String titulo = "Aplicacion de movimientos para clientes";
...
%>
<html>
<jsp:useBean id="BVCA"  class="ar.com.syswarp.web.ejb.BeanClientesAplicacionMovimientos"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 function seleccionarCliente(){
   abrirVentana('../Tesoreria/vlov_ClientesAbm.jsp', 'buscar', 700, 400); 
 }
 function cambiarCliente(){
   if(confirm("Al cambiar de cliente, perderá toda la información cargada.\n Continúa de todas formas?")){
	   seleccionarCliente();
     window.location = "ClientesAplicacionMovimientos.jsp";
	 }
 }
 </script>
</head>
...
<form action="ClientesAplicacionMovimientos.jsp" method="POST" name="frm">
...
<table width="98%"  border="1" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td>
      ...
      <tr >
        <td width="9%" class="fila-titulo-dos"><input name="idcliente" type="text" class="campo" id="idcliente" size="10" value="<%= str.esNulo(BVCA.getIdcliente() + "") %>"></td>
        <td width="91%" ><span class="fila-titulo-dos">
          <input name="razon" type="text" class="campo" id="razon" size="80" value="<%= BVCA.getRazon() %>">
        </span></td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td>
      ...
      <tr class="text-globales">
        ...
        <td width="58%" >
				 <input name="btnbuscacobrador" type="button" class="boton" id="btnbuscacobrador" style="cursor:pointer" onClick="abrirVentana('lov_cobrador.jsp', 'buscar', 700, 400)" value=">>">
      ...
      <tr >
        <td width="9%" class="fila-titulo-dos"><input name="idcobrador" type="text" class="campo" id="idcobrador" size="10" value="<%= str.esNulo(BVCA.getIdcobrador() + "") %>"></td>
        <td colspan="2" ><span class="fila-titulo-dos">
          <input name="cobrador" type="text" class="campo" id="cobrador" size="80" value="<%= BVCA.getCobrador() %>">
        </span></td>
      </tr>
    </table></td>
  </tr>
    ...
    <td>
      ...
      <tr class="text-globales">
        ...
        <td width="78%" class="fila-titulo-dos">
				...
				<input name="btncomprobantes" type="button" class="boton" id="btncomprobantes" style="cursor:pointer" onClick="abrirVentana('../Tesoreria/lov_clientesAplicacionMovimientos.jsp?cliente=' + document.frm.idcliente.value + '&razon=' + document.frm.razon.value, 'buscar', 700, 400)" value=">>"></td>
      </tr>
      <tr >
 ...
 <% 
  ...
  <tr>
    <td>
      ...
      <tr class="text-globales">
        ...
        <td width="78%" class="fila-titulo-dos">
          <!--img src="../imagenes/default/gnome_tango/actions/filefind.png" width="22" height="22" style="cursor:pointer" onClick="abrirVentana('lov_clientesMovCliAbm.jsp?cliente=' + document.frm.idcliente.value + '&razon=' + document.frm.razon.value, 'comprobantes', 700, 400)"-->
          <input name="btndescuentos" type="button" class="boton" id="btndescuentos" style="cursor:pointer" onClick="abrirVentana('../Tesoreria/lov_cajaIdentificadoresAbm.jsp?tipomov=X&propio=N', 'buscar', 700, 400)" value=">>"></td>
      </tr>
      <tr >
        <td colspan="2" class="fila-titulo-dos">
          <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr class="fila-det" >
        <td width="54%" height="29" class="fila-det-border"><span >
          <input class="cal-TextBox" onFocus="this.blur()" size="12" readonly="readonly" type="text" name="fechamov" value="<%//=BCF.getFecha_ferStr()%>" maxlength="12">
  ...
  <tr>
    <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"   >
      ...
      <tr class="text-globales">
        ...
        <td width="78%" class="fila-titulo-dos">
          <!--img src="../imagenes/default/gnome_tango/actions/filefind.png" width="22" height="22" style="cursor:pointer" onClick="abrirVentana('lov_clientesMovCliAbm.jsp?cliente=' + document.frm.idcliente.value + '&razon=' + document.frm.razon.value, 'comprobantes', 700, 400)"-->
          <input name="btndescuentos2" type="button" class="boton" id="btndescuentos2" style="cursor:pointer" onClick="abrirVentana('../Tesoreria/lov_cajaIdentificadoresPropioAbm.jsp?propio=N', 'descuentos', 800, 400)" value=">>"></td>
      </tr>
      <tr >
        <td colspan="2" class="fila-titulo-dos">
          <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	if(htIdentificadoresIngresosOK != null && !htIdentificadoresIngresosOK.isEmpty()){
		...
		while (en.hasMoreElements()) {
            ...
            <tr class="fila-det" >
              ...
              <td width="12%" class="fila-det-border">&nbsp;<div align="right"><%= Common.getNumeroFormateado(Float.parseFloat(identificadores[28]), 10, 4) %></div></td>
            </tr>
            <% 
		}
	}
  ...
  <tr>
    <td height="33"><span class="fila-titulo-dos">
      <input name="confirmar" type="submit" class="boton" id="confirmar" style="cursor:pointer" value="Confirmar Cobranza" >
    </span></td>
  </tr>
</table>
<p>&nbsp; </p>
