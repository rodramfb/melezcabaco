...
try {
	...
	String color_fondo ="";
	String titulo = "SAS - RESULTADOS DE CONTACTOS";
	...
	int i = 0;
	Iterator iterSasResultadosContactos = null;
...
<html>
	...
	<jsp:useBean id="BSA"  class="ar.com.syswarp.web.ejb.BeanSasResultadosContactosAbm"   scope="page"/>
	...
	tituCol[0] = "Cód.";
	tituCol[1] = "Resultado del contacto";
	tituCol[2] = "Tipo de contacto";
	tituCol[3] = "Canal de contacto";
	tituCol[4] = "Motivo del contacto";
	tituCol[5] = "Acción del contacto";

	java.util.List sasResultadosContactos = BSA.getSasResultadosContactosList();
	iterSasResultadosContactos = sasResultadosContactos.iterator();
	%>
	...
	<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
		...
		<form action="sasResultadosContactosAbm.jsp" method="POST" name="frm">
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id="rsTable" cols=<%=totCol+2-4%>  >
				...
				<%
				int r = 0;
   				while(iterSasResultadosContactos.hasNext()) {
      				++r;
      				String[] sCampos = (String[]) iterSasResultadosContactos.next(); 
				...
				%>
					...
					<tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
						<td class="fila-det-border" ><input type="radio" name="idResultadoContacto" value="<%= sCampos[0]%>"></td>
