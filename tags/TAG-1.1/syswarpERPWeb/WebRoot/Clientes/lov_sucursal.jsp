...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanSucursalLov"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idsucursal, sucursal){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idsucursal)
			break;
	opener.document.forms[i].idsucursal.value = idsucursal;
	opener.document.forms[i].sucursal.value = sucursal; 
	window.close();
}
 </script>
</head>
...
sucursal= BFFF.getsucursalList();
itersucursal = sucursal.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_sucursal.jsp" method="POST" name="frm">
