...
String color_fondo ="";
String titulo = "Tipo de Cliente";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterClientestipo   = null;
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanClientesTipoLov"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idtipoclie, tipoclie){
	for(var i = 0; i<10;i++)
	  if(opener.document.forms[i].idtipoclie){
	    opener.document.forms[i].idtipoclie.value = idtipoclie;
	    opener.document.forms[i].tipoclie.value = tipoclie; 
		if(opener.document.forms[i].idpromocion){
		  opener.document.forms[i].idpromocion.value = '-1';
		  opener.document.forms[i].promocion.value = '';
		}
		break;
	}
	window.close();
...
java.util.List clientestipo = new java.util.ArrayList();
clientestipo= BFFF.getClientestipoList();
iterClientestipo = clientestipo.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_tipocliente.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterClientestipo.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterClientestipo.next(); 
