...
/* 
   Grilla para la entidad: clientetarjetascreditomarcas
...
String color_fondo ="";
String titulo = "Tarejtas de Credito Marcas";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterClientetarjetascreditomarcas   = null;
...
%>
<html>
<jsp:useBean id="BCA"  class="ar.com.syswarp.web.ejb.BeanClientetarjetascreditomarcasAbm"   scope="page"/>
...
tituCol[0] = "Codigo";
tituCol[1] = "Tarjeta Credito";
tituCol[2] = "Formato";
tituCol[3] = "Metodo Asociado";
tituCol[4] = "Filtro Archivo";
tituCol[5] = "Formula Validacion";
tituCol[6] = "Codigo digito verificador de la marca";
java.util.List Clientetarjetascreditomarcas = new java.util.ArrayList();
Clientetarjetascreditomarcas= BCA.getClientetarjetascreditomarcasList();
iterClientetarjetascreditomarcas = Clientetarjetascreditomarcas.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="clientetarjetascreditomarcasAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterClientetarjetascreditomarcas.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterClientetarjetascreditomarcas.next(); 
      // estos campos hay que setearlos segun la grilla 
      if (color_fondo.equals("fila-det-verde")) color_fondo = "fila-det";
      else color_fondo = "fila-det-verde";%>
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="idtarjetacredito" value="<%= sCampos[0]%>"></td>
