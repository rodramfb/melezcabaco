...
int i = 0;
Iterator iterClientesestados   = null;
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanClientesEstadosLov"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idestado, estado){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idestado)
			break;
	opener.document.forms[i].idestado.value = idestado;
	opener.document.forms[i].estado.value = estado; 
	window.close();
}
 </script>
</head>
...
java.util.List clientesestado = new java.util.ArrayList();
clientesestado= BFFF.getclientesestadosList();
iterClientesestados = clientesestado.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_estados.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterClientesestados.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterClientesestados.next(); 
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" >
         <% 
         if(!sCampos[0].equalsIgnoreCase("6")){ %>
         <img src="../imagenes/default/gnome_tango/actions/down.png" width="18" height="18" onClick="bajarDatos('<%=sCampos[0]%>', '<%=sCampos[1]%>' )">
         <%
         } else out.write("&nbsp;");%>
       </td>
