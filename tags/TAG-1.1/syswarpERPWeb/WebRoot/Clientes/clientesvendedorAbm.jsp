...
/* 
   Grilla para la entidad: clientesvendedor
...
String color_fondo ="";
String titulo = "Vendedores";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterClientesvendedor   = null;
...
%>
<html>
<jsp:useBean id="BCA"  class="ar.com.syswarp.web.ejb.BeanClientesvendedorAbm"   scope="page"/>
...
tituCol[0] = "Codigo";
tituCol[1] = "Vendedor";
tituCol[2] = "Comision 1";
tituCol[3] = "Comision 2";
tituCol[4] = "Domicilio";
tituCol[5] = "Sueldo basico";
tituCol[6] = "Tipo liquidacion";
tituCol[7] = "Tasa desercion";
tituCol[8] = "Valor asociacion";
java.util.List Clientesvendedor = new java.util.ArrayList();
Clientesvendedor= BCA.getClientesvendedorList();
iterClientesvendedor = Clientesvendedor.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="clientesvendedorAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
     ...
     <td width="29%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[1]%></td>
     ...
     <td width="29%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[5]%></td>
     <td width="12%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[6]%></td>
     <td width="11%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[7]%></td>
     <td width="40%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[8]%></td>	 
   </tr>
   <%int r = 0;
   while(iterClientesvendedor.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterClientesvendedor.next(); 
      // estos campos hay que setearlos segun la grilla 
      if (color_fondo.equals("fila-det-verde")) color_fondo = "fila-det";
      else color_fondo = "fila-det-verde";%>
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="idvendedor" value="<%= sCampos[0]%>"></td>
      <td class="fila-det-border" ><%=sCampos[0]%>&nbsp;</td>
      <td class="fila-det-border" ><%=sCampos[9] == null ?sCampos[1]: sCampos[1] +" (Dado de baja el dia " + Common.setObjectToStrOrTime(java.sql.Date.valueOf(sCampos[9]), "JSDateToStr") + ")"%>&nbsp;</td>
