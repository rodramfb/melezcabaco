...
%>
<html>
<jsp:useBean id="BCCA"  class="ar.com.syswarp.web.ejb.BeanClientesClientesResumidoAbm"   scope="page"/>
...
<form action="clientesClientesResumidoAbm.jsp" method="POST" name="frm">
                ...
                <tr>
                   <td width="11%" height="38">
                      <table width="36%" border="0">
                         <tr>
                            <td width="27%">
                               <input name="alta" id="alta" value="alta" type="image" src="../imagenes/default/btn_add_norm.gif"  onMouseOut="MM_swapImgRestore() " onMouseOver="MM_swapImage('alta','','../imagenes/default/btn_add_over.gif',1)" onClick="document.frm.accion.value = this.name" tabindex="100">
                            </td>
                            <td width="27%">
                   ...
                   <td width="89%">
                      <table width="100%" border="0">
                         <tr>
                           ...
                           <td width="22%">
                              <input name="ocurrencia" type="text" value="<%=BCCA.getOcurrencia()%>" id="ocurrencia" size="30" maxlength="30" tabindex="1"> 
                           </td>
                           <td width="72%">
                                   ...
                                   <td>
                                     <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                        <tr class="text-globales">
                                          ...
                                          <td width="10%" class="text-globales"><input name="ir" type="submit" class="boton" id="ir" value="  >>  " tabindex="2"></td>
                                       </tr>
                                    </table>
                                 </td>
                              </tr>
