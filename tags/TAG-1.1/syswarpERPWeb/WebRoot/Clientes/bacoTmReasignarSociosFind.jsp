...
String color_fondo ="";
String titulo = "TELEMARKETING - Reasignación de Socios Por Telemarketer ";
...
%>
<html>
<jsp:useBean id="BBTASF"  class="ar.com.syswarp.web.ejb.BeanBacoTmReasignarSociosFind"   scope="page"/>
...
<form action="bacoTmReasignarSociosFind.jsp" method="POST" name="frm">
                ...
                <tr>
                  ...
                  <table width="100%" border="1" cellspacing="0" cellpadding="0" class="text-dos-bold">
                    <tr class="subtitulo-tres" >
                      <td height="30" colspan="4" >Datos de Campa&ntilde;a  - Reasignaci&oacute;n </td>
                    </tr>
					<tr >
                      <td width="19%" height="30" >&nbsp;</td>
                      <td width="36%">&nbsp;</td>
                      <td width="16%" height="30">Telemarketer Origen (*): </td>
                      <td width="29%"><select name="idtelemark" class="campo" id="idtelemark">
                    ...
                    <tr >
                      ...
                      <td width="36%">
                      <select name="idcampacabe" class="campo" id="idcampacabe" onChange = "borrarcampaniaAnterior();">
                        <option value="-1">Seleccionar</option>
                        <%
                      ...
                      <td width="16%" height="30">Telemarketer Destino (*): </td>
                      <td width="29%"><select name="idtelemarkdestino" class="campo" id="idtelemarkdestino">
                          <option value="-1">Seleccionar</option>
                        <%
                          iterador= BBTASF.getListTeleMarketer().iterator(); 
                          while(iterador.hasNext()){
                            String datos[] = (String[]) iterador.next();%>
                            <option value="<%= datos[0] %>" <%= BBTASF.getIdtelemarkdestino().toString().equals(datos[0]) ?  "selected" : "" %>><%= datos[4] %></option>
                        <%}  %>
                      </select></td>
                    </tr>
                ...
                <tr>
                  <td height="38">
                   <table width="100%" border="1" cellspacing="0" cellpadding="0" class="text-dos-bold">
                    ...
                    <tr >
                      <td width="19%" height="30" >Provincia:</td>
                      <td width="36%" bgcolor="#FFFFCC">
                        <select name="idprovincia" class="campo" id="idprovincia">
                          <option value="-1">Seleccionar</option>
                        <%
                      ...
                      <td width="15%">Localidad:
                      <input name="idlocalidad" type="hidden" class="campo" id="idlocalidad" value="<%= BBTASF.getIdlocalidad() %>"  readonly></td>
                      <td width="22%" bgcolor="#FFFFCE"><input name="localidad" type="text" class="campo" id="localidad" value="<%= BBTASF.getLocalidad() %>" size="40" maxlength="100"  readonly></td>
                      <td width="8%" bgcolor="#FFFFCE"><img src="../imagenes/default/gnome_tango/actions/find.png" width="22" height="22" onClick="getLocalidad();" style="cursor:pointer"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td bgcolor="#FFFFCC"><select name="idorigen" class="campo" id="idorigen" onChange="poblarObjList(<%= BBTASF.getIdsuborigen() %>, this.value, 'idsuborigen', 'suborigen_')">
                          <option value="-1">Seleccionar</option>
                        <%
                      ...
                      <td>Sub-Origen:</td>
                      <td colspan="2" bgcolor="#FFFFCE"><select name="idsuborigen" class="campo" id="idsuborigen">
                          <option value="-1">Seleccionar</option>
                      </select></td>
                    </tr>
                    <tr>
                      ...
                      <td bgcolor="#FFFFCC">
                       <select name="idestado" class="campo" id="idestado" onChange="poblarObjList(<%= BBTASF.getIdmotivo() %>, this.value, 'idmotivo', 'motivo_');">
                          <option value="-1">Seleccionar</option>
                        <%
                      ...
                      <td>Motivo:</td>
                      <td colspan="2" bgcolor="#FFFFCE"><select name="idmotivo" class="campo" id="idmotivo">
                          <option value="-1">Seleccionar</option>
                      </select></td>
                    </tr>
                    <tr>
                      <td height="30">Tipo Cliente: </td>
                      <td bgcolor="#FFFFCC"><select name="idtipoclie" class="campo" id="idtipoclie">
                          <option value="-1">Seleccionar</option>
                        <%
                      ...
                      <td>Preferencia:</td>
                      <td colspan="2" bgcolor="#FFFFCE"><select name="idpreferencia" class="campo" id="idpreferencia">
                          <option value="-1">Seleccionar</option>
                        <%
                  ...
                  onclick="calSwapImg('BTN_date_1', 'img_Date_DOWN');showCalendar('frm','fechaingresohasta','BTN_date_1');return false;"> <img align="absmiddle" border="0" name="BTN_date_1" src="vs/calendar/btn_date_up.gif" width="22" height="17"></a></span></td>
                    ...
                    <tr>
                      ...
                      <td bgcolor="#FFFFCC"><select name="idcategoria" class="campo" id="idcategoria">
                          <option value="-1">Seleccionar</option>
                          <%
                    ...
                    <tr>
                      ...
                      <td colspan="3"><div align="center">
                        <input name="asignar" type="button" class="boton" id="asignar" value="Reasignar" onClick="setAccion(this.name)">
                      </div></td>
                     </tr>
                  </table></td>
                </tr>
