...
String color_fondo ="";
String titulo = "Categoria Socio";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterClientescategoria   = null;
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanClientesCategoriasSociosLov"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idcategoria, categoria){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idcategoria)
			break;
...
java.util.List clientescategoria = new java.util.ArrayList();
clientescategoria= BFFF.getclientesCategoriaSocioList();
iterClientescategoria = clientescategoria.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_categoriaSocio.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterClientescategoria.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterClientescategoria.next(); 
