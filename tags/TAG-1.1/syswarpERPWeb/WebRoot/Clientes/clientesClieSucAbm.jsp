...
%>
<html>
<jsp:useBean id="BCCSA"  class="ar.com.syswarp.web.ejb.BeanClientesClieSucAbm"   scope="page"/>
...
ClientesClieSuc= BCCSA.getClientesClieSucList();
iterClientesClieSuc = ClientesClieSuc.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="clientesClieSucAbm.jsp" method="POST" name="frm">
