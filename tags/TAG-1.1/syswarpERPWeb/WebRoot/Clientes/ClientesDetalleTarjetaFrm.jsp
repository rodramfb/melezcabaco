...
<html>
<%-- INSTANCIAR BEAN --%>  
<jsp:useBean id="BCF"  class="ar.com.syswarp.web.ejb.BeanClientesDetalleTarjetaFrm"   scope="page"/>
<head>
...
BCF.setIdcliente(new BigDecimal(idcliente));
 ...
 %>
<form action="ClientesDetalleTarjetaFrm.jsp" method="post" name="frm">
       ...
       <td>
         <table width="100%"  border="0" cellspacing="0" cellpadding="0" align="center">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
			  ...
			  <input name="cliente" type="hidden" id="cliente" value="<%=BCF.getCliente()%>" size="30" readonly>
