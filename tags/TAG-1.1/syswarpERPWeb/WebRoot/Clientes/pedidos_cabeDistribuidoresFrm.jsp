...
<html>
	<%-- INSTANCIAR BEAN --%>
	<jsp:useBean id="BPF"
		class="ar.com.syswarp.web.ejb.BeanPedidos_cabeDistribuidoresFrm" scope="page" />
	<head>
	...
	<BODY>
		...
		<% 
 String titulo = "Captura de Pedidos de Clientes Distribuidores";
...
if(idcliente!=null){
 ...
 %>
		<form action="pedidos_cabeDistribuidoresFrm.jsp" method="post" name="frm">
								...
								<td>
									<table width="100%" border="0"  cellpadding="0"
										...
										<tr>
											...
											<td width="50">&nbsp;											</td>
											<td width="43">
												<div align="center"><img src="../imagenes/default/gnome_tango/actions/edit-clear.png" width="22" height="22" title="Limpiar datos" onClick="if(confirm('Confirma limpiar datos ?')) window.location = 'pedidos_cabeDistribuidoresFrm.jsp'" style="cursor:pointer"></div>
										  </td>
											<td width="42">
												<div align="center">
...
&nbsp;																								</td>
							...
							<tr class="fila-det">
								...
								<td width="39%" class="fila-det-border"><table width="53%" border="0">
								  ...
								  %>
                                      <option value="<%= datosPrioridad[0] %>" selected <%= datosPrioridad[0].equals( BPF.getIdprioridad().toString()) ? "selected" : "" %>><%= datosPrioridad[1] %></option>
                                      <%  
								  }%>
                                    </select></td>
                                    <td width="39%">&nbsp;</td>
