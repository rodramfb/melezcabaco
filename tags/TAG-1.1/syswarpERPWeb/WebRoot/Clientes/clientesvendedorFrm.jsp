       ...
       <td>
         <table width="100%"  border="0" cellspacing="0" cellpadding="0" align="center">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
			  ...
			  <tr class="fila-det">
                <td width="12%" class="fila-det-border">Sueldo básico:  </td>
			  ...
			  <tr class="fila-det">
                <td width="12%" class="fila-det-border">Tipo liquidación:  </td>
                <td width="88%" class="fila-det-border">
			  ...
			  <tr class="fila-det">
                <td width="12%" class="fila-det-border">Tasa deserción:  </td>
			  ...
			  <tr class="fila-det">
                <td width="12%" class="fila-det-border">Valor asociación:  </td>
