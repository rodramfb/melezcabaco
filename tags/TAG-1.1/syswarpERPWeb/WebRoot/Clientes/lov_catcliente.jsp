...
String color_fondo ="";
String titulo = "Categoria de Cliente";
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanClientesCategoriaLov"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idcredcate, credcate){
	for(var i = 0; i<10;i++)
...
clientescategoria= BFFF.getClientescategoriaList();
iterClientescategoria = clientescategoria.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_catcliente.jsp" method="POST" name="frm">
