...
String color_fondo ="";
String titulo = "Moneda";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterClientesmoneda   = null;
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanClientesmonedaLov"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(nom_com_st, d_nom_com_st){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].nom_com_st)
			break;
	opener.document.forms[i].nom_com_st.value = nom_com_st;
	opener.document.forms[i].d_nom_com_st.value = d_nom_com_st; 
	window.close();
}
 </script>
</head>
...
java.util.List clientesmoneda = new java.util.ArrayList();
clientesmoneda= BFFF.getClientesmonedaList();
iterClientesmoneda = clientesmoneda.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_moneda2.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterClientesmoneda.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterClientesmoneda.next(); 
