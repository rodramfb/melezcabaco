...
String color_fondo ="";
String titulo = "Tipo Cantidad Concepto";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator itertipocantidadconcepto   = null;
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanRRHHTipoCantidadConceptoLov"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idtipocantidadconcepto, tipocantidadconcepto){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idtipocantidadconcepto)
			break;
	opener.document.forms[i].idtipocantidadconcepto.value = idtipocantidadconcepto;
	opener.document.forms[i].tipocantidadconcepto.value = tipocantidadconcepto; 
	window.close();
}
 </script>
</head>
...
tituCol[0] = "Codigo";
tituCol[1] = "Tipo Cantidad Concepto";

java.util.List tipocantidadconcepto = new java.util.ArrayList();
tipocantidadconcepto= BFFF.getrrhhtipocantidadconcepto();
itertipocantidadconcepto = tipocantidadconcepto.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_tipocantidadconcepto.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(itertipocantidadconcepto.hasNext()){
      ++r;
      String[] sCampos = (String[]) itertipocantidadconcepto.next(); 
