...
/* 
   Formulario de carga para la entidad: rrhhobrasocial
...
<html>
<%-- INSTANCIAR BEAN --%>  
<jsp:useBean id="BRF"  class="ar.com.syswarp.web.ejb.BeanRrhhobrasocialFrm"   scope="page"/>
<head>
 <title>FRMRrhhobrasocial.jsp</title>
...
<div id="popupcalendar" class="text"></div>
 ...
 <% 
 String titulo = BRF.getAccion().toUpperCase() + " DE Obra Social" ;
 ...
 %>
<form action="rrhhobrasocialFrm.jsp" method="post" name="frm">
<input name="accion" type="hidden" value="<%=BRF.getAccion()%>" >
<input name="idobrasocial" type="hidden" value="<%=BRF.getIdobrasocial()%>" >
       ...
       <td>
         <table width="100%"  border="0" cellspacing="0" cellpadding="0" align="center">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
              ...
              <tr class="fila-det">
                <td width="12%" class="fila-det-border">Obra social: (*) </td>
                <td width="88%" class="fila-det-border"><input name="obrasocial" type="text" value="<%=BRF.getObrasocial()%>" class="campo" size="50" maxlength="50"  ></td>
              </tr>
              <tr class="fila-det">
                <td class="fila-det-border">&nbsp;</td>
