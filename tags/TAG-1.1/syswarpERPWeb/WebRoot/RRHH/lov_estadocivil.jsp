...
String color_fondo ="";
String titulo = "Estado Civil";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterGeneralEstadoCivil   = null;
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanRrhhestadocivilAbm"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idestadocivil, estadocivil){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idestadocivil)
			break;
	opener.document.forms[i].idestadocivil.value = idestadocivil;
	opener.document.forms[i].estadocivil.value = estadocivil; 
	window.close();
}
 </script>
</head>
...
tituCol[0] = "Codigo";
tituCol[1] = "Estado Civil";

java.util.List generalusuario = new java.util.ArrayList();
generalusuario= BFFF.getRrhhestadocivilList();
iterGeneralEstadoCivil = generalusuario.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_estadocivil.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterGeneralEstadoCivil.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterGeneralEstadoCivil.next(); 
