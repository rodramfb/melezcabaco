...
%>
<html>
<jsp:useBean id="BRA"  class="ar.com.syswarp.web.ejb.BeanRrhhothorasAbm"   scope="page"/>
...
tituCol[0] = "Codigo";
tituCol[1] = "cod Orden Trabajo";
tituCol[2] = "Orden Trabajo";
tituCol[3] = "Detalle";
tituCol[4] = "fecha";
tituCol[5] = "Hora Minuto Entrada 1";
tituCol[6] = "Hora Munuto Salida 1";
tituCol[7] = "Hora Minuto Entrada 2";
tituCol[8] = "Hora Minuto Salida 2";
tituCol[9] = "Total";
...
<form action="rrhhothorasAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
	 ...
	 <td width="14%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[9]%></td>
</tr>
   <%int r = 0;
