...
int i = 0;
Iterator iterclientesestado   = null;
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanRrhhestadosotLov"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idestadoot, estadoot){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idestadoot)
			break;
	opener.document.forms[i].idestadoot.value = idestadoot;
	opener.document.forms[i].estadoot.value = estadoot; 
	window.close();
}
 </script>
</head>
...
clientesestado= BFFF.getestadosotList();
iterclientesestado = clientesestado.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_estadosot.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterclientesestado.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterclientesestado.next(); 
