...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanWkftipoeventosAbm"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idtipoevento, tipoevento){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idtipoevento)
			break;
	opener.document.forms[i].idtipoevento.value = idtipoevento;
	opener.document.forms[i].tipoevento.value = tipoevento; 
	window.close();
}
 </script>
</head>
