...
/* 
   Grilla para la entidad: globalusuarios
...
int i = 0;
Iterator iterGlobalusuarios   = null;
...
%>
<html>
<jsp:useBean id="BGA"  class="ar.com.syswarp.web.ejb.BeanGlobalusuariosAbm"   scope="page"/>
...
tituCol[3] = "E-mail";
tituCol[4] = "Nombre";
tituCol[5] = "Habilitado";
tituCol[6] = "Puesto";
java.util.List Globalusuarios = new java.util.ArrayList();
Globalusuarios= BGA.getGlobalusuariosList();
iterGlobalusuarios = Globalusuarios.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="globalusuariosAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterGlobalusuarios.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterGlobalusuarios.next(); 
