...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanWkfeventosresultadosAbm"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(ideventoresultado, eventoresultado){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].ideventoresultado)
			break;
	opener.document.forms[i].ideventoresultado.value = ideventoresultado;
	opener.document.forms[i].eventoresultado.value = eventoresultado; 
	window.close();
}
 </script>
</head>
...
clientesexpreso= BFFF.getWkfeventosresultadosList();
iterClientestipoevento = clientesexpreso.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_eventoresultado.jsp" method="POST" name="frm">
