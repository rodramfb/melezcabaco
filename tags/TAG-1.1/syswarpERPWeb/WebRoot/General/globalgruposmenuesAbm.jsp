...
/* 
   Grilla para la entidad: globalgruposmenues
...
String color_fondo ="";
String titulo = "Grupos Menues";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterGlobalgruposmenues   = null;
...
%>
<html>
<jsp:useBean id="BGA"  class="ar.com.syswarp.web.ejb.BeanGlobalgruposmenuesAbm"   scope="page"/>
...
tituCol[1] = "Menu";
tituCol[2] = "Nivel";
java.util.List Globalgruposmenues = new java.util.ArrayList();
Globalgruposmenues= BGA.getGlobalgruposmenuesList();
iterGlobalgruposmenues = Globalgruposmenues.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="globalgruposmenuesAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
     ...
     <td width="32%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[1]%></td>
     <td width="43%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[2]%></td>
   </tr>
   <%int r = 0;
   while(iterGlobalgruposmenues.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterGlobalgruposmenues.next(); 
      // estos campos hay que setearlos segun la grilla 
      if (color_fondo.equals("fila-det-verde")) color_fondo = "fila-det";
      else color_fondo = "fila-det-verde";%>
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="idgrupo" value="<%= sCampos[0]%>" onClick="document.frm.idmenu.value = <%= sCampos[1]%>"></td>
...
<%
   ...
   <input name="idmenu" value="" type="hidden">
   </form>
  </body>
</html>
<% 
