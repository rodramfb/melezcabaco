...
int i = 0;
Iterator iterGeneralcontador8   = null;
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idconta_remitos4, conta_remitos4){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idconta_remitos4)
			break;
	opener.document.forms[i].idconta_remitos4.value = idconta_remitos4;
	opener.document.forms[i].conta_remitos4.value = conta_remitos4; 
	window.close();
}
 </script>
</head>
...
iterGeneralcontador8 = generalcontador.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_contador8.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterGeneralcontador8.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterGeneralcontador8.next(); 
