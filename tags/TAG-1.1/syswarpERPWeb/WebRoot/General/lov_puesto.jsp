...
int i = 0;
Iterator iterGeneralpuesto   = null;
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanGeneralPuestoLov"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idpuesto, puesto){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idpuesto)
			break;
	opener.document.forms[i].idpuesto.value = idpuesto;
	opener.document.forms[i].puesto.value = puesto; 
	window.close();
}
 </script>
</head>
...
java.util.List generalpuesto = new java.util.ArrayList();
generalpuesto= BFFF.getGeneralpuestoList();
iterGeneralpuesto = generalpuesto.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_puesto.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterGeneralpuesto.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterGeneralpuesto.next(); 
