...
/* 
   Grilla para la entidad: globalmonedas
...
int i = 0;
Iterator iterGlobalmonedas   = null;
...
%>
<html>
<jsp:useBean id="BGA"  class="ar.com.syswarp.web.ejb.BeanGlobalmonedasAbm"   scope="page"/>
...
tituCol[1] = "Moneda";
tituCol[2] = "Pais";
java.util.List Globalmonedas = new java.util.ArrayList();
Globalmonedas= BGA.getGlobalmonedasList();
iterGlobalmonedas = Globalmonedas.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="globalmonedasAbm.jsp" method="POST" name="frm">
                ...
                <tr>
                   ...
                   <td width="89%">
                      <table width="100%" border="0">
                         <tr>
                           <td width="6%" height="26" class="text-globales">BusScar</td>
                           <td width="22%">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterGlobalmonedas.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterGlobalmonedas.next(); 
      // estos campos hay que setearlos segun la grilla 
      if (color_fondo.equals("fila-det-verde")) color_fondo = "fila-det";
      else color_fondo = "fila-det-verde";%>
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="idmoneda" value="<%= sCampos[0]%>"></td>
