...
/* 
   Grilla para la entidad: wkfprocesoseventos
...
String color_fondo ="";
String titulo = "Procesos Eventos";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterWkfprocesoseventos   = null;
...
%>
<html>
<jsp:useBean id="BWA"  class="ar.com.syswarp.web.ejb.BeanWkfprocesoseventosAbm"   scope="page"/>
...
tituCol[4] = "Proceso Negocio Next";
java.util.List Wkfprocesoseventos = new java.util.ArrayList();
Wkfprocesoseventos= BWA.getWkfprocesoseventosList();
iterWkfprocesoseventos = Wkfprocesoseventos.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="wkfprocesoseventosAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterWkfprocesoseventos.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterWkfprocesoseventos.next(); 
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-bold-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="idprocesoevento" value="<%= sCampos[0]%>"></td>
