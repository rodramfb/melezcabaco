...
String color_fondo ="";
String titulo = "Preferencia";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterorigen   = null;
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanPreferenciasLov"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idpreferencia, preferencia){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idpreferencia)
			break;
	opener.document.forms[i].idpreferencia.value = idpreferencia;
	opener.document.forms[i].preferencia.value = preferencia; 
	window.close();
}
 </script>
</head>
...
java.util.List origen = new java.util.ArrayList();
origen= BFFF.getpreferenciasList();
iterorigen = origen.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_preferencia.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
     ...
     <td width="66%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[1]%></td>
   </tr>
   <%int r = 0;
   while(iterorigen.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterorigen.next(); 
