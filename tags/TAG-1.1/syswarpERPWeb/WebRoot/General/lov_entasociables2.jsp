...
int i = 0;
Iterator iterentidadesasociables   = null;
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanGlobalEntidadesAsociablesLov"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(identidaddestino, entidaddestino){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].identidaddestino)
			break;
	opener.document.forms[i].identidaddestino.value = identidaddestino;
	opener.document.forms[i].entidaddestino.value = entidaddestino; 
	window.close();
}
 </script>
</head>
...
tituCol[0] = "Codigo";
tituCol[1] = "Entidades asociables";

java.util.List entidadesasociables = new java.util.ArrayList();
entidadesasociables= BFFF.getGeneralentidadesasociablesList();
iterentidadesasociables = entidadesasociables.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_entasociables.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   while(iterentidadesasociables.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterentidadesasociables.next(); 
