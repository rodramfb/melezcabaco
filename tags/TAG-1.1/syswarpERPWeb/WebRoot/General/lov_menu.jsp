...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanGlobalmenuesLov"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idmenu, menu){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idmenu)
			break;
	opener.document.forms[i].idmenu.value = idmenu;
	opener.document.forms[i].menu.value = menu; 
	window.close();
}
 </script>
</head>
...
java.util.List generalmenu = new java.util.ArrayList();
generalmenu= BFFF.getGlobalmenuesList();
iterGeneralmenu = generalmenu.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_menu.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterGeneralmenu.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterGeneralmenu.next(); 
