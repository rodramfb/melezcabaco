...
/* 
   Formulario de carga para la entidad: wkfeventosresultados
...
<html>
<%-- INSTANCIAR BEAN --%>  
<jsp:useBean id="BWF"  class="ar.com.syswarp.web.ejb.BeanWkfeventosresultadosFrm"   scope="page"/>
<head>
...
<div id="popupcalendar" class="text"></div>
 ...
 <% 
 String titulo = BWF.getAccion().toUpperCase() + " DE Eventos Resultados" ;
 ...
 %>
<form action="wkfeventosresultadosFrm.jsp" method="post" name="frm">
<input name="accion" type="hidden" value="<%=BWF.getAccion()%>" >
<input name="ideventoresultado" type="hidden" value="<%=BWF.getIdeventoresultado()%>" >
       ...
       <td>
         <table width="100%"  border="0" cellspacing="0" cellpadding="0" align="center">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
              ...
              <tr class="fila-det">
                <td width="19%" class="fila-det-border">Evento Resultado: (*) </td>
                <td width="81%" class="fila-det-border"><input name="eventoresultado" type="text" value="<%=BWF.getEventoresultado()%>" class="campo" size="50" maxlength="50"  ></td>
              </tr>
              <tr class="fila-det">
                <td class="fila-det-border">&nbsp;</td>
