...
public class BeanLovCajaIdentificadoresContraPartida implements SessionBean,
		Serializable {
	static Logger log = Logger
			.getLogger(BeanLovCajaIdentificadoresContraPartida.class);
	...
	public BeanLovCajaIdentificadoresContraPartida() {
		super();
	}
	...
	public boolean ejecutarValidacion() {
		...
		try {
			...
			String filtro = " WHERE (UPPER(tipomov) IN ('S','O','G')"
					+ "    OR (tipomov = 'T' AND propio = 'N')"
					+ "    OR (tipomov = 'D' AND propio = 'N'))";
			if (buscar) {
				...
				this.cajaIdentificadoresList = cajaIdentificadores
						.getLovCajaIdentificadoresConParOcu(this.limit,
				...
				this.cajaIdentificadoresList = cajaIdentificadores
						.getLovCajaIdentificadoresConParAll(this.limit,
