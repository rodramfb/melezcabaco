...
public class BeanContableSumasSaldosRPT_BORRAR implements SessionBean, Serializable {
	static Logger log = Logger.getLogger(BeanContableSumasSaldosRPT_BORRAR.class);
	...
	public BeanContableSumasSaldosRPT_BORRAR() {
		super();
	}
	...
	public boolean ejecutarValidacion() {
		...
		try {
			...
			if (buscar) {
				String entidad = "("
						+ "SELECT idcuenta, cuenta, idempresa  FROM vcontablesumasysaldos  "
						+ "  ) entidad";
				...
				//this.listSaldoCuentas = contable.getSumasSaldos(this.anio, this.idempresa);
