...
public class BeanCajaINFSaldoEfectivoFecha implements SessionBean, Serializable {
	static Logger log = Logger.getLogger(BeanCajaINFSaldoEfectivoFecha.class);
	...
	private List cajaSaldosFecha = new ArrayList();
	...
	public BeanCajaINFSaldoEfectivoFecha() {
		super();
	}
	...
	public boolean ejecutarValidacion() {
		...
		try {
			...
			if (!aceptar.equals("")) {
				...
				this.cajaSaldosFecha = saldoFecha.getSaldosEfectivoFecha(
				...
				if (this.cajaSaldosFecha.size() < 1)
	...
	public List getCajaSaldosFecha() {
		return cajaSaldosFecha;
	}

	public void setCajaSaldosFecha(List cajaSaldosFecha) {
		this.cajaSaldosFecha = cajaSaldosFecha;
	}
