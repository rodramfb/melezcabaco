...
public class BeanConsultaOrdenProduccion implements SessionBean, Serializable {
	static Logger log = Logger.getLogger(BeanConsultaOrdenProduccion.class);
	...
	public BeanConsultaOrdenProduccion() {
		super();
	}
	...
	public boolean ejecutarValidacion() {
		...
		try {
			...
			String entidad = "("
					...
					+ "             END "
					+ "       END AS estado,  "
					+ "       mp.usuarioalt,mp.usuarioact,mp.fechaalt,mp.fechaact, mp.idempresa  "
			...
			if (buscar) {
				...
				//
				// this.totalRegistros =
				// produccionMovProdu.getTotalEntidadFiltro(
				...
				// .getProduccionMovProduOcu(this.limit, this.offset,
				...
				this.produccionMovProduList = Common.getStock()
						.getConsultaOrdenProduccion(this.codigo_st,
								this.idempresa);
			}
