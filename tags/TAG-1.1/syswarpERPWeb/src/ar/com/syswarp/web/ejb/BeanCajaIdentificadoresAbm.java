...
public class BeanCajaIdentificadoresAbm implements SessionBean, Serializable {
	static Logger log = Logger.getLogger(BeanCajaIdentificadoresAbm.class);
	...
	public BeanCajaIdentificadoresAbm() {
		super();
	}
	...
	public boolean ejecutarValidacion() {
		...
		try {
			if (this.accion.equalsIgnoreCase("baja")) {
				if (ididentificador.longValue() < 0) {
					this.mensaje = "Debe seleccionar un registro a eliminar.";
				} else {
					this.mensaje = cajaIdentificadores
							.cajaIdentificadoresDelete(this.ididentificador,
									this.identificador, this.idempresa);
				}
			}
			if (this.accion.equalsIgnoreCase("modificacion")) {
				if (ididentificador.longValue() < 0) {
					...
					dispatcher = request
							.getRequestDispatcher("cajaIdentificadoresFrm.jsp");
			...
			if (buscar) {
				...
				this.totalRegistros = cajaIdentificadores.getTotalEntidadOcu(
						"cajaIdentificadores", campos, this.ocurrencia
								.toUpperCase(), this.idempresa);
				...
				this.cajaIdentificadoresList = cajaIdentificadores
						.getCajaIdentificadoresOcu(this.limit, this.offset,
								this.ocurrencia, this.idempresa);
			} else {
				this.totalRegistros = cajaIdentificadores.getTotalEntidad(
				...
				this.cajaIdentificadoresList = cajaIdentificadores
						.getCajaIdentificadoresAll(this.limit, this.offset,
								this.idempresa);
			}
