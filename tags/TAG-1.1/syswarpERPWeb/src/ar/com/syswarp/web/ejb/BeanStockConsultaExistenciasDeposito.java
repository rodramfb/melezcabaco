...
public class BeanStockConsultaExistenciasDeposito implements SessionBean,
		Serializable {
	...
	static Logger log = Logger
			.getLogger(BeanStockConsultaExistenciasDeposito.class);
	...
	public BeanStockConsultaExistenciasDeposito() {
		super();
	}
	...
	public void ejecutarSentenciaDML() {
		try {
			...
			if (this.mensaje.equalsIgnoreCase("")) {
				this.MovimientosList = Consulta.getExistencias4Deposito(
						this.iddeposito, this.idempresa);
			}
