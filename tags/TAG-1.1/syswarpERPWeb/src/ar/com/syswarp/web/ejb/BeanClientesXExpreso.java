...
public class BeanClientesXExpreso implements SessionBean, Serializable {
	static Logger log = Logger.getLogger(BeanClientesXExpreso.class);
	...
	public boolean ejecutarValidacion() {
		...
		try {
			...
			this.listExpresos = clientes.getClientesexpresosAll(250, 0,
					this.idempresa);

			if (this.idexpreso.longValue() > 0) {
				...
				String entidad = "("
						...
						+ " WHERE ex.idexpreso = " + this.idexpreso.toString()
						+ " ) entidad";
				...
				this.clientesExpresosCPostalList = clientes
						.getClientesXExpresoAll(this.limit, this.offset,
				...
				this.mensaje = "Seleccione Expreso a consultar.";
			}
