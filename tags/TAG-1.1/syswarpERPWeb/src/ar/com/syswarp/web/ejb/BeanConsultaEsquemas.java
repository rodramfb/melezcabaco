...
public class BeanConsultaEsquemas implements SessionBean, Serializable {
	private SessionContext context;

	private BigDecimal idempresa = new BigDecimal(-1);

	static Logger log = Logger.getLogger(BeanConsultaEsquemas.class);
	...
	public boolean ejecutarValidacion() {
		try {
			...
			this.MovimientosList = Consulta.getConsultaEsquema(this.codigo_st,this.idempresa);
		} catch (Exception e) {
