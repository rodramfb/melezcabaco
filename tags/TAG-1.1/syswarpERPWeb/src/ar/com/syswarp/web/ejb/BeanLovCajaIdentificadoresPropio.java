...
public class BeanLovCajaIdentificadoresPropio implements SessionBean,
		Serializable {
	static Logger log = Logger
			.getLogger(BeanLovCajaIdentificadoresPropio.class);
	...
	public BeanLovCajaIdentificadoresPropio() {
		super();
	}
		...
		try {
			...
			if (buscar) {
				...
				this.totalRegistros = cajaIdentificadores
						.getTotalEntidadRelacionOcu(
								"videntificadorestipo",
								new String[] { "propio" },
								new String[] { "'" + this.propio + "'" },
								campos,
								new String[] { this.ocurrencia, this.ocurrencia },
								this.idempresa);
				...
				this.cajaIdentificadoresList = cajaIdentificadores
						.getLovCajaIdentificadoresPropioOcu(this.limit,
								this.offset, this.ocurrencia, this.propio,
								this.idempresa);
			} else {

				String filtro = " WHERE propio = '" + this.propio + "'";
				this.totalRegistros = cajaIdentificadores
				...
				this.cajaIdentificadoresList = cajaIdentificadores
						.getLovCajaIdentificadoresPropioAll(this.limit,
								this.offset, this.propio, this.idempresa);
			}
			...
			if (this.accion.equalsIgnoreCase("agregar")) {
				...
				if (!this.identificador.equals("")) {
					...
					List lista = cajaIdentificadores
							.getLovCajaIdentificadoresPropioOne(
									this.identificador, this.ejercicio,
									this.idempresa);
					if (lista.size() > 0) {
