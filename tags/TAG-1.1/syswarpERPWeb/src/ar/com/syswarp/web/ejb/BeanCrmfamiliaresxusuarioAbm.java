...
public class BeanCrmfamiliaresxusuarioAbm implements SessionBean, Serializable {
	static Logger log = Logger.getLogger(BeanCrmfamiliaresxusuarioAbm.class);
	...
	public BeanCrmfamiliaresxusuarioAbm() {
		super();
	}
		...
		try {
			...
			if (this.accion.equalsIgnoreCase("modificacion")) {
				if (idfamiliar == null
					...
					dispatcher = request
							.getRequestDispatcher("crmfamiliaresxusuarioFrm.jsp");
			...
			if (buscar) {
				String[] campos = { "idfamiliar", "razon_nombre",
						"nexofamiliar", "nombre", "profesion", "actividad",
						"email", "telefonos_part", "celular",
						"fechanacimiento", "deportes", "hobbies",
						"actividad_social", "obseravaciones" };
				this.totalRegistros = crmfamiliares
						.getTotalEntidadOcuxindividuo("vcrmfamiliares", campos,
				...
				this.crmfamiliaresList = crmfamiliares
						.getCrmfamiliaresxindividuoOcu(this.limit, this.offset,
								this.ocurrencia, this.idempresa,
								this.idindividuos);
			} else {
				this.totalRegistros = crmfamiliares.getTotalEntidadxindividuo(
						"crmfamiliares", this.idempresa, this.idindividuos);
				this.totalPaginas = (this.totalRegistros / this.limit) + 1;
				if (this.totalPaginas < this.paginaSeleccion)
					this.paginaSeleccion = this.totalPaginas;
				this.offset = (this.paginaSeleccion - 1) * this.limit;
				...
				this.crmfamiliaresList = crmfamiliares
						.getCrmfamiliaresxindividuoAll(this.limit, this.offset,
