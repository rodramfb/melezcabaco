...
public class BeanConsultaVentasProductosporCategoria implements SessionBean,
		Serializable {
	private SessionContext context;

	private BigDecimal idempresa = new BigDecimal(-1);

	static Logger log = Logger.getLogger(BeanConsultaVentasProductosporCategoria.class);
	...
	public BeanConsultaVentasProductosporCategoria() {
		super();
	}
	...
	public void ejecutarSentenciaDML() {   
		try {
			...
			if (this.accion.equalsIgnoreCase("consulta"))
              ...
              this.MovimientosList = Consulta.getClientesVentasporCategorias(
					this.fechadesde,this.fechahasta,this.idempresa);
