...
public class BeanClientesDetalleTarjetaFrm implements SessionBean, Serializable {
	private SessionContext context;

	static Logger log = Logger.getLogger(BeanClientesDetalleTarjetaFrm.class);
	...
	public BeanClientesDetalleTarjetaFrm() {
		super();
	}
			...
			if (this.accion.equalsIgnoreCase("alta"))
				...
				this.mensaje = clientetarjetascredito
						.clienteTarjetasCreditoUpdate(this.idtarjeta,
								...
								this.orden, this.activa, this.idempresa,
								this.usuarioact);
			else if (this.accion.equalsIgnoreCase("baja"))
				this.mensaje = clientetarjetascredito
						.clienteTarjetasCreditoDelete(this.idtarjeta,
								this.idempresa);
		} catch (Exception ex) {
	...
	public boolean ejecutarValidacion() {
		try {
			if (!this.volver.equalsIgnoreCase("")) {
				response.sendRedirect("ClientesDetalleTarjetaAbm.jsp");
				return true;
			}
