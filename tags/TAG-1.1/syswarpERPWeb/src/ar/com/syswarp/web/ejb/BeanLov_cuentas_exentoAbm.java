...
public class BeanLov_cuentas_exentoAbm implements SessionBean, Serializable {
	static Logger log = Logger.getLogger(BeanLov_cuentas_exentoAbm.class);
	...
	public BeanLov_cuentas_exentoAbm() {
		super();
	}
	...
	public boolean ejecutarValidacion() {
		...
		try {
			...
			if (((Hashtable) session.getAttribute("htNetoExentoConfirma")) != null
					&& !((Hashtable) session
							.getAttribute("htNetoExentoConfirma")).isEmpty()) {

				this.htNetoExentoConfirma = (Hashtable) session
						.getAttribute("htNetoExentoConfirma");
			...
			session.setAttribute("htNetoExentoConfirma",
			...
			if (this.accion.equalsIgnoreCase("confirmar")) {
				...
				if (this.asignarValidar(this.htNetoExentoConfirma)) {
					...
					if (this.auxTNExento == this.TNExento) {
						...
						session.removeAttribute("htNetoExentoConfirma");
						session.setAttribute("htNetoExento", htAux);
					} else
