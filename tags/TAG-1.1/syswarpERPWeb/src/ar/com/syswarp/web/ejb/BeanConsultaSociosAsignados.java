...
public class BeanConsultaSociosAsignados implements SessionBean,
		Serializable {
	private SessionContext context;

	private BigDecimal idempresa = new BigDecimal(-1);

	static Logger log = Logger.getLogger(BeanConsultaSociosAsignados.class);
	...
	public BeanConsultaSociosAsignados() {
		super();
	}
	...
	public void ejecutarSentenciaDML() {
		try {
			...
			if (this.accion.equalsIgnoreCase("consulta"))
              ...
              this.MovimientosList = Consulta.getClientesSociosAsignados(
					this.idcampania,this.idempresa);
			
              this.MovimientosListTotales = Consulta.getClientesSociosAsignadosTotales(
					this.idcampania,this.idempresa);
              
              this.MovimientosListTotalesDS = Consulta.getClientesSociosAsignadosTotalesDS(
  					this.idcampania,this.idempresa);
