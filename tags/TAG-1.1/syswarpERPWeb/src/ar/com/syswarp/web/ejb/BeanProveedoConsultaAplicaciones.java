...
public class BeanProveedoConsultaAplicaciones implements SessionBean,
		Serializable {
	...
	static Logger log = Logger
			.getLogger(BeanProveedoConsultaAplicaciones.class);
	...
	public BeanProveedoConsultaAplicaciones() {
		super();
	}
	...
	public void ejecutarSentenciaDML() {
		try {
			...
			// idempresa);
			this.MovimientosList = Consulta.getProveedoresAplicaciones(
			...
			if (flag) {
				...
				if (this.tipo.equalsIgnoreCase("P")) {
					general.setArchivo(this.MovimientosList, new BigDecimal(
							totCol), "ProveedoresAplicacionesPendiente");
				} else {
					general.setArchivo(this.MovimientosList, new BigDecimal(
							totCol), "ProveedoresAplicacionesHistorico");
				}
	...
	// 20110818 - CAMI - Informe de compras ---------->
