...
public class BeanCrmfamiliaresAbm implements SessionBean, Serializable {
	static Logger log = Logger.getLogger(BeanCrmfamiliaresAbm.class);
	...
	public boolean ejecutarValidacion() {
		...
		try {
			...
			if (buscar) {
				...
				this.totalRegistros = crmfamiliares.getTotalEntidadOcu(
						"vcrmfamiliares", campos, this.ocurrencia,
						this.idempresa);
				...
				this.crmfamiliaresList = crmfamiliares.getCrmfamiliaresOcu(
						this.limit, this.offset, this.ocurrencia,
						this.idempresa);
			} else {
				this.totalRegistros = crmfamiliares.getTotalEntidad(
						"crmfamiliares", this.idempresa);
				this.totalPaginas = (this.totalRegistros / this.limit) + 1;
				if (this.totalPaginas < this.paginaSeleccion)
					this.paginaSeleccion = this.totalPaginas;
				this.offset = (this.paginaSeleccion - 1) * this.limit;
				...
				this.crmfamiliaresList = crmfamiliares.getCrmfamiliaresAll(
