...
public class BeanStockConsultaMovimientosArticuloDeposito implements SessionBean, Serializable {
	private SessionContext context;

	private BigDecimal idempresa = new BigDecimal(-1);

	static Logger log = Logger.getLogger(BeanStockConsultaMovimientosArticuloDeposito.class);
	...
	public BeanStockConsultaMovimientosArticuloDeposito() {
		super();
	}
		...
		try {
			...
			if (this.accion.equalsIgnoreCase("consulta"))
			    ...
			    if (this.mensaje.equalsIgnoreCase("") ){
			    	this.SaldoAnteriorList = Consulta.getMovArticuloDepositoSaldoAnterior(this.codigo_st, this.iddeposito, this.fechadesde, this.fechahasta, idempresa, this.getUsuarioalt());
			    	this.MovimientosList   = Consulta.getMovArticuloDepositoDetalle(this.codigo_st, this.iddeposito, this.fechadesde, this.fechahasta, idempresa, this.getUsuarioalt());
			    	this.SaldoFinalList    = Consulta.getMovArticuloDepositoSaldoFinal(this.codigo_st, this.iddeposito, this.fechadesde, this.fechahasta, idempresa, this.getUsuarioalt());
