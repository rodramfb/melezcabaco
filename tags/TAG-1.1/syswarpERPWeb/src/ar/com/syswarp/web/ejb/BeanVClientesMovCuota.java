...
public class BeanVClientesMovCuota implements SessionBean, Serializable {

	static Logger log = Logger.getLogger(BeanVClientesMovCuota.class);
	...
	public boolean ejecutarValidacion() {
		...
		try {
			...
			this.totalRegistros = clientes.getTotalEntidadFiltro(
					"vclientesmovcuorecepcion", filtro, this.idempresa);
			...
			this.vClientesAplicacionesList = clientes
					.getVClientesMovCuotaXCliente(this.limit, this.offset,
