...
public class BeanPedidosRegalos_cabeFrm implements SessionBean, Serializable {
	private SessionContext context;

	static Logger log = Logger.getLogger(BeanPedidosRegalos_cabeFrm.class);
	...
	public BeanPedidosRegalos_cabeFrm() {
		super();
	}
	...
	public void ejecutarSentenciaDML() {
		try {
			...
			resultado = pedidos_cabe.pedidosRegalosCreate(GeneralBean.setNull(
					this.idcampacabe, 1), idpedidoregalospadre, this.idestado,
					this.idcliente, this.idsucursal, this.iddomicilio,
					(Timestamp) Common.setObjectToStrOrTime(this.fechapedido,
							"StrToJSTs"), this.idcondicion, GeneralBean
							.setNull(this.idvendedor, 1), this.idexpreso,
	...
	private void getDomiciliosCliente(Clientes clientes) {
		try {
			this.listaDomicilios = clientes.getClientesDomiciliosCliente(5000, 0,
					this.idcliente, this.idempresa);
