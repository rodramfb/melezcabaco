...
public class BeanClientesResumenVentasporPeriodoTM implements SessionBean,
		Serializable {
	private SessionContext context;

	private BigDecimal idempresa = new BigDecimal(-1);

	static Logger log = Logger.getLogger(BeanClientesResumenVentasporPeriodoTM.class);
	...
	public BeanClientesResumenVentasporPeriodoTM() {
		super();
	}
	...
	public void ejecutarSentenciaDML() {   
		try {
			...
			if (this.accion.equalsIgnoreCase("consulta"))
              ...
              this.MovimientosList = Consulta.getClientesResumenVentasporPeriodoTMFINAL(
