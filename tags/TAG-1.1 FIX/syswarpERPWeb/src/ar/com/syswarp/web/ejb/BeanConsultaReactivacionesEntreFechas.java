...
public class BeanConsultaReactivacionesEntreFechas implements SessionBean,
		Serializable {
	...
	static Logger log = Logger
			.getLogger(BeanConsultaReactivacionesEntreFechas.class);
	...
	public BeanConsultaReactivacionesEntreFechas() {
		super();
	}
	...
	public void ejecutarSentenciaDML() {
		try {
			...
			this.MovimientosList = Consulta
					.getClientesConsultaReactEntreFechas(fdesde.toString(),
							fhasta.toString(), this.idempresa);
