...
public class BeanProduccionAnulaOrden implements SessionBean, Serializable {
	private SessionContext context;

	private BigDecimal idempresa = new BigDecimal(-1);

	static Logger log = Logger.getLogger(BeanProduccionAnulaOrden.class);
	...
	public BeanProduccionAnulaOrden() {
		super();
	}
	...
	public void ejecutarSentenciaDML() {
		try {
			...
			if (this.accion.equalsIgnoreCase("desarmar")) {
				...
				this.recursivo = 0;
				this.observaciones = "ORDEN: " + this.idop + " / " + this.observaciones;
				resultado = stock.callAnulaOrdenProduccion(this.idop,
