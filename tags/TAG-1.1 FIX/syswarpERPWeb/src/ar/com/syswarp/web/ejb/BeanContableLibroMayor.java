...
public class BeanContableLibroMayor implements SessionBean, Serializable {

	private SessionContext context;

	private BigDecimal idempresa = new BigDecimal(-1);

	static Logger log = Logger.getLogger(BeanContableLibroMayor.class);
	...
	public void ejecutarSentenciaDML() {
		try {
			...
			if (this.cuenta_desde == null
				...
				this.MovimientosList = Consulta.getLibroMayorSinCC(
