...
public class BeanConsultaVendedoresDetalleAsociaciones implements SessionBean,
		Serializable {
	...
	static Logger log = Logger
			.getLogger(BeanConsultaVendedoresDetalleAsociaciones.class);
	...
	public BeanConsultaVendedoresDetalleAsociaciones() {
		super();
	}
	...
	public boolean ejecutarValidacion() {
		try {
			...
			this.MovimientosList = Consulta
					.getCosnultaVendedoresDetalleAsociaciones(this.anio,
							this.mes, this.idvendedor, this.idempresa);
		} catch (Exception e) {
