...
public class BeanClientesAplicacionAutomaticaCobranzas implements SessionBean,
		Serializable {
	private SessionContext context;

	static Logger log = Logger
			.getLogger(BeanClientesAplicacionAutomaticaCobranzas.class);
	...
	public BeanClientesAplicacionAutomaticaCobranzas() {
		super();
	}
	...
	public void ejecutarSentenciaDML() {
		try {
			...
			this.mensaje  = clientes.AplicacionAutomaticaCobranzas(args);
			
			if(this.mensaje.equalsIgnoreCase("OK")){
				this.mensaje = "Aplicación automática exitosa..";
			}
