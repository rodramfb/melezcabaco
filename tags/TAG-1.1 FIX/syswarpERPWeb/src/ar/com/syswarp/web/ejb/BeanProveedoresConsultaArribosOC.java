...
public class BeanProveedoresConsultaArribosOC implements SessionBean, Serializable {
	private SessionContext context;

	private BigDecimal idempresa = new BigDecimal(-1);

	static Logger log = Logger.getLogger(BeanProveedoresConsultaArribosOC.class);
	...
	public BeanProveedoresConsultaArribosOC() {
		super();
	}
		...
		try {
			...
			if (this.accion.equalsIgnoreCase("consulta"))
			    ...
			    if (this.mensaje.equalsIgnoreCase("") ){
		    	   // this.SaldoAnteriorList = Consulta.getMovArticuloSaldoAnterior(this.iddeposito,  this.fechadesde, this.fechahasta, idempresa);
			    	this.MovimientosList   = Consulta.getArriboOCDeposito(this.iddeposito, this.fechadesde, this.fechahasta,new BigDecimal(this.idestadooc), idempresa);
			    	//this.SaldoFinalList    = Consulta.getMovArticuloSaldoFinal(this.iddeposito,  this.fechadesde, this.fechahasta, idempresa);
			    	//20110818 - CAMI - Informes de compras --------->
					...
					if (flag)
					{
						...
						general.setArchivo(this.MovimientosList,new BigDecimal(totCol), "ArriboOCDeposito");
