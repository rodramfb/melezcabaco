...
public class BeanClientesCampaniaLov implements SessionBean, Serializable {
	static Logger log = Logger.getLogger(BeanClientesCampaniaLov.class);
	...
	public BeanClientesCampaniaLov() {
		super();
	}
	...
	public boolean ejecutarValidacion() {
		...
		try {
			...
			if (buscar) {
				...
				this.totalRegistros = clientescampania.getTotalEntidadOcu(
				...
				this.clientescampaniaList = clientescampania
						.getClientesCampanaLovOcu(this.limit, this.offset,
								this.ocurrencia);
			} else {
				this.totalRegistros = clientescampania
						.getTotalEntidad("bacotmcampacabe", this.idempresa);
				this.totalPaginas = (this.totalRegistros / this.limit) + 1;
				if (this.totalPaginas < this.paginaSeleccion)
					this.paginaSeleccion = this.totalPaginas;
				this.offset = (this.paginaSeleccion - 1) * this.limit;
				...
				this.clientescampaniaList = clientescampania
						.getClientesCampanaLovAll(this.limit, this.offset);
			}
