...
public class BeanProveedoConsultaCtaCteLovAplicacion implements SessionBean, Serializable {
	...
	public BeanProveedoConsultaCtaCteLovAplicacion() {
		super();
	}
	...
	public boolean ejecutarValidacion() {
		...
		try {
			...
			if (!this.ocurrencia.trim().equalsIgnoreCase("")) {
				...
				log.info(nrocomprobante);
				this.stockdepositosList = proveedores
						.getProveedoConsultaCtaCteLovAplicacionesAll(limit, offset, nrocomprobante, idempresa);
