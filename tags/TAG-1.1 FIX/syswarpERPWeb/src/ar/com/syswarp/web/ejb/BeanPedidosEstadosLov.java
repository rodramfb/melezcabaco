...
public class BeanPedidosEstadosLov implements SessionBean, Serializable {
	static Logger log = Logger.getLogger(BeanPedidosEstadosLov.class);
	...
	public boolean ejecutarValidacion() {
		...
		try {
			...
			if (buscar) {
				...
				this.pedidosList = pedidosestados.getPedidosEstadosOcu(
				...
				this.pedidosList = pedidosestados.getPedidosEstadosAll(
