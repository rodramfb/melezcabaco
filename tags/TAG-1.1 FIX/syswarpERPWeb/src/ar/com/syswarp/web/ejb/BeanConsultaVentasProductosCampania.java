...
public class BeanConsultaVentasProductosCampania implements SessionBean,
		Serializable {
	private SessionContext context;

	private BigDecimal idempresa = new BigDecimal(-1);

	static Logger log = Logger.getLogger(BeanConsultaVentasProductosCampania.class);
	...
	public BeanConsultaVentasProductosCampania() {
		super();
	}
	...
	public void ejecutarSentenciaDML() {   
		try {
			...
			if (this.accion.equalsIgnoreCase("consulta"))
              ...
              this.MovimientosList = Consulta.getClientesVentasporProductosyCampania(
