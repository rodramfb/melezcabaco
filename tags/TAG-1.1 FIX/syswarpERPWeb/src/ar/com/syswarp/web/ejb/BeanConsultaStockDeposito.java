...
public class BeanConsultaStockDeposito implements SessionBean, Serializable {
	private SessionContext context;

	private BigDecimal idempresa = new BigDecimal(-1);

	static Logger log = Logger.getLogger(BeanConsultaStockDeposito.class);
	...
	public BeanConsultaStockDeposito() {
		super();
	}
	...
	public boolean ejecutarValidacion() {
		try {
			...
			this.MovimientosList = Consulta.getConsultaStockDepositos(this.codigo_st,this.idempresa);
		} catch (Exception e) {
