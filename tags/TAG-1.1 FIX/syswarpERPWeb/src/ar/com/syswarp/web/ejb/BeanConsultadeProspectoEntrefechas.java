...
public class BeanConsultadeProspectoEntrefechas implements SessionBean,
		Serializable {
	...
	static Logger log = Logger
			.getLogger(BeanConsultadeProspectoEntrefechas.class);
	...
	public BeanConsultadeProspectoEntrefechas() {
		super();
	}
	...
	public void ejecutarSentenciaDML() {
		try {
			...
			this.MovimientosList = Consulta.getClientesConsultadePrecarga(
					fdesde.toString(), fhasta.toString(),  this.idtipoclie, this.idempresa);
	...
	public boolean ejecutarValidacion() {
		try {
			...
			this.listTipoClie = Common.getClientes().getClientestipoclieAll(
