...
public class BeanClientesLovIngMov implements SessionBean, Serializable {
	static Logger log = Logger.getLogger(BeanClientesLovIngMov.class);
		...
		try {
			...
			if (buscar) {
				...
				this.totalRegistros = clientesclientes.getTotalEntidadOcu(
						"clientesclientes", campos, this.ocurrencia,
						this.idempresa);
				...
				this.clientesclientesList = clientesclientes
						.getClientesclientesIngMovLovOcu(this.limit, this.offset,
				...
				this.clientesclientesList = clientesclientes
						.getClientesclientesIngMovLovAll(this.limit, this.offset,
								this.idempresa);
			}
