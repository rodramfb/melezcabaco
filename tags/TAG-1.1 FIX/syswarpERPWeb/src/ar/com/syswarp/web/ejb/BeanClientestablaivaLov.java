...
public class BeanClientestablaivaLov implements SessionBean, Serializable {
	static Logger log = Logger.getLogger(BeanClientestablaivaLov.class);
	...
	public BeanClientestablaivaLov() {
		super();
	}
