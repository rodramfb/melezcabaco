...
public class BeanStockConsultaMovimientosArticulo implements SessionBean, Serializable {
	private SessionContext context;

	private BigDecimal idempresa = new BigDecimal(-1);

	static Logger log = Logger.getLogger(BeanStockConsultaMovimientosArticulo.class);
	...
	public BeanStockConsultaMovimientosArticulo() {
		super();
	}
		...
		try {
			...
			if (this.accion.equalsIgnoreCase("consulta"))
			    ...
			    if (this.mensaje.equalsIgnoreCase("") ){
		    	    this.SaldoAnteriorList = Consulta.getMovArticuloSaldoAnterior(this.codigo_st,  this.fechadesde, this.fechahasta, idempresa);
			    	this.MovimientosList   = Consulta.getMovArticuloDetalle(this.codigo_st, this.fechadesde, this.fechahasta, idempresa);
			    	this.SaldoFinalList    = Consulta.getMovArticuloSaldoFinal(this.codigo_st,  this.fechadesde, this.fechahasta, idempresa);
