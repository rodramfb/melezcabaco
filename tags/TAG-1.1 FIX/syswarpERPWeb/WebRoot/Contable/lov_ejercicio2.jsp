...
String color_fondo ="";
String titulo = "Ejercicio";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator itersucursal   = null;
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanContableEjercicioLov" scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(ejerciciohasta,d_ejerciciohasta){
	for(var i = 0; i<10;i++){
	
		if(opener.document.forms[i].ejerciciohasta){
			opener.document.forms[i].ejerciciohasta.value = ejerciciohasta;
			opener.document.forms[i].d_ejerciciohasta.value = d_ejerciciohasta; 
			break;
    }
		
		if(opener.document.forms[i].ejercicioDestino){
			opener.document.forms[i].ejercicioDestino.value = ejerciciohasta;
			opener.document.forms[i].d_ejerciciohasta.value = d_ejerciciohasta; 
			break;
    }
...
java.util.List sucursal = new java.util.ArrayList();
sucursal= BFFF.getContableejercicioList();
itersucursal = sucursal.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_ejercicio2.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   while(itersucursal.hasNext()){
      ++r;
      String[] sCampos = (String[]) itersucursal.next(); 
