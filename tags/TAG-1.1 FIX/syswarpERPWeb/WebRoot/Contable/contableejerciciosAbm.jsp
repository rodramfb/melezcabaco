...
/* 
   Grilla para la entidad: contableejercicios
...
String color_fondo ="";
String titulo = "Ejercicios";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterContableejercicios   = null;
...
%>
<html>
<jsp:useBean id="BCA"  class="ar.com.syswarp.web.ejb.BeanContableejerciciosAbm"   scope="page"/>
...
tituCol[0] = "Ejercicio";
tituCol[1] = "fecha desde";
tituCol[2] = "fecha hasta";
tituCol[3] = "Activo";
java.util.List Contableejercicios = new java.util.ArrayList();
Contableejercicios= BCA.getContableejerciciosList();
iterContableejercicios = Contableejercicios.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="contableejerciciosAbm.jsp" method="POST" name="frm">
  ...
  <tr class="text-globales">
    <td width="100%" height="24" colspan="10" background="imagenes/dialogtop.gif">
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td width="11%" height="38"><table width="43%" border="0">
                    <tr>
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
     ...
     <td width="35%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[3]%></td>
   </tr>
   <%int r = 0;
   while(iterContableejercicios.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterContableejercicios.next(); 
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-bold-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="ejercicio" value="<%= sCampos[0]%>"></td>
