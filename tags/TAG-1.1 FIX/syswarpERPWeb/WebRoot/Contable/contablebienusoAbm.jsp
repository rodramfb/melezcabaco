...
/* 
   Grilla para la entidad: contablebienuso
...
String color_fondo ="";
String titulo = "Bienes de Uso";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterContablebienuso   = null;
...
%>
<html>
<jsp:useBean id="BCA"  class="ar.com.syswarp.web.ejb.BeanContablebienusoAbm"   scope="page"/>
...
tituCol[0] = "Codigo";
tituCol[1] = "Bienes de Uso";
tituCol[2] = "Rubro";
tituCol[3] = "Fecha Compra";
tituCol[4] = "Valor";
tituCol[5] = "Años";
tituCol[6] = "Meses";
java.util.List Contablebienuso = new java.util.ArrayList();
Contablebienuso= BCA.getContablebienusoList();
iterContablebienuso = Contablebienuso.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="contablebienusoAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterContablebienuso.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterContablebienuso.next(); 
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-bold-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="idbienuso" value="<%= sCampos[0]%>"></td>
