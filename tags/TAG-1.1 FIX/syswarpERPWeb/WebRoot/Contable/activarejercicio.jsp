...
<html>
	<%-- INSTANCIAR BEAN --%>
	<jsp:useBean id="BPF"
		class="ar.com.syswarp.web.ejb.BeanContableActivarejercicio" scope="page" />
	<head>
	...
	<BODY>
		...
		<% 
 String titulo = "Activar Ejercicio";
 ...
 %>
		<form action="activarejercicio.jsp" method="post" name="frm">
...
<tr class="fila-det">
								<td width="13%" class="fila-det-border">
									Ejercicio 
		  (*)
		                              <input name="d_ejerciciodesde" type="hidden" class="campo" id="d_ejerciciodesde" value="<%=BPF.getD_ejerciciodesde()%>" size="30" readonly></td>
								<td width="21%" class="fila-det-border"><table width="23%" border="0">
                                  <tr class="fila-det-border">
                                    <td width="61%" ><input name="ejerciciodesde" type="text" class="campo" id="ejerciciodesde" value="<%=BPF.getEjerciciodesde()%>" size="30" readonly></td>
		  ...
		  <td width="53%" class="fila-det-border">&nbsp;</td>
						    ...
						    <td width="13%" height="46" class="fila-det-border">&nbsp;</td>
						    <td width="21%" class="fila-det-border"><input name="validar"
											type="submit" value="Ejecutar" class="boton"></td>
						    <td width="13%" class="fila-det-border">&nbsp;</td>
						    <td width="53%" class="fila-det-border">&nbsp;						</td>
		  </table>
