...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(cent_cost2, d_cent_cost2){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].cent_cost2)
			break;
	opener.document.forms[i].cent_cost2.value = cent_cost2;
	opener.document.forms[i].d_cent_cost2.value = d_cent_cost2; 
	window.close();
}
 </script>
</head>
...
<form action="lov_centro_de_costos3.jsp" method="POST" name="frm">
