...
/* 
   Grilla para la entidad: grafico
...
String color_fondo ="";
String titulo = "GRAFICO";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterGrafico   = null;
...
%>
<html>
<jsp:useBean id="BGA"  class="ar.com.syswarp.web.ejb.report.BeanGraficoAbm"   scope="page"/>
...
tituCol[1] = "Gráfico";
tituCol[2] = "Consulta";
tituCol[3] = "Tipo Grafico";
tituCol[4] = "Data Source";
java.util.List Grafico = new java.util.ArrayList();
Grafico= BGA.getGraficoList();
iterGrafico = Grafico.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="graficoAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterGrafico.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterGrafico.next(); 
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      ...
      <td class="fila-det-border" >&nbsp;<%=str.parteStr(BGA.recuperarValueHtTG(sCampos[3]).toString(), 30, " ...")%></td>
      <td class="fila-det-border" >&nbsp;<%=str.parteStr(BGA.recuperarValueHtDT(sCampos[4] ).toString(), 30, " ...")%></td>
   </tr>
<%
}%>
   </table>
