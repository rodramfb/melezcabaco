...
/* 
   Grilla para la entidad: reportes
...
%>
<html>
<jsp:useBean id="BRA"  class="ar.com.syswarp.web.ejb.report.BeanReportesAbm"   scope="page"/>
                   ...
                   <td width="11%" height="38">
                      <table width="36%" border="0">
                         <tr>
                            ...
                            <td width="27%">
												      <input name="reportes-tablas" id="reportes-tablas" value="reportes-tablas" type="image" src="../imagenes/default/btn_lock_norm.gif"  onMouseOut="MM_swapImgRestore() " onMouseOver="MM_swapImage('usuario-grupos','','../imagenes/default/btn_lock_over.gif',1)" onClick="document.frm.accion.value = this.name">
											      </td>
                         </tr>
                      </table>
                   </td>
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
     ...
     <td width="7%" ><%=tituCol[1]%>&nbsp;</td>
     <td width="23%" ><%=tituCol[2]%>&nbsp;</td>
     <td width="46%" ><%=tituCol[3]%>&nbsp;</td>
