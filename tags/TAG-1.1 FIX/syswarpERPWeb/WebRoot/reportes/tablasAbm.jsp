<%
response.addHeader("Window-target","topFrame");
response.setHeader("Window-target","topFrame");
		 System.out.println("SETEA HEADER  : ");
...
<%
/* 
   Grilla para la entidad: tablas
   Copyrigth(r) sysWarp S.R.L. 
   Fecha de creacion: Wed Jun 28 13:47:32 GMT-03:00 2006 
   Observaciones: 
      .
*/ 
...
%>
<html>
<jsp:useBean id="BTA"  class="ar.com.syswarp.web.ejb.report.BeanTablasAbm"   scope="page"/>
...
tituCol[0] = "Cód.";
tituCol[1] = "Tabla";
tituCol[2] = "Consulta de Carga";
tituCol[3] = "Consulta";
tituCol[4] = "Data Source";

java.util.List Tablas = new java.util.ArrayList();
Tablas= BTA.getTablasList();
                         ...
                         <tr>
                            ...
                            <td width="27%">
                               <input name="baja" id="baja" value="baja" type="image" src="../imagenes/default/btn_remove_norm.gif"  onMouseOut="MM_swapImgRestore() " onMouseOver="MM_swapImage('baja','','../imagenes/default/btn_remove_over.gif',1)" onClick="return confirmarBaja('frm');"> 
														...
														<td width="27%">
															<input name="tablas-graficos" id="tablas-graficos" value="tablas-graficos" type="image" src="../imagenes/default/btn_lock_norm.gif"  onMouseOut="MM_swapImgRestore() " onMouseOver="MM_swapImage('tablas-graficos','','../imagenes/default/btn_lock_over.gif',1)" onClick="document.frm.accion.value = this.name">
														</td>
                         </tr>
                      </table>
                   </td>
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
     ...
     <td width="25%" ><%=tituCol[1]%></td>
     <td width="25%" ><%=tituCol[2]%></td>
     <td width="25%" ><%=tituCol[3]%></td>
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      ...
      <td class="fila-det-border" ><%= str.parteStr(sCampos[3], 30, " ...")%>&nbsp;</td>
      <td class="fila-det-border" ><%= BTA.recuperarValueHtDT( sCampos[4]  )%>&nbsp;</td>
   </tr>
<%
}%>
   </table>
