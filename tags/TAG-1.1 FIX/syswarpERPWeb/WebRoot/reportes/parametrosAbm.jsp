...
/* 
   Grilla para la entidad: parametros
...
String color_fondo ="";
String titulo = "PARAMETROS";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterParametros   = null;
...
%>
<html>
<jsp:useBean id="BPA"  class="ar.com.syswarp.web.ejb.report.BeanParametrosAbm"   scope="page"/>
...
tituCol[1] = "Parametro";
tituCol[2] = "Desc.";
tituCol[3] = "Tipo Param.";
tituCol[4] = "Consulta Validacion";
tituCol[5] = "Data Source";
tituCol[6] = "Obligatorio";
tituCol[7] = "Orden";
java.util.List Parametros = new java.util.ArrayList();
Parametros= BPA.getParametrosList();
iterParametros = Parametros.iterator();


%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="parametrosAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   while(iterParametros.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterParametros.next(); 
      // estos campos hay que setearlos segun la grilla 
      if (color_fondo.equals("fila-det-verde")) color_fondo = "fila-det";
      else color_fondo = "fila-det-verde";%>
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="idparametro" value="<%= sCampos[0]%>"></td>
      <td class="fila-det-border" ><%=sCampos[0]%>&nbsp;</td>
      <td class="fila-det-border" ><%=sCampos[1]%>&nbsp;</td>
      <td class="fila-det-border" ><%=sCampos[2]%>&nbsp;</td>
      <td class="fila-det-border" ><%=str.parteStr(BPA.recuperarValueHtTP(sCampos[3] ).toString(), 30, " ...")%>&nbsp;</td>
      <td class="fila-det-border" ><%=str.parteStr(sCampos[4], 30, " ...")%>&nbsp;</td>
      <td class="fila-det-border" ><%=str.parteStr(BPA.recuperarValueHtDT(sCampos[5] ).toString(), 30, " ...")%>&nbsp;</td>
