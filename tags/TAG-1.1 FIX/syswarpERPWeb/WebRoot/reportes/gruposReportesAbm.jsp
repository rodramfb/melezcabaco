...
/*
Programa gruposReportesAbm.jsp
...
String color_fondo ="";
String titulo = " REPORTES ASOCIADOS AL GRUPO  ";
...
<html>
  <jsp:useBean id="BGRA"  class="ar.com.syswarp.web.ejb.report.BeanGruposReportesAbm"   scope="page"/>
<head>
...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
  ...
  EJECUTAR SETEO DE PROPIEDADES
	--%>
  <jsp:setProperty name="BGRA" property="*" />  	
  <%  
  BGRA.setResponse(response);    
	BGRA.setRequest(request);  		
  BGRA.ejecutarValidacion();
	%>
<%
...
<form action="gruposReportesAbm.jsp" method="POST" name="frm">
     <table width="100%" border="0" cellspacing="0" cellpadding="0" class=color-tabletrim>
	      <tr class="text-globales">
          <td width="100%" height="24" colspan="10" background="imagenes/dialogtop.gif">
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td colspan="2"  class="text-globales"><%=titulo + ": " +  BGRA.getGrupo() %></td>
              </tr>
              <tr>
                    ...
                    <tr>    
                      ...
                      <td width="54%"><input type="submit" name="volver_grupos" value="Volver" class="boton"></td>
                    </tr>
                  </table>
								</td>
                <td width="81%">
									<table width="100%" border="0">
										<tr> 
											...
											<td width="3%"> 
                        <input name="ocurrencia" type="hidden" value="<%=BGRA.getOcurrencia()%>" id="ocurrencia" size="30" maxlength="30">                      </td>
											<td width="95%"> 
														...
														<td>
															<table width="100%" border="0" cellpadding="0" cellspacing="0">
																<tr class="text-globales">
																	...
																	<td width="30%" >&nbsp;Total de registros:&nbsp;<%=BGRA.getTotalRegistros()%>  </td>
																	...
																	<td width="15%" > 
																		<select name="limit" >
																			<%for(i=15; i<= 150 ; i+=15){%>
																			 ...
																			 <%}
																			 if( i >= BGRA.getTotalRegistros() ) break;
																			 %>
																			<%}%>
																			<option value="<%= BGRA.getTotalRegistros()%>">Todos</option>
																		</select> 
																	</td>
																	<td width="11%">&nbsp;P&aacute;gina:</td>
																	<td width="16%"> 
																	<select name="paginaSeleccion" >
																			<%for(i=1; i<= BGRA.getTotalPaginas(); i++){%>
																			<%if ( i==BGRA.getPaginaSeleccion() ){%>
																					<option value="<%=i%>" selected><%=i%></option>
																			<%}else{%>
																					<option value="<%=i%>"><%=i%></option>
																				<%}%>
		...
		<table width="100%"  border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td class="fila-det-bold-rojo"><jsp:getProperty name="BGRA" property="mensaje"/>&nbsp;</td>
			</tr>
		</table>
  ...
  <%int r = 0;
    while(iterReportes.hasNext()){      
	    ...
	    if (color_fondo.equals("fila-det-verde")) color_fondo = "fila-det";
			...
			<tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
				<td class="fila-det-border" ><input type="radio" name="idreporte" value="<%= sCampos[0]%>"></td>
    ...
    <%
		...
		<input name="idgrupo" value="<%= BGRA.getIdgrupo() %>" type="hidden">
</form>
</body>
</html>
<% 
