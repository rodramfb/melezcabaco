...
%>
<html>
<jsp:useBean id="BPMPA"  class="ar.com.syswarp.web.ejb.BeanLovProveedoMovProvAplicar"   scope="page"/>
...
<form action="lov_proveedoMovProvAplicar.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><img src="../imagenes/default/gnome_tango/actions/down.png" width="18" height="18" onClick="bajarDatos( '<%=BPMPA.getTipo().toLowerCase() %>', <%= sCampos[0] %>, '<%= sCampos[6] + " - " + comprob %>', '<%=sCampos[7]%>', '<%=sCampos[8]%>', '<%= fecha %>')"></td>
...
<%
     ...
     <input type="hidden" name="idproveedor" value="<%=BPMPA.getIdproveedor()%>">
     <input type="hidden" name="proveedor"   value="<%=BPMPA.getProveedor()%>">	 	   
