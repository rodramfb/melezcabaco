...
%>
<html>
<jsp:useBean id="BLCEA"  class="ar.com.syswarp.web.ejb.BeanLov_cuentas_exentoAbmUpd"   scope="page"/>
...
<form action="lov_cuentas_exentoUpd.jsp" method="POST" name="frm">
...
<%
	 ...
	 <% 
   Hashtable htNetoExentoConfirma = (Hashtable) session.getAttribute("htNetoExentoConfirmaUpd");
	 if(htNetoExentoConfirma != null && !htNetoExentoConfirma.isEmpty() ){
	   %> 	 
		...
		<tr class="fila-det">
			...
			<td class="fila-det-border">&nbsp;
		  <input type="text" class="campo" name="totalAsiento" value="<%= asientoNE[2] %>" size="10"></td>
