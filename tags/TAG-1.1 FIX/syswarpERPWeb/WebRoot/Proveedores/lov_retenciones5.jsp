...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idretencion5, d_idretencion5){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idretencion5)
			break;
	opener.document.forms[i].idretencion5.value = idretencion5;
	opener.document.forms[i].d_idretencion5.value = d_idretencion5; 
	window.close();
}
 </script>
</head>
...
<form action="lov_retenciones5.jsp" method="POST" name="frm">
