...
<%-- INSTANCIAR BEAN --%>  
<jsp:useBean id="BPMPIF"  class="ar.com.syswarp.web.ejb.BeanProveedoMovProvImpresionFrmUpd"   scope="page"/>
<head>
...
<div id="popupcalendar" class="text"></div>
 ...
 <% 
 String titulo = BPMPIF.getAccion().toUpperCase() + " COMPROBANTES" ;
 ...
 %>
<form action="proveedoMovProvImpresionUpd.jsp" method="post" name="frm">
  <div align="right">
       ...
       <tr>
         <td>
           <table width="100%"  border="0" cellspacing="0" cellpadding="0" align="center"> 
              ...
              <td width="22%" height="27">&nbsp;COMPROBANTE INTERNO NRO.: <%=BPMPIF.getNrointerno() + "" %></td>
              <td width="78%"><img src="../imagenes/default/gnome_tango/apps/pdf.jpg" width="20" height="20" onClick="abrirVentana('../reportes/jasper/generaPDF.jsp?nrointerno=<%= BPMPIF.getNrointerno() %>&plantillaImpresionJRXML=proveed_captura_doc_frame&accion=MODIFICADO', 'comprobante', 750, 450);" style="cursor:pointer"></td>
              </tr>
           </table> 
              <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
...
<td width="26%" class="fila-det-border"><%=  BPMPIF.getStock_fact() %></td>
                ...
                <td height="25" class="fila-det-border">Fecha movimiento:</td>
                  <td class="fila-det-border"><%=BPMPIF.getFechamov()%> <input  type="hidden" name="fechamov" value="<%=BPMPIF.getFechamov()%>" >&nbsp;</td>
                  <td class="fila-det-border">Fecha Vencimiento:</td>
<td class="fila-det-border"><%= BPMPIF.getFechavto() %><input  type="hidden" name="fechavto" value="<%=BPMPIF.getFechavto()%>" >&nbsp;</td>
<td width="0%" class="fila-det-border">&nbsp;</td>
   ...
   if(BPMPIF.getTipomovs().equalsIgnoreCase("C")) out.write("C"); %></td>
                ...
                <tr class="fila-det-bold">
                <td width="16%" height="25" class="fila-det-border">Observaciones:</td>
                ...
                <tr class="fila-det">
								  ...
								  <td colspan="3" class="fila-det-border">
								    <table width="100%" border="0" cellpadding="0" cellspacing="0">
											<tr>
												<td width="8%">&nbsp;</td>
												<td width="19%"><div align="right"><span class="fila-det"><%=BPMPIF.getSubTotalGravado()+""%></span>
...
<input name="porcentajeBonificacion" type="hidden" class="campo" id="porcentajeBonificacion" value="<%=BPMPIF.getPorcentajeBonificacion()%>" size="7" maxlength="6"  >
													%</td>
												<td width="19%"><div align="right"><span class="fila-det"><%=BPMPIF.getBonificacion()+""%></span>
                ...
                <tr class="fila-det">
								...
								<td colspan="3" class="fila-det-border">
									<table width="100%" border="0" cellpadding="0" cellspacing="0">
										<tr>
											<td width="8%">&nbsp;</td>
											<td width="19%"><div align="right"><span class="fila-det"><%=BPMPIF.getNetoGravado()+""%></span>
              ...
              <tr class="fila-det">
								...
								<td colspan="3" class="fila-det-border">
										<table width="100%" border="0" cellpadding="0" cellspacing="0">
											<tr>
												<td width="8%">&nbsp;</td>
												<td width="19%"><div align="right"><span class="fila-det"><%=BPMPIF.getNetoExento()+""%></span>
              ...
              <tr  height="10" class="permiso-cinco">
                  ...
                  <td width="16%" class="fila-det-border">IVA :  </td>
									...
									<table width="100%" border="0" cellpadding="0" cellspacing="0">
										<tr>
											...
											%</td>
											<td width="19%"><div align="right"><span class="fila-det"><%=BPMPIF.getIva()+""%></span>
								...
								<td colspan="3" class="fila-det-border">
									<table width="100%" border="0" cellpadding="0" cellspacing="0">
										<tr>
											...
											%</td>
											<td width="19%"><div align="right"><span class="fila-det"><%=BPMPIF.getPercepcionIva()+""%></span>
                ...
                <td colspan="3" class="fila-det-border">
									<table width="100%" border="0" cellpadding="0" cellspacing="0">
										<tr>
											<td width="8%">&nbsp;</td>
											<td width="19%"><div align="right"><span class="fila-det"><%=Common.getNumeroFormateado(BPMPIF.getImporte().doubleValue(), 10, 2)%></span>
										    <input name="importe" type="hidden" value="<%=Common.getNumeroFormateado(BPMPIF.getImporte().doubleValue(), 10, 2)%>">
											  </div></td>
                      <td width="73%">&nbsp;</td>
										</tr>
									</table>									</td>
