...
String color_fondo ="";
String titulo = "Asientos contables: valores";
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanProveedoConsultaCtaCteLovValores"   scope="page"/>
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
	  ...
	  <td class="fila-det-border" ><%=!Common.setNotNull(sCampos[2]).equalsIgnoreCase("")?sCampos[2]:"No hay detalle"%>&nbsp;</td>
   </tr>
<%
   }%>
   </table>
