...
/* 
   Grilla para la entidad: lovcajaretenciones
...
String color_fondo ="";
String titulo = "Retenciones / Percepciones";
...
%>
<html>
<jsp:useBean id="BCIA"  class="ar.com.syswarp.web.ejb.BeanCajaRetenciones"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 function bajarDatos(codigo, descripcion ){
   opener.document.frm.<%=  BCIA.getCmpCod() %>.value = codigo;
   opener.document.frm.<%=  BCIA.getCmpDesc() %>.value = descripcion; 
...
<form action="lov_cajaretenciones.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" >  
      <td class="fila-det-border" ><img src="../imagenes/default/gnome_tango/actions/down.png" width="18" height="18" style="cursor:pointer" onClick="bajarDatos('<%=sCampos[0]%>', '<%=sCampos[3]%>');"></td>
...
<%
   ...
   <input name="cmpCod" value="<%= BCIA.getCmpCod() %>" type="hidden">	 
   <input name="cmpDesc" value="<%= BCIA.getCmpDesc() %>" type="hidden">	 	 
