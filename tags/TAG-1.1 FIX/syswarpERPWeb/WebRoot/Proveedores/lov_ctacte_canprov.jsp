...
String color_fondo ="";
String titulo = "Asientos contables: aplicaciones";
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanProveedoConsultaCtaCteLovAplicacion"   scope="page"/>
...
deposito = BFFF.getProveedoEstadosOCList();
iterdepositos = deposito.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_ctacte_movteso.jsp" method="POST" name="frm">
<input type="hidden" name="nrocomprobante" value="<%=BFFF.getNrocomprobante()%>">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
	  ...
	  <td class="fila-det-border" ><%=!Common.setNotNull(sCampos[1]).equalsIgnoreCase("")?sCampos[1]:""%>&nbsp;</td>
   </tr>
<%
   }%>
   </table>
