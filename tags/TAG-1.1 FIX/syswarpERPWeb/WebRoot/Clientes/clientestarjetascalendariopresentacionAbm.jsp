...
/* 
   Grilla para la entidad: clientestarjetascalendariopresentacion
...
String color_fondo ="";
String titulo = "Tarjetas Calendario Presentacion";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterClientestarjetascalendariopresentacion   = null;
...
%>
<html>
<jsp:useBean id="BCA"  class="ar.com.syswarp.web.ejb.BeanClientestarjetascalendariopresentacionAbm"   scope="page"/>
...
tituCol[2] = "Año";
tituCol[3] = "Mes";
tituCol[4] = "Fecha Desde";
tituCol[5] = "Fecha Hasta";
java.util.List Clientestarjetascalendariopresentacion = new java.util.ArrayList();
Clientestarjetascalendariopresentacion= BCA.getClientestarjetascalendariopresentacionList();
iterClientestarjetascalendariopresentacion = Clientestarjetascalendariopresentacion.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="clientestarjetascalendariopresentacionAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
     ...
     <td width="17%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[5]%></td>
   </tr>
   <%int r = 0;
   while(iterClientestarjetascalendariopresentacion.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterClientestarjetascalendariopresentacion.next(); 
