...
<html>
	<%-- INSTANCIAR BEAN --%>
	<jsp:useBean id="BPF"
		class="ar.com.syswarp.web.ejb.BeanConsultaSociosCategoriasProvincias" scope="page" />
	<head>
	...
	<BODY>
		...
		<% 
 String titulo = "Estadistica por categoria y provincia";
 ...
 %>
	<form action="ConsultaSocioCategoriasProvincias.jsp" method="post" name="frm">
