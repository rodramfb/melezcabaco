...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanCampaniaLov"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idcampacabe, campacabe){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idcampacabe)
			break;
	opener.document.forms[i].idcampacabe.value = idcampacabe;
	opener.document.forms[i].campacabe.value = campacabe; 
	window.close();
}
 </script>
</head>
...
<form action="lov_campania2.jsp" method="POST" name="frm">
