...
/* 
   Grilla para la entidad: clientesestados
...
%>
<html>
<jsp:useBean id="BCA"  class="ar.com.syswarp.web.ejb.BeanClientesestadosAbm"   scope="page"/>
...
tituCol[1] = "Estado";
tituCol[2] = "Fecha s/n";
java.util.List Clientesestados = new java.util.ArrayList();
Clientesestados= BCA.getClientesestadosList();
iterClientesestados = Clientesestados.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="clientesestadosAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
     ...
     <td width="49%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[2]%></td>
   </tr>
   <%int r = 0;
