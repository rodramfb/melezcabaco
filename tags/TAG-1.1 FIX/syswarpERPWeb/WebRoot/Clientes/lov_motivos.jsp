...
String color_fondo ="";
String titulo = "Motivos";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterClientesmotivos   = null;
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanClientesMotivosLov"   scope="page"/>
...
idestado =  session.getAttribute("idestado").toString();


BFFF.setIdestado(new BigDecimal(idestado));
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idmotivo, motivo){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idmotivo)
			break;
	opener.document.forms[i].idmotivo.value = idmotivo;
	opener.document.forms[i].motivo.value = motivo;
...
java.util.List clientesmotivo = new java.util.ArrayList();
clientesmotivo= BFFF.getclientesmotivosList();
iterClientesmotivos = clientesmotivo.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_motivos.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterClientesmotivos.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterClientesmotivos.next(); 
