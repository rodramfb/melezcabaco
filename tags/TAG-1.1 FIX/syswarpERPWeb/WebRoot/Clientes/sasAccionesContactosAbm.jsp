...
try{
	...
	String color_fondo ="";
	String titulo = "SAS - ACCIONES DE CONTACTOS";
	...
	int i = 0;
	Iterator iterSasAccionesContactos   = null;
...
<html>
	...
	<jsp:useBean id="BSA"  class="ar.com.syswarp.web.ejb.BeanSasAccionesContactosAbm"   scope="page"/>
	...
	tituCol[0] = "Cód.";
	tituCol[1] = "Acción del contacto";
	tituCol[2] = "Tipo de contacto";
	tituCol[3] = "Canal de contacto";
	tituCol[4] = "Motivo del contacto";

	java.util.List SasAccionesContactos = BSA.getSasAccionesContactosList();
	iterSasAccionesContactos = SasAccionesContactos.iterator();
	%>
	...
	<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
		...
		<form action="sasAccionesContactosAbm.jsp" method="POST" name="frm">
														...
														<table width="100%" border="0" cellpadding="0" cellspacing="0">
															<tr class="text-globales">
																<td width="1%" height="19">&nbsp; </td>
																	...
																	<td width="10%" class="text-globales">
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
				<tr class="fila-encabezado">
					...
					<td width="20%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[2]%></td>
     				...
     				<td width="20%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[4]%></td>
     				<td width="20%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[1]%></td>
				</tr>

				<%
				int r = 0;
   				while(iterSasAccionesContactos.hasNext()) {
      				++r;
      				String[] sCampos = (String[]) iterSasAccionesContactos.next(); 
				...
				%>
					...
					<tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
						<td class="fila-det-border" ><input type="radio" name="idAccionContacto" value="<%= sCampos[0]%>"></td>
