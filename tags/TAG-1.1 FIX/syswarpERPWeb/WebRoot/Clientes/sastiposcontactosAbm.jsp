...
/* 
   Grilla para la entidad: sastiposcontactos
...
String color_fondo ="";
String titulo = "SAS - TIPOS DE CONTACTOS";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterSastiposcontactos   = null;
...
%>
<html>
<jsp:useBean id="BSA"  class="ar.com.syswarp.web.ejb.BeanSastiposcontactosAbm"   scope="page"/>
...
tituCol[0] = "Cód.";
tituCol[1] = "Tipo de contacto";
java.util.List Sastiposcontactos = new java.util.ArrayList();
Sastiposcontactos= BSA.getSastiposcontactosList();
iterSastiposcontactos = Sastiposcontactos.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="sastiposcontactosAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
     <td width="3%" >&nbsp;</td>
     <td width="47%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[0]%></td>
     <td width="50%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[1]%></td>
   </tr>
   <%int r = 0;
   while(iterSastiposcontactos.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterSastiposcontactos.next(); 
      // estos campos hay que setearlos segun la grilla 
      if (color_fondo.equals("fila-det-verde")) color_fondo = "fila-det";
      else color_fondo = "fila-det-verde";%>
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="idtipocontacto" value="<%= sCampos[0]%>"></td>
