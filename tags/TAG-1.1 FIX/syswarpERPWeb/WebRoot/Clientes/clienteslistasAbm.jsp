...
/* 
   Grilla para la entidad: clienteslistas
...
int i = 0;
Iterator iterClienteslistas   = null;
...
%>
<html>
<jsp:useBean id="BCA"  class="ar.com.syswarp.web.ejb.BeanClienteslistasAbm"   scope="page"/>
...
tituCol[2] = "Moneda";
tituCol[3] = "Condicion Iva";
tituCol[4] = "Con cuotas";
tituCol[5] = "Decimales";
java.util.List Clienteslistas = new java.util.ArrayList();
Clienteslistas= BCA.getClienteslistasList();
iterClienteslistas = Clienteslistas.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="clienteslistasAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterClienteslistas.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterClienteslistas.next(); 
