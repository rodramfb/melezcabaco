...
int i = 0;
Iterator iterClienteslista   = null;
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanClientesListaLov"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idlista, lista){
	for(var i = 0; i<10;i++)
...
java.util.List clienteslista = new java.util.ArrayList();
clienteslista= BFFF.getClienteslistaList();
iterClienteslista = clienteslista.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_lista.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterClienteslista.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterClienteslista.next(); 
