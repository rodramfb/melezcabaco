...
<head>
	...
	function poblarLista(objTxt){
	  var tokens = objTxt.value.split('@');
		if(tokens.length == 2 && trim(tokens[0]).length > 0  && trim(tokens[1]).length > 0){
		  var option = document.frm.email.options[document.frm.email.options.length] = new Option(objTxt.value, objTxt.value);
		  option.onmouseover = function () {verMail(option.value);};
		}else  
 ...
 //--	
	...
	function setAction(identidad){
	  document.frm.action = 'clientesClientesFrm.jsp#' + identidad.toLowerCase();
	}
	//--
...
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
 ...
 %>
<form action="clientesClientesFrm.jsp" method="post" name="frm"  >
       ...
       <td>
         <table width="95%"  border="0" cellspacing="0" cellpadding="0" align="center">
            ...
            <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
              ...
              <tr class="fila-det">
                <td height="24" class="fila-det-border">Promocion: 
                <input name="promocion" type="hidden" id="promocion" value="<%=BCF.getPromocion()%>"></td>
                <td class="fila-det-border"><%=BCF.getPromocion()%>&nbsp; </td>
                <td class="fila-det-border">&nbsp;</td>
                <td class="fila-det-border">&nbsp;</td>
              </tr>
              <tr class="fila-det">
                ...
                <td class="fila-det-border"><table width="23%" border="0" cellpadding="0" cellspacing="0">
                    <tr class="fila-det-border">
                      <td width="61%" ><input name="categoria" type="text" class="campo" id="categoria" value="<%=str.esNulo(BCF.getCategoria())%>" size="30" readonly></td>
                      <td width="39%">&nbsp;</td>
                    </tr>
                </table></td>
                <td class="fila-det-border">Periodicidad:(*)</td>
                <td class="fila-det-border"><img src="../imagenes/default/gnome_tango/apps/date.png" width="22" height="22" onClick="abrirVentana('../Clientes/clientesPeriodicidadEntregaFrm.jsp?idcliente=<%=BCF.getIdcliente()%>&accion=<%=BCF.getAccion()%>', 'periodicidad', 800, 450)" style="cursor:pointer"></td>
              </tr>
              <tr class="fila-det">
                <td class="fila-det-border">Observaciones:</td>
                <td colspan="3" class="fila-det-border"><textarea name="observacion" cols="80" rows="2" class="campo"><%=str.esNulo(BCF.getObservacion()) %></textarea></td>
              </tr> 
              <tr class="fila-det">
              ...
              <tr class="fila-det">
               ...
               <%--
 				<select name="idcondicion" id="idcondicion" class="campo" style="width:200px" >
                    <option value="-1">Seleccionar</option>
                    <%
                   iter = BCF.getListCondicion().iterator();   
                    while(iter.hasNext()){
              ...
              <tr class="fila-det">
                ...
                <td class="fila-det-border"><table width="23%" border="0" cellpadding="0" cellspacing="0">
                    <tr class="fila-det-border">
                      <td width="61%" >
					    <input name="idctaneto" type="text" class="campo" id="idctaneto" value="<%=str.esNulo(BCF.getIdctaneto())%>" size="20" maxlength="20" readonly>
					   <%--  <input name="idctaneto" type="text" class="campo" id="idctaneto" value="<%=BCF.getIdctaneto()%>" size="30" readonly> --%>
					  </td>
                      <td width="39%"><img src="../imagenes/default/gnome_tango/status/info.png" width="18" height="18" title='Para asignar cuenta es necesario seleccionar "Condici&oacute;n de Pago"' style="cursor:help" ><%-- <img src="../imagenes/default/gnome_tango/actions/filefind.png" width="22" height="22" onClick="abrirVentana('../Clientes/lov_cuentascontables.jsp', 'cuentas', 800, 450)" style="cursor:pointer"> --%></td>
                    </tr>
                </table></td>
              ...
              <tr class="fila-det" >
                <td colspan="4" class="fila-det-border">
                  ...
                  <tr class="text-dos-bold" >
                    <td colspan="4" > <img src="../imagenes/default/gnome_tango/actions/contact-new.png" width="22" height="22"> TARJETAS DE CREDITO DEL CLIENTE                     </td>
                  </tr>  
                  <tr class="text-dos-bold" >
                  ...
                  <tr class="fila-det"> 
                   ...
                   while(iter.hasNext()){
                     ...
                     <%-- <table width="23%" border="0" cellpadding="0" cellspacing="0">
                      <tr class="fila-det-border">
                        <td width="61%" ><input name="idtipotarjeta" type="hidden" id="idtipotarjeta" value="< %=BCF.getIdtipotarjeta()% >"><input name="tipotarjeta" type="text" class="campo" id="tipotarjeta" value="< %=BCF.getTipotarjeta()% >" size="30"  readonly=""></td>
                  ...
                  <tr class="fila-det">
                    ...
                    <td class="fila-det-border"><table width="57%" border="0" cellpadding="0" cellspacing="0">
                      <tr class="fila-det-border">
                        ...
                        <td width="61%" ><img src="../imagenes/default/gnome_tango/actions/gtk-goto-first-ltr.png" width="15" height="15" onClick="sugiereRazon(document.frm.titular)" style="cursor:pointer" title="Copiar Raz&oacute;n"></td>
                      </tr>
                    </table></td>
                ...
                <td colspan="4" class="fila-det-border">
                  ...
                  <tr class="fila-det">
                    ...
                    <td width="31%" class="fila-det-border"><table width="23%" border="0" cellpadding="0" cellspacing="0">
                        <tr class="fila-det-border">
                          ...
                          <td width="39%"><img src="../imagenes/default/gnome_tango/actions/filefind.png" width="22" height="22" onClick="abrirVentana('../Clientes/lov_localidades_anexos.jsp', 'localidad', 800, 450)" style="cursor:pointer"><!--img src="../imagenes/default/gnome_tango/actions/filefind.png" width="22" height="22" onClick="mostrarLOV('../Clientes/lov_localidades.jsp')" style="cursor:pointer"--></td>
                        </tr>
                    </table></td>
                  ...
                  <tr class="fila-det">
                    ...
                    <td class="fila-det-border">
                        ...
                        <option value="<%= BCF.getEmail()[m] %>" onMouseOver="verMail(this.value)"><%= BCF.getEmail()[m] %></option>
												<%} %>
                      </select>											</td>
                  ...
                  <tr class="fila-det">
                    ...
                    <td class="fila-det-border"><table width="23%" border="0" cellpadding="0" cellspacing="0">
                        <tr class="fila-det-border">
                          <td width="61%" ><input name="zona" type="text" class="campo" id="zona" value="<%=str.esNulo(BCF.getZona())%>" size="30"  readonly style="border-style:none"></td>
                  ...
                  <tr class="fila-det">
                    ...
                    <td width="22%" class="fila-det-border"><%-- Vendedor Asignado: 
