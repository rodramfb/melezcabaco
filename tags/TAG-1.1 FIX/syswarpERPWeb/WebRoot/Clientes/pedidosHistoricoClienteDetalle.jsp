...
%>
<html>
<jsp:useBean id="BPDA"  class="ar.com.syswarp.web.ejb.BeanPedidosHistoricoClienteDetalle" scope="page"/>
...
<%
 ...
 String titulo = "DETALLE DEL PEDIDO: " + BPDA.getIdpedido_cabe() + " / SOCIO: "  + BPDA.getIdcliente() + " - " + BPDA.getCliente();
...
<table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" >
       <tr>
         <td>
           ...
           <tr class="text-dos-bold">
             <td colspan="4" >DATOS COMERCIALES </td>
           </tr>
           <tr>
             <td class="fila-det-bold">Estado:</td>
             <td>&nbsp;<%=BPDA.getEstado()%></td>
             <td class="fila-det-bold">Total:</td>
             <td>&nbsp;<%=BPDA.getTotaliva()%></td>
           </tr>
           <tr>
             ...
             <td class="fila-det-bold">Condicion:</td>
             <td>&nbsp;<%=BPDA.getCondicion()%></td>
           </tr>
           <tr>
             <td class="fila-det-bold">Prioridad:</td>
             <td>&nbsp;<%=BPDA.getPrioridad()%></td>
             <td class="fila-det-bold">Vendedor:</td>
             <td>&nbsp;<%=BPDA.getVendedor()%></td>
           </tr>
           <tr>
             <td class="fila-det-bold">Lista:</td>
             <td>&nbsp;<%=BPDA.getDescri_lis()%></td>
             <td class="fila-det-bold">Moneda:</td>
             <td>&nbsp;<%=BPDA.getMoneda()%></td>
           </tr>
           <tr>
             <td class="fila-det-bold">Condicion:</td>
             <td>&nbsp;<%=BPDA.getCondicion()%></td>
             <td class="fila-det-bold">Tipo Iva :</td>
             <td>&nbsp;<%=BPDA.getTipoiva()%></td>
           </tr>
           <tr>
             <td class="fila-det-bold">Tarjeta:</td>
             <td>&nbsp;<%=BPDA.getTarjeta()%></td>
