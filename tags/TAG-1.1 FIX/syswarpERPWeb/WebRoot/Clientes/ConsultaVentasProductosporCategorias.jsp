...
<html>
	<%-- INSTANCIAR BEAN --%>
	<jsp:useBean id="BPF"
		class="ar.com.syswarp.web.ejb.BeanConsultaVentasProductosporCategoria" scope="page" />
	<head>
	...
	<BODY>
		...
		<% 
 String titulo = "Consulta Ventas por Productos por Categorias";
 ...
 %>
	<form action="ConsultaVentasProductosporCategorias.jsp" method="post" name="frm">
