...
String color_fondo ="";
String titulo = "CATEGORIAS CATALOGO";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterBacoRefCatalogoCategoria   = null;
...
%>
<html>
<jsp:useBean id="BBRCCA"  class="ar.com.syswarp.web.ejb.BeanBacoRefCatalogoCategoriaAbm"   scope="page"/>
...
tituCol[3] = "idempresa";
java.util.List BacoRefCatalogoCategoria = new java.util.ArrayList();
BacoRefCatalogoCategoria= BBRCCA.getBacoRefCatalogoCategoriaList();
iterBacoRefCatalogoCategoria = BacoRefCatalogoCategoria.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="bacoRefCatalogoCategoriaAbm.jsp" method="POST" name="frm">
                   ...
                   <td width="89%">
                      <table width="100%" border="0">
                         <tr>
                           ...
                           <td width="22%">
                              <input name="ocurrencia" type="text" value="<%=BBRCCA.getOcurrencia()%>" id="ocurrencia" size="30" maxlength="30">                           </td>
                           <td width="72%">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
     ...
     <td width="35%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[1]%></td>
     <td width="59%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[2]%></td>
    </tr>
   <%int r = 0;
   while(iterBacoRefCatalogoCategoria.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterBacoRefCatalogoCategoria.next(); 
      // estos campos hay que setearlos segun la grilla 
      if (color_fondo.equals("fila-det-verde")) color_fondo = "fila-det";
      else color_fondo = "fila-det-verde";%>
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="idcatalogocategoria" value="<%= sCampos[0]%>"></td>
