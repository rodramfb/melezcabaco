...
int i = 0;
Iterator iterClientesresultado   = null;
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanClientesResultadoLov"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idresultado, resultado){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idresultado)
			break;
	opener.document.forms[i].idresultado.value = idresultado;
	opener.document.forms[i].resultado.value = resultado; 
	window.close();
}
 </script>
</head>
...
java.util.List clientesresultado = new java.util.ArrayList();
clientesresultado= BFFF.getClientesresultadoList();
iterClientesresultado = clientesresultado.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_resultado.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterClientesresultado.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterClientesresultado.next(); 
