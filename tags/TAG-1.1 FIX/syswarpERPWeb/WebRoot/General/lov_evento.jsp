...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idevento, evento){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idevento)
			break;
	opener.document.forms[i].idevento.value = idevento;
	opener.document.forms[i].evento.value = evento; 
	window.close();
}
 </script>
</head>
...
<form action="lov_evento.jsp" method="POST" name="frm">
