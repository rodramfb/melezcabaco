...
/* 
   Grilla para la entidad: wkfeventosresultados
...
String color_fondo ="";
String titulo = "Evento Resultado";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterWkfeventosresultados   = null;
...
%>
<html>
<jsp:useBean id="BWA"  class="ar.com.syswarp.web.ejb.BeanWkfeventosresultadosAbm"   scope="page"/>
...
tituCol[0] = "Codigo";
tituCol[1] = "Evente Resultado";
java.util.List Wkfeventosresultados = new java.util.ArrayList();
Wkfeventosresultados= BWA.getWkfeventosresultadosList();
iterWkfeventosresultados = Wkfeventosresultados.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="wkfeventosresultadosAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
     ...
     <td width="82%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[1]%></td>
   </tr>
   <%int r = 0;
   while(iterWkfeventosresultados.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterWkfeventosresultados.next(); 
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-bold-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="ideventoresultado" value="<%= sCampos[0]%>"></td>
