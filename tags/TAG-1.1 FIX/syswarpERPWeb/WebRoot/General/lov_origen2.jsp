...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanOrigenLov"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idorigen, origen){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idorigen)
			break;
	opener.document.forms[i].idorigen.value = idorigen;
	opener.document.forms[i].origen.value = origen;
    if(opener.document.forms[i].idsuborigen) opener.document.forms[i].idsuborigen.value = "";
    if(opener.document.forms[i].suborigen)opener.document.forms[i].suborigen.value = "";
	window.close();
}
 </script>
</head>
...
origen= BFFF.getOrigenList();
iterorigen = origen.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_origen2.jsp" method="POST" name="frm">
