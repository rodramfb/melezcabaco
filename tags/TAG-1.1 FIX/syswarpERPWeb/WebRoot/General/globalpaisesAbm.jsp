...
/* 
   Grilla para la entidad: globalpaises
...
int i = 0;
Iterator iterGlobalpaises   = null;
...
%>
<html>
<jsp:useBean id="BGA"  class="ar.com.syswarp.web.ejb.BeanGlobalpaisesAbm"   scope="page"/>
...
tituCol[0] = "Codigo";
tituCol[1] = "Pais";
java.util.List Globalpaises = new java.util.ArrayList();
Globalpaises= BGA.getGlobalpaisesList();
iterGlobalpaises = Globalpaises.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="globalpaisesAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterGlobalpaises.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterGlobalpaises.next(); 
      // estos campos hay que setearlos segun la grilla 
      if (color_fondo.equals("fila-det-verde")) color_fondo = "fila-det";
      else color_fondo = "fila-det-verde";%>
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="idpais" value="<%= sCampos[0]%>"></td>
