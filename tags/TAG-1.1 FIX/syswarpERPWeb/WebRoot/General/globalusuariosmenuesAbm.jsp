...
/* 
   Grilla para la entidad: globalusuariosmenues
...
String color_fondo ="";
String titulo = "Usuarios Menues";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterGlobalusuariosmenues   = null;
...
%>
<html>
<jsp:useBean id="BGA"  class="ar.com.syswarp.web.ejb.BeanGlobalusuariosmenuesAbm"   scope="page"/>
...
tituCol[1] = "Menu";
tituCol[2] = "Nivel";
java.util.List Globalusuariosmenues = new java.util.ArrayList();
Globalusuariosmenues= BGA.getGlobalusuariosmenuesList();
iterGlobalusuariosmenues = Globalusuariosmenues.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="globalusuariosmenuesAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterGlobalusuariosmenues.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterGlobalusuariosmenues.next(); 
      // estos campos hay que setearlos segun la grilla 
      if (color_fondo.equals("fila-det-verde")) color_fondo = "fila-det";
      else color_fondo = "fila-det-verde";%>
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
    <td class="fila-det-border" ><input type="radio" name="idusuario" value="<%= sCampos[0]%>" onClick="document.frm.idmenu.value = <%= sCampos[1]%>"></td>
