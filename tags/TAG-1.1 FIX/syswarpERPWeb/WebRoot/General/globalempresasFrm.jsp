...
/* 
   Formulario de carga para la entidad: globalempresas
...
<html>
<%-- INSTANCIAR BEAN --%>  
<jsp:useBean id="BGF"  class="ar.com.syswarp.web.ejb.BeanGlobalempresasFrm"   scope="page"/>
<head>
 <title>FRMGlobalempresas.jsp</title>
...
<div id="popupcalendar" class="text"></div>
 ...
 <% 
 String titulo = BGF.getAccion().toUpperCase() + " DE Empresas" ;
 ...
 %>
<form action="globalempresasFrm.jsp" method="post" name="frm">
<input name="accion" type="hidden" value="<%=BGF.getAccion()%>" >
<input name="idempresa" type="hidden" value="<%=BGF.getIdempresa()%>" >
       ...
       <td>
         <table width="100%"  border="0" cellspacing="0" cellpadding="0" align="center">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
              ...
              <tr class="fila-det">
                <td width="12%" class="fila-det-border">Empresa: (*) </td>
                <td width="88%" class="fila-det-border"><input name="empresa" type="text" value="<%=BGF.getEmpresa()%>" class="campo" size="100" maxlength="100"  ></td>
              </tr>
              <tr class="fila-det">
                <td class="fila-det-border">&nbsp;</td>
