...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanWkfeventosAbm"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idproximoevento, proximoevento){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idproximoevento)
			break;
	opener.document.forms[i].idproximoevento.value = idproximoevento;
	opener.document.forms[i].proximoevento.value = proximoevento; 
	window.close();
}
 </script>
</head>
...
tituCol[0] = "Codigo";
tituCol[1] = "Proximo Evento";

java.util.List clientesexpreso = new java.util.ArrayList();
clientesexpreso= BFFF.getWkfeventosList();
