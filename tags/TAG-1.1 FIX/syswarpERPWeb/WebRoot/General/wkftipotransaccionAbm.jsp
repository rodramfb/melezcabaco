...
/* 
   Grilla para la entidad: wkftipotransaccion
...
String color_fondo ="";
String titulo = "Tipo Transacciones";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterWkftipotransaccion   = null;
...
%>
<html>
<jsp:useBean id="BWA"  class="ar.com.syswarp.web.ejb.BeanWkftipotransaccionAbm"   scope="page"/>
...
java.util.List Wkftipotransaccion = new java.util.ArrayList();
Wkftipotransaccion= BWA.getWkftipotransaccionList();
iterWkftipotransaccion = Wkftipotransaccion.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="wkftipotransaccionAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
     ...
     <td width="89%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[1]%></td>
   </tr>
   <%int r = 0;
   while(iterWkftipotransaccion.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterWkftipotransaccion.next(); 
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-bold-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="idtipotransaccion" value="<%= sCampos[0]%>"></td>
