...
/* 
   Grilla para la entidad: wkfeventos
...
%>
<html>
<jsp:useBean id="BWA"  class="ar.com.syswarp.web.ejb.BeanWkfeventosAbm"   scope="page"/>
...
tituCol[0] = "Codigo";
tituCol[1] = "Evento";
tituCol[2] = "Tipo evento";
tituCol[3] = "Proximo evento";
tituCol[4] = "Descripcion";
java.util.List Wkfeventos = new java.util.ArrayList();
Wkfeventos= BWA.getWkfeventosList();
iterWkfeventos = Wkfeventos.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="wkfeventosAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterWkfeventos.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterWkfeventos.next(); 
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-bold-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="idevento" value="<%= sCampos[0]%>"></td>
