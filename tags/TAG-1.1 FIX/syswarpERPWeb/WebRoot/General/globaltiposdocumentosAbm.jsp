...
/* 
   Grilla para la entidad: globaltiposdocumentos
...
String color_fondo ="";
String titulo = "Tipo Documentos";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterGlobaltiposdocumentos   = null;
...
%>
<html>
<jsp:useBean id="BGA"  class="ar.com.syswarp.web.ejb.BeanGlobaltiposdocumentosAbm"   scope="page"/>
...
tituCol[0] = "codigo";
tituCol[1] = "tipo documento";
java.util.List Globaltiposdocumentos = new java.util.ArrayList();
Globaltiposdocumentos= BGA.getGlobaltiposdocumentosList();
iterGlobaltiposdocumentos = Globaltiposdocumentos.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="globaltiposdocumentosAbm.jsp" method="POST" name="frm">
                   ...
                   <td width="89%">
                      <table width="100%" border="0">
                         <tr>
                           ...
                           <td width="22%">
                              <input name="ocurrencia" type="text" value="<%=BGA.getOcurrencia()%>" id="ocurrencia" size="30" maxlength="30">
                           </td>
                           <td width="72%">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
     ...
     <td width="75%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[1]%></td>
</tr>
   <%int r = 0;
   while(iterGlobaltiposdocumentos.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterGlobaltiposdocumentos.next(); 
      // estos campos hay que setearlos segun la grilla 
      if (color_fondo.equals("fila-det-verde")) color_fondo = "fila-det";
      else color_fondo = "fila-det-verde";%>
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="idtipodocumento" value="<%= sCampos[0]%>"></td>
