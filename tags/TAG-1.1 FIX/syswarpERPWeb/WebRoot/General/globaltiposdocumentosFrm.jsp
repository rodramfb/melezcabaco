...
<html>
<%-- INSTANCIAR BEAN --%>  
<jsp:useBean id="BGF"  class="ar.com.syswarp.web.ejb.BeanGlobaltiposdocumentosFrm"   scope="page"/>
<head>
 <title>FRMGlobaltiposdocumentos.jsp</title>
...
<div id="popupcalendar" class="text"></div>
 ...
 <% 
 String titulo = BGF.getAccion().toUpperCase() + " DE Tipo Documentos" ;
 ...
 %>
<form action="globaltiposdocumentosFrm.jsp" method="post" name="frm">
<input name="accion" type="hidden" value="<%=BGF.getAccion()%>" >
<input name="idtipodocumento" type="hidden" value="<%=BGF.getIdtipodocumento()%>" >
       ...
       <td>
         <table width="100%"  border="0" cellspacing="0" cellpadding="0" align="center">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
              ...
              <tr class="fila-det">
                <td width="15%" class="fila-det-border">Tipo documento: (*) </td>
                <td width="85%" class="fila-det-border"><input name="tipodocumento" type="text" value="<%=BGF.getTipodocumento()%>" class="campo" size="50" maxlength="50"  ></td>
              </tr>
              <tr class="fila-det">
                <td class="fila-det-border">&nbsp;</td>
