...
/* 
   Formulario de carga para la entidad: tickets_severidad
...
<html>
<%-- INSTANCIAR BEAN --%>  
<jsp:useBean id="BTF"  class="ar.com.syswarp.web.ejb.BeanTickets_severidadFrm"   scope="page"/>
<head>
 <title>FRMTickets_severidad.jsp</title>
...
<div id="popupcalendar" class="text"></div>
 ...
 <% 
 String titulo = BTF.getAccion().toUpperCase() + " DE Tickets Severidad" ;
 ...
 %>
<form action="tickets_severidadFrm.jsp" method="post" name="frm">
<input name="accion" type="hidden" value="<%=BTF.getAccion()%>" >
<input name="idseveridad" type="hidden" value="<%=BTF.getIdseveridad()%>" >
       ...
       <td>
         <table width="100%"  border="0" cellspacing="0" cellpadding="0" align="center">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
              ...
              <tr class="fila-det">
                <td width="12%" class="fila-det-border">Severidad: (*) </td>
                <td width="88%" class="fila-det-border"><input name="severidad" type="text" value="<%=BTF.getSeveridad()%>" class="campo" size="50" maxlength="50"  ></td>
              </tr>
              <tr class="fila-det">
                <td class="fila-det-border">&nbsp;</td>
