...
/* 
   Grilla para la entidad: globalentidadesasociacionesmov
...
String color_fondo ="";
String titulo = "Movimientos Asociados";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterGlobalentidadesasociacionesmov   = null;
...
%>
<html>
<jsp:useBean id="BGA"  class="ar.com.syswarp.web.ejb.BeanGlobalentidadesasociacionesmovAbm"   scope="page"/>
...
tituCol[0] = "Cód";
tituCol[1] = "Ent. Origen";
tituCol[2] = "Ent. Destino";
tituCol[3] = "Pk Origen";
tituCol[4] = "Pk Destino";
tituCol[5] = "Fecha";
tituCol[6] = "Observacion";
java.util.List Globalentidadesasociacionesmov = new java.util.ArrayList();
Globalentidadesasociacionesmov= BGA.getGlobalentidadesasociacionesmovList();
iterGlobalentidadesasociacionesmov = Globalentidadesasociacionesmov.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="globalentidadesasociacionesmovAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
     ...
     <td width="13%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[6]%></td>
   </tr>
   <%int r = 0;
   while(iterGlobalentidadesasociacionesmov.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterGlobalentidadesasociacionesmov.next(); 
      // estos campos hay que setearlos segun la grilla 
      if (color_fondo.equals("fila-det-verde")) color_fondo = "fila-det";
      else color_fondo = "fila-det-verde";%>
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="identidadesasociacionesmov" value="<%= sCampos[0]%>"></td>
