...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanTickets_estadosLov"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idestadovista, desc_estadovista){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idestadovista)
			break;
	opener.document.forms[i].idestadovista.value = idestadovista;
	opener.document.forms[i].desc_estadovista.value = desc_estadovista; 
	window.close();
}
 </script>
</head>
...
generalestado= BFFF.getestadoList();
iterGeneralEstado = generalestado.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_estado2.jsp" method="POST" name="frm">
