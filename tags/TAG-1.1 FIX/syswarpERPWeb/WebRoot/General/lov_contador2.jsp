...
int i = 0;
Iterator iterGeneralcontador2   = null;
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idconta_facturasb, conta_facturasb){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idconta_facturasb)
			break;
	opener.document.forms[i].idconta_facturasb.value = idconta_facturasb;
	opener.document.forms[i].conta_facturasb.value = conta_facturasb; 
	window.close();
}
 </script>
</head>
...
iterGeneralcontador2 = generalcontador.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_contador2.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterGeneralcontador2.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterGeneralcontador2.next(); 
