...
<html>
	<%-- INSTANCIAR BEAN --%>
	<jsp:useBean id="BPF"
		class="ar.com.syswarp.web.ejb.BeanConsultaCartaBienvenida" scope="page" />
	<head>
	...
	<BODY>
		...
		<% 
 String titulo = "Carta de Bienvenida";
 ...
 %>
		<form action="cartadebienvenida.jsp" method="post" name="frm">
...
<tr class="fila-det">
								<td width="14%" class="fila-det-border">
									Fecha Activacion (*) </td>
								<td width="23%" class="fila-det-border"><table width="88%" border="0">
                                  <tr class="fila-det-border">
                                    <td width="29%"><input name="fechaactivacion" type="text" class="cal-TextBox"
													id="fechaactivacion" onFocus="this.blur()"
													value="<%=BPF.getFechaactivacion() %>" size="12"
                                    ...
                                    <td width="71%"><a class="so-BtnLink"
													...
													onclick="calSwapImg('BTN_date_6', 'img_Date_DOWN');showCalendar('frm','fechaactivacion','BTN_date_6');return false;"><img
								...
								<td width="52%" class="fila-det-border"><table width="19%" border="0">
                                  <tr class="fila-det-border">
                                    ...
                                    <td width="88%"><a class="so-BtnLink"
													...
													onclick="calSwapImg('BTN_date_7', 'img_Date_DOWN');showCalendar('frm','fechahasta','BTN_date_7');return false;"></a> </td>
                                  </tr>
          </table></td>
						  </tr><tr class="fila-det">
						    <td width="14%" height="46" class="fila-det-border"> Tipo Cliente(*)
				            <input name="idtipoclie" type="hidden" id="idtipoclie" value="<%=BPF.getIdtipoclie()%>"></td>
						    <td width="23%" class="fila-det-border"><table width="23%" border="0">
                              <tr class="fila-det-border">
                                <td width="61%" ><input name="tipoclie" type="text" class="campo" id="tipoclie" value="<%=BPF.getTipoclie()%>" size="30" readonly></td>
                                <td width="39%"><img src="../imagenes/default/gnome_tango/actions/filefind.png" width="22" height="22" onClick="mostrarLOV('../General/lov_clientetipo.jsp')" style="cursor:pointer"></td>
                              </tr>
                            </table></td>
						    <td width="11%" class="fila-det-border">&nbsp;</td>
  ...
  <% BigDecimal totalgeneral = new BigDecimal(0); %> 
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" >
     <td height="22" class="fila-det-border" >&nbsp;<%=sCampos[0]%></td>
      <td width="14%" class="fila-det-border" ><div align="left"><%=sCampos[1]%></div></td>
      <td width="48%" class="fila-det-border" ><%=sCampos[2]%></td>
   </tr>
   <%
   }%>
   </table>
