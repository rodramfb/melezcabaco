...
String titulo = "Tipo Transaccion";
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanWkftipotransaccionAbm"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idtipotransaccion, tipotransaccion){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idtipotransaccion)
			break;
	opener.document.forms[i].idtipotransaccion.value = idtipotransaccion;
	opener.document.forms[i].tipotransaccion.value = tipotransaccion; 
	window.close();
}
 </script>
</head>
...
tituCol[0] = "Codigo";
tituCol[1] = "Tipo Transaccion";

java.util.List clientesexpreso = new java.util.ArrayList();
clientesexpreso= BFFF.getWkftipotransaccionList();
iterClientestipoevento = clientesexpreso.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_tipotransaccion.jsp" method="POST" name="frm">
