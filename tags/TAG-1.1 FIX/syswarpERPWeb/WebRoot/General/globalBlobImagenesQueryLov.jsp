...
<form action="globalBlobImagenesQueryLov.jsp" method="POST" name="frm">
                   ...
                   <td width="98%">
                      <table width="100%" border="0">
                         <tr>
                           ...
                           <td width="22%">
                              <input name="ocurrencia" type="text" value="<%=BGBIA.getOcurrencia()%>" id="ocurrencia" size="30" maxlength="30">                           </td>
                           <td width="72%">
