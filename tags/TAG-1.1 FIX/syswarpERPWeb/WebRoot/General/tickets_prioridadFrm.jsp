...
/* 
   Formulario de carga para la entidad: tickets_prioridad
...
<html>
<%-- INSTANCIAR BEAN --%>  
<jsp:useBean id="BTF"  class="ar.com.syswarp.web.ejb.BeanTickets_prioridadFrm"   scope="page"/>
<head>
 <title>FRMTickets_prioridad.jsp</title>
...
<div id="popupcalendar" class="text"></div>
 ...
 <% 
 String titulo = BTF.getAccion().toUpperCase() + " DE TICKETS_PRIORIDAD" ;
 ...
 %>
<form action="tickets_prioridadFrm.jsp" method="post" name="frm">
<input name="accion" type="hidden" value="<%=BTF.getAccion()%>" >
<input name="idprioridad" type="hidden" value="<%=BTF.getIdprioridad()%>" >
       ...
       <td>
         <table width="100%"  border="0" cellspacing="0" cellpadding="0" align="center">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
              ...
              <tr class="fila-det">
                <td width="12%" class="fila-det-border">Prioridad: (*) </td>
                <td width="88%" class="fila-det-border"><input name="prioridad" type="text" value="<%=BTF.getPrioridad()%>" class="campo" size="50" maxlength="50"  ></td>
              </tr>
              <tr class="fila-det">
                <td class="fila-det-border">&nbsp;</td>
