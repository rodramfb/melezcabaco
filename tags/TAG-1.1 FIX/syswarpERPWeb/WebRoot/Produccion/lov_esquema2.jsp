...
String color_fondo ="";
String titulo = "Esquema";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iteresquema  = null;
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanProduccionEsquemaLov"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(esquemahasta, d_esquemahasta){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].esquemahasta)
			break;
	if(opener.document.forms[i].esquemahasta)		
	  opener.document.forms[i].esquemahasta.value = esquemahasta;
  if(opener.document.forms[i].d_esquemahasta)		
	  opener.document.forms[i].d_esquemahasta.value = d_esquemahasta; 
	window.close();
}
 </script>
</head>
...
java.util.List esquema = new java.util.ArrayList();
esquema= BFFF.getesquemaList();
iteresquema = esquema.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_esquema2.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   while(iteresquema.hasNext()){
      ++r;
      String[] sCampos = (String[]) iteresquema.next(); 
