...
/* 
   ...
   Fecha de creacion: Mon Nov 13 22:01:41 GMT-03:00 2006 
   Observaciones: 
      .
...
String color_fondo ="";
String titulo = "Ayuda de Contadores";
...
%>
<html>
<jsp:useBean id="BGA"  class="ar.com.syswarp.web.ejb.BeanGlobalContadoresAbm"   scope="page"/>
...
function passBack(idcontador, contador) {
  var i = 0;
   for(i=0;i<10;i++) if(opener.document.forms[i].idcontador) break;    
...
GlobalContadores= BGA.getGlobalContadoresList();
iterGlobalContadores = GlobalContadores.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_contador.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
     ...
     <td width="50%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[3]%></td>
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td width="3%" class="fila-det-border" ><a href="javascript:passBack('<%=sCampos[0]%>','<%=sCampos[1]%>')"><img src="../imagenes/default/lupa.gif" width="21" height="17" border="0"></a></td>
