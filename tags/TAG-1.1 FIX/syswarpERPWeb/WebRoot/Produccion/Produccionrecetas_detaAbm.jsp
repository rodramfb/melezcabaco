...
/* 
   Grilla para la entidad: produccionRecetas_deta
...
int i = 0;
Iterator iterProduccionRecetas_deta   = null;
...
%>
<html>
<jsp:useBean id="BPRA"  class="ar.com.syswarp.web.ejb.BeanProduccionrecetas_detaAbm"   scope="page"/>
<%-- EJECUTAR SETEO DE PROPIEDADES --%>
<jsp:setProperty name="BPRA" property="*" />
<%

 //String codigo_st =  request.getParameter("codigo_st");
...
String titulo = "DETALLE DE LA RECETA : " + descrip_st ;  

BPRA.setCodigo_st_cabe(codigo_st_cabe);
...
tituCol[0] = "C.Articulo";
tituCol[1] = "Articulo";
tituCol[2] = "Tipo";
tituCol[3] = "Cantidad";
tituCol[4] = "Imprime?";
tituCol[5] = "Margen Error";
java.util.List ProduccionRecetas_deta = new java.util.ArrayList();
ProduccionRecetas_deta= BPRA.getProduccionRecetas_detaList();
iterProduccionRecetas_deta = ProduccionRecetas_deta.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="Produccionrecetas_detaAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterProduccionRecetas_deta.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterProduccionRecetas_deta.next(); 
