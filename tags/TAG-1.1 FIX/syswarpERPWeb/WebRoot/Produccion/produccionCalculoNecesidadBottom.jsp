...
function imprimeComprobante(){
	...
	window.parent.frames['produccionCNTopFrame'].focus();
	if(app.indexOf("microsoft")!= "-1")
		window.print(); 
	else if(app.indexOf("netscape")!= "-1")
		window.parent.frames['produccionCNTopFrame'].print();
}
...
<table width="90%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr class="fila-det">
    ...
    <td width="31%" >
      <input name="imprimir" type="button" class="boton" id="imprimir" value="Imprimir Orden" onClick="imprimeComprobante()">
</td>
    <td width="28%" >&nbsp;</td>
    <td width="22%"  >&nbsp;</td>
  </tr>
