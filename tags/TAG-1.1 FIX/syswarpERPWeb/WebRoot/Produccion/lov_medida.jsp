...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanStockMedidasLov"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(codigo_md, d_codigo_md){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].codigo_md)
			break;
	if(opener.document.forms[i].codigo_md)		
	  opener.document.forms[i].codigo_md.value = codigo_md;
  if(opener.document.forms[i].d_codigo_md)		
	  opener.document.forms[i].d_codigo_md.value = d_codigo_md; 
	window.close();
}
 </script>
</head>
...
java.util.List medidas = new java.util.ArrayList();
medidas= BFFF.getmedidasList();
itermedidas = medidas.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_medida.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(itermedidas.hasNext()){
      ++r;
      String[] sCampos = (String[]) itermedidas.next(); 
