...
String color_fondo ="";
String titulo = "Tipo cotizacion";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator itertipocotizacion   = null;
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanCrmtiposcotizacionesAbm"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idtipocotizacion, tipocotizacion){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idtipocotizacion)
			break;
	opener.document.forms[i].idtipocotizacion.value = idtipocotizacion;
	opener.document.forms[i].tipocotizacion.value = tipocotizacion; 
	window.close();
}
 </script>
</head>
...
java.util.List tipocotizacion = new java.util.ArrayList();
tipocotizacion= BFFF.getCrmtiposcotizacionesList();
itertipocotizacion = tipocotizacion.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_tipocotizacion.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(itertipocotizacion.hasNext()){
      ++r;
      String[] sCampos = (String[]) itertipocotizacion.next(); 
