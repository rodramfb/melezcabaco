...
/*  
   Grilla para la entidad: crmclasificacionclientes
...
String color_fondo ="";
String titulo = "Clasificacion de Clientes";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterCrmclasificacionclientes   = null;
...
%>
<html>
<jsp:useBean id="BCA"  class="ar.com.syswarp.web.ejb.BeanCrmclasificacionclientesAbm"   scope="page"/>
...
tituCol[2] = "Tipo cliente";
tituCol[3] = "Observaciones";
java.util.List Crmclasificacionclientes = new java.util.ArrayList();
Crmclasificacionclientes= BCA.getCrmclasificacionclientesList();
iterCrmclasificacionclientes = Crmclasificacionclientes.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="crmclasificacionclientesAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterCrmclasificacionclientes.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterCrmclasificacionclientes.next(); 
      // estos campos hay que setearlos segun la grilla 
      if (color_fondo.equals("fila-det-verde")) color_fondo = "fila-det";
      else color_fondo = "fila-det-verde";%>
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="idclasificacioncliente" value="<%= sCampos[0]%>"></td>
