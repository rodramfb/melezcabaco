...
String color_fondo ="";
String titulo = "Tipo finaciacion";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterTipofinanciacion   = null;
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanCrmtiposfinanciacionesAbm"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idtipofinanciacion, tipofinanciacion){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idtipofinanciacion)
			break;
	opener.document.forms[i].idtipofinanciacion.value = idtipofinanciacion;
	opener.document.forms[i].tipofinanciacion.value = tipofinanciacion; 
	window.close();
}
 </script>
</head>
...
tituCol[0] = "Codigo";
tituCol[1] = "Tipo financiacion";

java.util.List tipofinanciacion = new java.util.ArrayList();
tipofinanciacion= BFFF.getCrmtiposfinanciacionesList();
iterTipofinanciacion = tipofinanciacion.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_tipofinanciacion.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterTipofinanciacion.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterTipofinanciacion.next(); 
