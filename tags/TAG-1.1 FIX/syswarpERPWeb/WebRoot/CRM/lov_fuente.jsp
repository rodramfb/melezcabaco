...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanCrmfuentecaptacionAbm"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idfuente, fuente){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idfuente)
			break;
	opener.document.forms[i].idfuente.value = idfuente;
	opener.document.forms[i].fuente.value = fuente; 
	window.close();
}
 </script>
</head>
...
java.util.List fuente = new java.util.ArrayList();
fuente= BFFF.getCrmfuentecaptacionList();
iterfuente = fuente.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_fuente.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   while(iterfuente.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterfuente.next(); 
