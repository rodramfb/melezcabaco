...
String color_fondo ="";
String titulo = "Ordenes de Trabajo";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterordentrabajo   = null;
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanGlobaOrdendetrabajoxlusuariosLov"   scope="page"/>
...
<%
 ...
 BFFF.setUsuario(session.getAttribute("usuario").toString()); 
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idordendetrabajo, ordendetrabajo){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idordendetrabajo)
			break;
	opener.document.forms[i].idordendetrabajo.value = idordendetrabajo;
	opener.document.forms[i].ordendetrabajo.value = ordendetrabajo; 
	window.close();
}
 </script>
</head>
...
tituCol[0] = "Codigo";
tituCol[1] = "orden de trabajo";

java.util.List ordentrabajo = new java.util.ArrayList();
ordentrabajo= BFFF.getGlobalusuarioList();
iterordentrabajo = ordentrabajo.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_ordentrabajo2.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterordentrabajo.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterordentrabajo.next(); 
