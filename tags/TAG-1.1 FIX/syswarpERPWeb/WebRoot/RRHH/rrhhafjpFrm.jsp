...
/* 
   Formulario de carga para la entidad: rrhhafjp
...
<html>
<%-- INSTANCIAR BEAN --%>  
<jsp:useBean id="BRF"  class="ar.com.syswarp.web.ejb.BeanRrhhafjpFrm"   scope="page"/>
<head>
 <title>FRMRrhhafjp.jsp</title>
...
<div id="popupcalendar" class="text"></div>
 ...
 <% 
 String titulo = BRF.getAccion().toUpperCase() + " DE AFJP" ;
 ...
 %>
<form action="rrhhafjpFrm.jsp" method="post" name="frm">
<input name="accion" type="hidden" value="<%=BRF.getAccion()%>" >
<input name="idafjp" type="hidden" value="<%=BRF.getIdafjp()%>" >
         ...
         <table width="100%"  border="0" cellspacing="0" cellpadding="0" align="center">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
              ...
              <tr class="fila-det">
                ...
                <td width="88%" class="fila-det-border"><input name="afjp" type="text" value="<%=BRF.getAfjp()%>" class="campo" size="50" maxlength="50"  ></td>
              </tr>
              <tr class="fila-det">
                <td width="12%" class="fila-det-border">Expediente: (*) </td>
                <td width="88%" class="fila-det-border"><input name="expediente" type="text" value="<%=BRF.getExpediente()%>" class="campo" size="10" maxlength="10"  ></td>
              </tr>
              <tr class="fila-det">
                <td class="fila-det-border">&nbsp;</td>
