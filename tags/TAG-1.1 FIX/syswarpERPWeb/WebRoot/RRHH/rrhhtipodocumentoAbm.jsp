...
/* 
   Grilla para la entidad: rrhhtipodocumento
...
String color_fondo ="";
String titulo = "Tipo Documento";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterRrhhtipodocumento   = null;
...
%>
<html>
<jsp:useBean id="BRA"  class="ar.com.syswarp.web.ejb.BeanRrhhtipodocumentoAbm"   scope="page"/>
...
java.util.List Rrhhtipodocumento = new java.util.ArrayList();
Rrhhtipodocumento= BRA.getRrhhtipodocumentoList();
iterRrhhtipodocumento = Rrhhtipodocumento.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="rrhhtipodocumentoAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
     <td width="3%" >&nbsp;</td>
     <td width="28%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[0]%></td>
     <td width="69%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[1]%></td>
</tr>
   <%int r = 0;
   while(iterRrhhtipodocumento.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterRrhhtipodocumento.next(); 
