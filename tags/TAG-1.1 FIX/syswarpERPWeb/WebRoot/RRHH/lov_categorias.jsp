...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanRrhhcategoriasAbm"   scope="page"/>
...
generalusuario= BFFF.getRrhhcategoriasList();
itercategorias = generalusuario.iterator();
%>
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   while(itercategorias.hasNext()){
      ++r;
      String[] sCampos = (String[]) itercategorias.next(); 
