...
/* 
   Formulario de carga para la entidad: rrhhlista
...
<html>
<%-- INSTANCIAR BEAN --%>  
<jsp:useBean id="BRF"  class="ar.com.syswarp.web.ejb.BeanRrhhlistaFrm"   scope="page"/>
<head>
 <title>FRMRrhhlista</title>
...
<div id="popupcalendar" class="text"></div>
 ...
 <% 
 String titulo = BRF.getAccion().toUpperCase() + " DE RRHHLISTA" ;
 ...
 %>
<form action="rrhhlistaFrm.jsp" method="post" name="frm">
<input name="accion" type="hidden" value="<%=BRF.getAccion()%>" >
<input name="idlista" type="hidden" value="<%=BRF.getIdlista()%>" >
         ...
         <table width="100%"  border="0" cellspacing="0" cellpadding="0" align="center">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
              ...
              <tr class="fila-det">
                ...
                <td width="88%" class="fila-det-border">&nbsp;<input name="lista" type="text" value="<%=BRF.getLista()%>" class="campo" size="50" maxlength="50"  ></td>
              </tr>
              <tr class="fila-det">
                <td class="fila-det-border">&nbsp;</td>
