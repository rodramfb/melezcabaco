...
/* 
   Grilla para la entidad: rrhhlistaconceptos
...
String color_fondo ="";
String titulo = "Recursos humanos: Conceptos enlistados";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterRrhhlistaconceptos   = null;
...
%>
<html>
<jsp:useBean id="BRA"  class="ar.com.syswarp.web.ejb.BeanRrhhlistaconceptosAbm"   scope="page"/>
...
tituCol[1] = "Lista";
tituCol[2] = "Concepto";
java.util.List Rrhhlistaconceptos = new java.util.ArrayList();
Rrhhlistaconceptos= BRA.getRrhhlistaconceptosList();
iterRrhhlistaconceptos = Rrhhlistaconceptos.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_listasconceptos.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterRrhhlistaconceptos.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterRrhhlistaconceptos.next(); 
