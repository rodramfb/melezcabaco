...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(unialt4_st, d_unialt4_st){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].unialt4_st)
			break;
	opener.document.forms[i].unialt4_st.value = unialt4_st;
	opener.document.forms[i].d_unialt4_st.value = d_unialt4_st; 
	window.close();
}
 </script>
</head>
...
<form action="lov_medida4.jsp" method="POST" name="frm">
