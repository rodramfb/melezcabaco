...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(iddepositodesde, depositodesde){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].iddepositodesde)
			break;
	opener.document.forms[i].iddepositodesde.value = iddepositodesde;
	opener.document.forms[i].depositodesde.value = depositodesde; 
	window.close();
}
 </script>
</head>
...
<form action="lov_deposito_desde_informe.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
     ...
     <td width="94%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[1]%></td>
   </tr>
   <%int r = 0;
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><img src="../imagenes/default/gnome_tango/actions/down.png" width="20" height="20" onClick="bajarDatos('<%=sCampos[0]%>', '<%=sCampos[1]%>' )"></td>
