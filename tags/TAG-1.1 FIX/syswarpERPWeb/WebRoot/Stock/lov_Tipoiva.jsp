...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanClientestablaivaLov"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(tipoiva_st, d_tipoiva_st){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].tipoiva_st)
			break;
	opener.document.forms[i].tipoiva_st.value = tipoiva_st;
	opener.document.forms[i].d_tipoiva_st.value = d_tipoiva_st; 
	window.close();
}
 </script>
</head>
...
clientestablaiva= BFFF.getClientestablaivaList();
iterClientestablaiva = clientestablaiva.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_Tipoiva.jsp" method="POST" name="frm">
