...
<html>
	<%-- INSTANCIAR BEAN --%>
	<jsp:useBean id="BPF"
		class="ar.com.syswarp.web.ejb.BeanConsultaStockDeposito" scope="page" />
	<head>
		<title>Consulta especial de stock caracas</title>
	...
	<BODY>
		...
		<% 
 String titulo = "Consulta especial de stock caracas ";
 ...
 %>
		<form action="ConsultasStockDepositos.jsp" method="post" name="frm">
