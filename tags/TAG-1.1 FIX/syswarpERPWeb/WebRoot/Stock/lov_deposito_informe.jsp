...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(iddeposito, deposito){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].iddeposito)
			break;
	opener.document.forms[i].iddeposito.value = iddeposito;
	opener.document.forms[i].deposito.value = deposito; 
	window.close();
}
 </script>
</head>
...
<form action="lov_deposito_informe.jsp" method="POST" name="frm">
