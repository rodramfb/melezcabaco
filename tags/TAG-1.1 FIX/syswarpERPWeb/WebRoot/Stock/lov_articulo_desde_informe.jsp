...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(codigo_desde_st, descrip_desde_st){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].codigo_desde_st)
			break;
	opener.document.forms[i].codigo_desde_st.value = codigo_desde_st;
	opener.document.forms[i].descrip_desde_st.value = descrip_desde_st; 
	window.close();
}
 </script>
</head>
...
java.util.List clientesdescrip_st = new java.util.ArrayList();
clientesdescrip_st= BFFF.getclientesarticuloList();
iterClientesarticulo = clientesdescrip_st.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_articulo_desde_informe.jsp" method="POST" name="frm">
