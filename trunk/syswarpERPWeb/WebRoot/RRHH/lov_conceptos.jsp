...
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
 ...
 <script language="JavaScript" src="<%=pathscript%>/forms.js"></script>
  <script >
function bajarDatos(idconcepto, concepto){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idconcepto)
			break;
	opener.document.forms[i].idconcepto.value = idconcepto;
	opener.document.forms[i].concepto.value = concepto; 
	window.close();
}
 </script>
</head>
...
<form action="lov_conceptos.jsp" method="POST" name="frm">
