...
/* 
   Grilla para la entidad: rrhhmotivobaja
...
%>
<html>
<jsp:useBean id="BRA"  class="ar.com.syswarp.web.ejb.BeanRrhhmotivoAbm"   scope="page"/>
...
tituCol[0] = "Cód.";
tituCol[1] = "Motivo";
java.util.List Rrhhmotivo = new java.util.ArrayList();
Rrhhmotivo= BRA.getRrhhmotivoList();
iterRrhhmotivo = Rrhhmotivo.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="rrhhmotivoAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterRrhhmotivo.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterRrhhmotivo.next(); 
