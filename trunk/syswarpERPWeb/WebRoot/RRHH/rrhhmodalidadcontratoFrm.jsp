...
/* 
   Formulario de carga para la entidad: rrhhactividad
...
<html>
<%-- INSTANCIAR BEAN --%>  
<jsp:useBean id="BRF"  class="ar.com.syswarp.web.ejb.BeanRrhhmodalidadcontratoFrm"   scope="page"/>
<head>
 <title>FRMRrhhmodalidadcontrato.jsp</title>
...
<div id="popupcalendar" class="text"></div>
 ...
 <% 
 String titulo = BRF.getAccion().toUpperCase() + " DE Modalidad de Contrato" ;
 ...
 %>
<form action="rrhhmodalidadcontratoFrm.jsp" method="post" name="frm">
<input name="accion" type="hidden" value="<%=BRF.getAccion()%>" >
<input name="idmodalidadcontrato" type="hidden" value="<%=BRF.getIdmodalidadcontrato()%>" >
       ...
       <td>
         <table width="100%"  border="0" cellspacing="0" cellpadding="0" align="center">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
              ...
              <tr class="fila-det">
                <td width="20%" class="fila-det-border">Modalidad de Contrato : (*) </td>
                <td width="80%" class="fila-det-border"><input name="modalidadcontrato" type="text" value="<%=BRF.getModalidadcontrato()%>" class="campo" size="50" maxlength="50"  >
                </td>
              </tr>
              <tr class="fila-det">
                <td class="fila-det-border">&nbsp;</td>
