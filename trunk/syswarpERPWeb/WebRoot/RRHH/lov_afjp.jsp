...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanRrhhafjpAbm"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idafjp, afjp){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idafjp)
			break;
	opener.document.forms[i].idafjp.value = idafjp;
	opener.document.forms[i].afjp.value = afjp; 
	window.close();
}
 </script>
</head>
...
generalusuario= BFFF.getRrhhafjpList();
iterafjp = generalusuario.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_afjp.jsp" method="POST" name="frm">
