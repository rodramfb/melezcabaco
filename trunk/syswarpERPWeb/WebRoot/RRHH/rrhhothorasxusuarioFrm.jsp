...
<html>
<%-- INSTANCIAR BEAN --%>  
<jsp:useBean id="BRF"  class="ar.com.syswarp.web.ejb.BeanRrhhothorasXusuarioFrm"   scope="page"/>
<head>
...
<div id="popupcalendar" class="text"></div>
 ...
 %>
<form action="rrhhothorasxusuarioFrm.jsp" method="post" name="frm">
...
<input name="ordendetrabajo" type="hidden" class="campo" id="ordendetrabajo" value="<%=BRF.getOrdendetrabajo()%>">		  
