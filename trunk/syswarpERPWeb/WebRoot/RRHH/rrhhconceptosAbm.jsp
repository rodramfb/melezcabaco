...
/* 
   Grilla para la entidad: rrhhconceptos
...
int i = 0;
Iterator iterRrhhconceptos   = null;
...
%>
<html>
<jsp:useBean id="BRA"  class="ar.com.syswarp.web.ejb.BeanRrhhconceptosAbm"   scope="page"/>
...
tituCol[2] = "Imprime";
tituCol[3] = "Formula";
tituCol[4] = "Cuenta Contable";
tituCol[5] = "Tipo Concepto";
tituCol[6] = "Tipo Cantidad Concepto";
tituCol[7] = "Valor";

java.util.List Rrhhconceptos = new java.util.ArrayList();
Rrhhconceptos= BRA.getRrhhconceptosList();
iterRrhhconceptos = Rrhhconceptos.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="rrhhconceptosAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
	 ...
	 <td width="15%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[4]%></td>
   ...
   <%int r = 0;
   while(iterRrhhconceptos.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterRrhhconceptos.next(); 
