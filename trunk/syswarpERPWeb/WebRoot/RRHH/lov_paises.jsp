...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanGlobalpaisesAbm"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idpais, pais){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idpais)
			break;
	opener.document.forms[i].idpais.value = idpais;
	opener.document.forms[i].pais.value = pais; 
	window.close();
}
 </script>
</head>
...
generalusuario= BFFF.getGlobalpaisesList();
iterPaises = generalusuario.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_paises.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterPaises.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterPaises.next(); 
