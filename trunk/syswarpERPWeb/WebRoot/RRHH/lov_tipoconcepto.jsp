...
String color_fondo ="";
String titulo = "Tipo Concepto";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterTipoConcepto   = null;
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanRRHHTipoConceptoLov"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idtipoconcepto, tipoconcepto){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idtipoconcepto)
			break;
	opener.document.forms[i].idtipoconcepto.value = idtipoconcepto;
	opener.document.forms[i].tipoconcepto.value = tipoconcepto; 
	window.close();
}
 </script>
</head>
...
tituCol[0] = "Codigo";
tituCol[1] = "Tipo Concepto";

java.util.List tipoconcepto = new java.util.ArrayList();
tipoconcepto= BFFF.getrrhhtipoconcepto();
iterTipoConcepto = tipoconcepto.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_tipoconcepto.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterTipoConcepto.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterTipoConcepto.next(); 
