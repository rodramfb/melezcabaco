...
String color_fondo ="";
String titulo = "Caja Identificadores";
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanRRHHCajaIdentificadoresLov"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idbancodeposito, bancodeposito){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idbancodeposito)
			break;
	opener.document.forms[i].idbancodeposito.value = idbancodeposito;
	opener.document.forms[i].bancodeposito.value = bancodeposito; 
	window.close();
}
 </script>
</head>
...
cajaidentificadores= BFFF.getcajaidentificadoresList();
