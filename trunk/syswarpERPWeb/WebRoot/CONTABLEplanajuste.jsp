...
/*
Programa contableplanajus.jsp
Objetivo: Grilla de Plan de Ajustes
Sistema : Syswarp ERP
Copyrigth: Syswarp S.R.L.
Fecha de creacion: 08/06/2006
...
String action = "CONTABLEplanajuste.jsp";
String formulario = "frmCONTABLEplanajuste.jsp";
...
String fechaalt   = "";
String fechaact   = "";
String ayudalink  = "ayuda.jsp?idayuda=6";   // link a las ayudas en linea de cada punto
...
if (cPgreg!=null && !cPgreg.equalsIgnoreCase(""))
   //System.out.println("cPgreg: " + cPgreg);
   session.setAttribute("rxp", cPgreg.toString());    
...
tituCol[0] = "";
tituCol[1] = "cuenta_pl";
tituCol[2] = "des_cuenta_pl";
tituCol[3] = "indice_pl";
tituCol[4] = "des_indice_pl";
tituCol[5] = "Audit";
            ...
            <td width="14%" height="38"> 
              <table width="36%" border="0">
					       <tr>    
										<%if (_nivel==2){%>                    
               			<td width="27%">
										  <a href="<%=formulario%>?accion=Alta" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('alta','','./imagenes/default/btn_add_over.gif',1)">
										    <img src="./imagenes/default/btn_add_norm.gif" name="alta" border="0"  onmouseover="return overlib('Haga click en el boton para ingresar al formulario de alta de un nuevo registro', STICKY, CAPTION, 'Alta de un nuevo registro',TIMEOUT,3000,HAUTO,VAUTO);" onMouseOut="return nd();">
										  </a>
										</td>
									  <%}%>
<!-- 
										  ******La modificacion no se usa!!
                		<td width="27%">
										  <a href="javascript:validar('Modificacion');" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('modificacion','','./imagenes/default/btn_edit_over.gif',1)"><img src="./imagenes/default/btn_edit_norm.gif" name="modificacion" border="0" onmouseover="return overlib('Haga click en el boton para modificar el registro, tenga en cuenta seleccionarlo previamente registro', STICKY, CAPTION, 'Modificacion de un registro',TIMEOUT,3000,HAUTO,VAUTO);" onmouseout="return nd();">
											</a>
										</td>
...
-->		
										<%if (_nivel==2){%>                    				 
                      <td width="27%">
											  <a href="javascript:validar('Baja');" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('borrar','','./imagenes/default/btn_remove_over.gif',1)"><img src="./imagenes/default/btn_remove_norm.gif" name="borrar" border="0" onMouseOver="return overlib('Haga click en el boton eliminar el registro, tenga en cuenta seleccionarlo previamente y que dicho registro no tenga transacciones ya existentes', STICKY, CAPTION, 'Eliminacion de un registro',TIMEOUT,3000,HAUTO,VAUTO);" onMouseOut="return nd();">
												</a>
											</td>																						
										<%}%>				 
                </tr>
                ...
                <td width="47%"><div align="left">
                  <table width="70%" border="0">
                    <tr> 
                      ...
                      <td width="32%">
											  <div align="left"> 
                        <input name="txtbuscar" type="text" class="campo" id="txtbuscar" value="<%=buscar%>" size="30" maxlength="30">
                        </div>
										</td>
                    <td width="11%"> 
										  <div align="left"> 
     ...
     <table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%//=totCol+2-4%>   >
      <tr class="fila-encabezado">
        <td width="8%"  >&nbsp;<%=tituCol[0]%> </td>
				<td width="12%"  onClick="javascript:sortTable(<%=totCol+1-4%>, rsTable);"><%=tituCol[1]%></td>
				<td width="23%"  onClick="javascript:sortTable(<%=totCol+1-4%>, rsTable);"><%=tituCol[2]%></td>
				<td width="14%"  onClick="javascript:sortTable(<%=totCol+1-4%>, rsTable);"><%=tituCol[3]%></td>
				<td width="37%"  onClick="javascript:sortTable(<%=totCol+1-4%>, rsTable);"><%=tituCol[4]%></td>
				<td width="6%"  onClick="javascript:sortTable(<%=totCol+1-4%>, rsTable);"><%=tituCol[5]%></td>		
		  </tr>
 <%int r = 0;
    while(iterPlanAjustes.hasNext()){      
     ++r;
     String[] sCampos = (String[]) iterPlanAjustes.next(); 
	 if ( r >= posIni && r <= posFin ){
   	    // estos campos hay que setearlos segun la grilla 
	    String cmp_codigo = sCampos[0];
	           usuarioalt = sCampos[4] ;
	           usuarioact = sCampos[5] ;
	           fechaalt   = sCampos[6] ;
   	         fechaact   = sCampos[7] ;	 
  ...
  %>
			<tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
				<td class="fila-det-border" ><input type="radio" name="codigo" value="<%= sCampos[0] + "|" + sCampos[2]%>"></td>
    ...
    <td width="100%" height="21" colspan="7" background="images/dialogtop.gif">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr class="fila-titulo-dos">
          ...
          <td width="4%" > 
					  <select name="pgReg" class="campo" onChange="gotosite(this.options[this.selectedIndex].value)">
              <%for(i=15; i<= 150; i+=15){%>
                <%if(i==pgRegistros){%>
          ...
          <td width="28%" > 
					  <select name="curpage" class="campo" onChange="gotosite2(this.options[this.selectedIndex].value)">
