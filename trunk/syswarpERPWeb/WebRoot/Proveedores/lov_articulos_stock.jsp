...
%>
<html>
<jsp:useBean id="BPAA"  class="ar.com.syswarp.web.ejb.BeanProveedoArticulosAbm"   scope="page"/>
...
<form action="lov_articulos_stock.jsp" method="POST" name="frm">
<table width="100%" border="0" cellspacing="0" cellpadding="0" class=color-tabletrim>
  <tr class="text-globales">
    <td width="100%" height="24" colspan="10" background="imagenes/dialogtop.gif">
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                   <td class="textGlobales"><%=titulo%></td>
                </tr>
                <tr>
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
     <td width="3%" ><span class="fila-det-bold-rojo">
       <input name="agregar" type="image" id="agregar" onClick="document.frm.accion.value = this.name" onMouseOver="MM_swapImage('agregar','','../imagenes/default/btn_add_over.gif',1)"  onMouseOut="MM_swapImgRestore()" value="agregar" src="../imagenes/default/nuevo.gif" width="16" height="16">
     </span></td>
...
<%! 
 ...
 %>
   ...
   Hashtable htArticulos = (Hashtable) session.getAttribute("htArticulos");
	   ...
	   %> 	 
	        ...
	        System.out.println("NO ES NULO: ");
	   			Enumeration en = htArticulos.keys();
					while (en.hasMoreElements()) {
						...
						String [] articulos = (String []) htArticulos.get(key);
						/*
		...
		<tr class="fila-det">
		 ...
		 <td class="fila-det-border"><select name="deposito" id="deposito" class="campo">
			...
			<td class="fila-det-border">&nbsp;<input type="text" class="campo" name="precio" value="<%= Double.parseDouble( articulos[5] ) == 0 ?  articulos[4] : articulos[5]  %>" size="10"></td>
			<td class="fila-det-border">&nbsp;<input type="text" class="campo" name="total" value="<%= articulos[11] %>" size="10" readonly="yes"></td>						
		</tr>							
		<%
					}
	  %>
