...
<html>
	<%-- INSTANCIAR BEAN --%>
	<jsp:useBean id="BPF"
		class="ar.com.syswarp.web.ejb.BeanProveedoConsultaVencimientos" scope="page" />
	<head>
	...
	<BODY>
		...
		<% 
 String titulo = "Consulta de Vencimientos de Proveedores.";
 ...
 %>
		<form action="proveedoConsultaVencimientos.jsp" method="post" name="frm">
...
<tr class="fila-det">
  ...
  <td width="1095" class="fila-det-border" >El archivo se ha generado exitosamente. Haga click aqui para descargar. <img src="../imagenes/default/gnome_tango/apps/pdf.jpg" width="20" height="20" onClick="abrirVentana('../reportes/jasper/generaPDF.jsp?plantillaImpresionJRXML=proveed_vencimientos&fechadesde=<%= BPF.getFechadesde() %>&fechahasta=<%= BPF.getFechahasta() %>', 'pdf', 800, 600);">
  Exportar a excel <a href="./manejarArchivosDatosToXls.jsp?file=../reportes/reportes/ConsultasVencimientos.csv" >
  <input type="image" src="../imagenes/default/gnome_tango/mimetypes/gnome-mime-application-vnd.ms-excel.png"/></a><%
			session.setAttribute("archivo","ConsultasVencimientos.csv");%>
  </td>
</tr> 
</table>    
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable"   >
  <tr class="fila-encabezado">  
     ...
     <td width="10%">F.Ven.</td>
     <td width="10%"><div align="right">Importe</div></td>
     <td width="10%"><div align="right">Saldo</div></td>
...
<table>
	<tr class="fila-det">
		<td width="1099" class="fila-det-border">No existen registros para este período de fechas.</td>
	</tr>
</table>
<%}%>
