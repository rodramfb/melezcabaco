...
<html>
	<%-- INSTANCIAR BEAN --%>
	<jsp:useBean id="BPF"
		class="ar.com.syswarp.web.ejb.BeanProveedoresComprasporProveedoresMov" scope="page" />
	<head>
	...
	<BODY>
		...
		<% 
 String titulo = "Consulta Compras por Proveedores";
 ...
 %>
	<form action="proveedoComprasporProveedores.jsp" method="post" name="frm">
