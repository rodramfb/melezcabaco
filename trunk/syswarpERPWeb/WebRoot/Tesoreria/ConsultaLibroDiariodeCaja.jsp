...
<html>
	<%-- INSTANCIAR BEAN --%>
	<jsp:useBean id="BPF"
		class="ar.com.syswarp.web.ejb.BeanConsultaLibroDiariodeCaja" scope="page" />
	<head>
	...
	<BODY>
		...
		<% 
 String titulo = "Consulta Libro Diario de Caja";
 ...
 %>
		<form action="ConsultaLibroDiariodeCaja.jsp" method="post" name="frm">
...
<tr class="fila-det">
								<td width="11%" class="fila-det-border">
									Fecha Desde </td>
								<td width="15%" class="fila-det-border"><table width="88%" border="0">
								...
								<td width="61%" class="fila-det-border"><table width="19%" border="0">
                                  <tr class="fila-det-border">
						    ...
						    <td width="15%" class="fila-det-border"><input name="validar"
											type="submit" value="Consultar" class="boton"></td>
						    <td width="13%" class="fila-det-border">&nbsp;</td>
						    <td width="61%" class="fila-det-border">&nbsp;						</td>
		  </table>
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable"   >
  <tr class="fila-encabezado">
     ...
     <td><div align="center">Tipo Mov </div></td>
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" >
     <td height="22" class="fila-det-border" ><%=Common.setObjectToStrOrTime(java.sql.Date.valueOf(sCampos[0]), "JSTsToStr")%>&nbsp;</td>
      <td width="12%" class="fila-det-border" ><%=sCampos[1]%>&nbsp;</td>
	  <td width="21%" class="fila-det-border" ><%=sCampos[2]%>&nbsp;</td>
      <td width="10%" class="fila-det-border" ><div align="center"><%=sCampos[3]%>&nbsp;</div></td>
      <td width="12%" class="fila-det-border" ><div align="right"><%=sCampos[4]%>&nbsp;</div></td>
      <td width="8%" class="fila-det-border" ><%=sCampos[5]%>&nbsp;</td>
      <td width="33%" class="fila-det-border" ><%=sCampos[6]%>&nbsp;</td>      
   </tr>
<%
   grandTotal =   grandTotal.add(new BigDecimal(sCampos[4]));
   
   }%>
   </table>

   
<table width="100%" border="1" cellpadding="1" cellspacing="1" name="rsTable"   >
  <tr class="fila-encabezado">
