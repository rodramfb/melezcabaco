...
String color_fondo ="";
String titulo = "INFORME PAGOS POR FECHA"; 
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterPagos   = null;
...
%>
<html>
<jsp:useBean id="BCA"  class="ar.com.syswarp.web.ejb.BeanCajaINFMovPagoFecha"   scope="page"/>
...
java.util.List Pagos = new java.util.ArrayList();
Pagos = BCA.getCajaMovPagoFecha();
iterPagos = Pagos.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<div id="popupcalendar" class="text"></div>
<form action="cajaINFMovPagoFecha.jsp" method="POST" name="frm">
...
<table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" cols=<%=totCol+2-4%> id=rsTable name="rsTable"  >
  <tr class="fila-encabezado">
   ...
   while(iterPagos.hasNext()){ 
      ...
      String[] sCampos = (String[]) iterPagos.next(); 
