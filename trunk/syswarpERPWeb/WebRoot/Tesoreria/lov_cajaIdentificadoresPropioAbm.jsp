...
%>
<html>
<jsp:useBean id="BCIA"  class="ar.com.syswarp.web.ejb.BeanLovCajaIdentificadoresPropio"   scope="page"/>
...
<form action="lov_cajaIdentificadoresPropioAbm.jsp" method="POST" name="frm">
  ...
  <tr class="fila-encabezado">
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><div align="center">
        <img src="../imagenes/default/nuevo.gif" width="16" height="16" onClick="addIdentificador('<%= sCampos[2] %>');"></div></td>
...
<%
  ...
  Hashtable htIdentificadoresIngresos = (Hashtable) session.getAttribute("htIdentificadoresIngresos");
   ...
   <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="1">
     ...
     <%
	   			Enumeration en = htIdentificadoresIngresos.keys();
					int element = 0;
     ...
     <tr class="fila-det">
       ...
       <input name="chequenro" type="text" value="<%= identificador[30] %>" class="campo" id="chequenro" size="10" maxlength="10" <%= str.esNulo( identificador[6] ).equalsIgnoreCase("C") || str.esNulo( identificador[6] ).equalsIgnoreCase("D") ? "": "readonly"%>></td>
       <td class="fila-det-border"> 
				 <input name="detalle" type="text" value="<%= identificador[29] %>" class="campo" id="detalle" size="30" maxlength="50"  <%= str.esNulo( identificador[6] ).equalsIgnoreCase("C") || str.esNulo( identificador[6] ).equalsIgnoreCase("D") ? "": "readonly"%>> 
				  </td>
       <td class="fila-det-border">
         ...
         <% } else out.write("&nbsp;");%>       </td>
       <td class="fila-det-border"><input name="fecha" type="text" value="<%= identificador[31] %>" class="campo" id="fecha" size="10" maxlength="10" <%= str.esNulo( identificador[6] ).equalsIgnoreCase("C") || str.esNulo( identificador[6] ).equalsIgnoreCase("D") ? "": "readonly"%> title="Formato: dd/mm/yyyy "></td>
