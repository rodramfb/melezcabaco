...
%>
<html>
<jsp:useBean id="BCMCA"  class="ar.com.syswarp.web.ejb.BeanLovClientesMovCliAbm"   scope="page"/>
...
<form action="lov_clientesMovCliAbm.jsp" method="POST" name="frm">
  ...
  <tr class="fila-encabezado">
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><div align="center">
        <img src="../imagenes/default/nuevo.gif" width="16" height="16" onClick="agregarComprobante('<%= sCampos[2] + "-" + sCampos[3] + "-" + sCampos[6]  %>');">
      </div></td>
