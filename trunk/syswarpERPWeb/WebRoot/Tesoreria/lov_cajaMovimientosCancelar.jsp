...
%>
<html>
<jsp:useBean id="BCIA"  class="ar.com.syswarp.web.ejb.BeanLovCajaMovimientosCancelarAbm"   scope="page"/>
...
//-->
  ...
  function addIdentificador( idmovteso ){
...
<form action="lov_cajaMovimientosCancelar.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><div align="center"><img src="../imagenes/default/nuevo.gif" width="16" height="16" onClick="addIdentificador('<%= sCampos[0] %>');"></div></td>
...
&nbsp;
     <% 
  Hashtable htMovimientosCancelar = (Hashtable) session.getAttribute("htMovimientosCancelar");
	if(htMovimientosCancelar != null && !htMovimientosCancelar.isEmpty()){
	   %>
   ...
   <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="1">
     ...
     <%   
	   			Enumeration en = htMovimientosCancelar.keys();
					int element = 0;
					while (en.hasMoreElements()) {
						String key = (String) en.nextElement();
						String [] identificador = (String []) htMovimientosCancelar.get(key); 
...
<% System.out.println(identificador[37]); %>
       <td class="fila-det-border">  
				 <input name="chequenro" type="text" value="<%= identificador[37] %>" class="campo" id="chequenro" size="10" maxlength="10" <%= str.esNulo( identificador[6] ).equalsIgnoreCase("C") ? "": "readonly"%> style="text-align:right"></td>
