...
String color_fondo ="";
String titulo = "Nexo familiar";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterNexofamiliar   = null;
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanCrmnexosfamiliaresAbm"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idnexofamiliar, nexofamiliar){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idnexofamiliar)
			break;
	opener.document.forms[i].idnexofamiliar.value = idnexofamiliar;
	opener.document.forms[i].nexofamiliar.value = nexofamiliar; 
	window.close();
}
 </script>
</head>
...
java.util.List nexofamiliar = new java.util.ArrayList();
nexofamiliar= BFFF.getCrmnexosfamiliaresList();
iterNexofamiliar = nexofamiliar.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_nexofamiliar.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterNexofamiliar.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterNexofamiliar.next(); 
