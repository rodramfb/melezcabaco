...
/*  
   Grilla para la entidad: crmtiposllamadas
...
String color_fondo ="";
String titulo = "Tipos de llamados";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterCrmtiposllamadas   = null;
...
%>
<html>
<jsp:useBean id="BCA"  class="ar.com.syswarp.web.ejb.BeanCrmtiposllamadasAbm"   scope="page"/>
...
tituCol[0] = "Codigo";
tituCol[1] = "Tipo llamado";
java.util.List Crmtiposllamadas = new java.util.ArrayList();
Crmtiposllamadas= BCA.getCrmtiposllamadasList();
iterCrmtiposllamadas = Crmtiposllamadas.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="crmtiposllamadasAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
     ...
     <td width="86%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[1]%></td>
</tr>
   <%int r = 0;
   while(iterCrmtiposllamadas.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterCrmtiposllamadas.next(); 
      // estos campos hay que setearlos segun la grilla 
      if (color_fondo.equals("fila-det-verde")) color_fondo = "fila-det";
      else color_fondo = "fila-det-verde";%>
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="idtipollamada" value="<%= sCampos[0]%>"></td>
