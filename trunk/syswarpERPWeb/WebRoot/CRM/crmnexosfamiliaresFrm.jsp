...
/*  
   Formulario de carga para la entidad: crmnexosfamiliares
...
<html>
<%-- INSTANCIAR BEAN --%>  
<jsp:useBean id="BCF"  class="ar.com.syswarp.web.ejb.BeanCrmnexosfamiliaresFrm"   scope="page"/>
<head>
 <title>FRMCrmnexosfamiliares.jsp</title>
...
<div id="popupcalendar" class="text"></div>
 ...
 <% 
 String titulo = BCF.getAccion().toUpperCase() + " DE Nexos familiares" ;
 ...
 %>
<form action="crmnexosfamiliaresFrm.jsp" method="post" name="frm">
<input name="accion" type="hidden" value="<%=BCF.getAccion()%>" >
<input name="idnexofamiliar" type="hidden" value="<%=BCF.getIdnexofamiliar()%>" >
         ...
         <table width="100%"  border="0" cellspacing="0" cellpadding="0" align="center">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
              ...
              <tr class="fila-det">
                ...
                <td width="75%" class="fila-det-border"><input name="nexofamiliar" type="text" value="<%=str.esNulo(BCF.getNexofamiliar())%>" class="campo" size="50" maxlength="50"  ></td>
              </tr>
              <tr class="fila-det">
                <td class="fila-det-border">&nbsp;</td>
