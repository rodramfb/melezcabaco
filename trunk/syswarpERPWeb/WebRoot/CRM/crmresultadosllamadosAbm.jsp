...
/*  
   Grilla para la entidad: crmresultadosllamados
...
String color_fondo ="";
String titulo = "Resultados de llamadas";
...
%>
<html>
<jsp:useBean id="BCA"  class="ar.com.syswarp.web.ejb.BeanCrmresultadosllamadosAbm"   scope="page"/>
...
tituCol[0] = "Codigo";
tituCol[1] = "Resultado";
java.util.List Crmresultadollamados = new java.util.ArrayList();
Crmresultadollamados= BCA.getcrmresultadosllamadosList();
iterCrmfuentecaptacion = Crmresultadollamados.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="crmresultadosllamadosAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="idresultadollamada" value="<%= sCampos[0]%>"></td>
