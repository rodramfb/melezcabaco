...
<html>
<%-- INSTANCIAR BEAN --%>  
<jsp:useBean id="BCF"  class="ar.com.syswarp.web.ejb.BeanCrmfamiliaresFrm"   scope="page"/>
<head>
...
<div id="popupcalendar" class="text"></div>
 ...
 <% 
 String titulo = BCF.getAccion().toUpperCase() + " DE Gestion de familiares" ;
 ...
 %>
<form action="crmfamiliaresFrm.jsp" method="post" name="frm">
       ...
       <td>
         <table width="100%"  border="0" cellspacing="0" cellpadding="0" align="center">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
              ...
              <tr class="fila-det">
                <td width="25%" class="fila-det-border">Individuos: (*) </td>
