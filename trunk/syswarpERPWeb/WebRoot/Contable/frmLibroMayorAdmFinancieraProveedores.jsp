...
<html>
	<%-- INSTANCIAR BEAN --%>
	<jsp:useBean id="BPF"
		class="ar.com.syswarp.web.ejb.BeanProveedoLibroMayorAdmFinanciera" scope="page" />
	<head>
	...
	<BODY>
		...
		<% 
 String titulo = "Consulta - Libro Mayor de Gestion de Compras(Sub Contabilidad)";
 ...
 %>
		<form action="frmLibroMayorAdmFinancieraProveedores.jsp" method="post" name="frm">
