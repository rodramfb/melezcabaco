...
<html>
	<%-- INSTANCIAR BEAN --%>
	<jsp:useBean id="BPF"
		class="ar.com.syswarp.web.ejb.BeanContableLibroMayorAdmFinanciera" scope="page" />
	<head>
	...
	<BODY>
		...
		<% 
 String titulo = "Consulta - Libro Mayor Administracion Financiera(Sub Contabilidad)";
 ...
 %>
		<form action="frmLibroMayorAdmFinanciera.jsp" method="post" name="frm">
