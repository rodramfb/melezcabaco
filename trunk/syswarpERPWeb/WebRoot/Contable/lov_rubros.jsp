...
String color_fondo ="";
String titulo = "Rubros";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterRubros   = null;
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanContablerubieusoAbm"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idrubro, rubro){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idrubro)
			break;
	opener.document.forms[i].idrubro.value = idrubro;
	opener.document.forms[i].rubro.value = rubro; 
	window.close();
}
 </script>
</head>
...
java.util.List rubros = new java.util.ArrayList();
rubros= BFFF.getContablerubieusoList();
iterRubros = rubros.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_rubros.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   while(iterRubros.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterRubros.next(); 
