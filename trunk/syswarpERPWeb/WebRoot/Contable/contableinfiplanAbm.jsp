...
%>
<html>
<jsp:useBean id="BCA"  class="ar.com.syswarp.web.ejb.BeanContableinfiplannAbm"   scope="page"/>
...
<form action="contableinfiplanAbm.jsp" method="POST" name="frm">
