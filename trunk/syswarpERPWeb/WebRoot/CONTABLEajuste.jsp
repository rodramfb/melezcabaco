...
Objetivo: Grilla de Cuentas de Ajuste
Sistema : Syswarp ERP
Copyrigth: Syswarp S.R.L.
Fecha de creacion: 30/03/2006
...
String action = "CONTABLEajuste.jsp";
String formulario = "frmCONTABLEajuste.jsp";
...
String fechaalt   = "";
String fechaact   = "";
String ayudalink  = "ayuda.jsp?idayuda=5";  // link a las ayudas en linea de cada punto
  ...
  <tr >
     ...
     <table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>   >
      <tr class="fila-encabezado">
        <td width="7%"  >&nbsp;<%=tituCol[0]%> </td>
        <td width="8%"   onClick="javascript:sortTable(<%=totCol+1-4%>, rsTable);"><%=tituCol[1]%></td>
				<td width="31%"  onClick="javascript:sortTable(<%=totCol+1-4%>, rsTable);"><%=tituCol[2]%></td>
				<td width="16%"  onClick="javascript:sortTable(<%=totCol+1-4%>, rsTable);"><%=tituCol[3]%></td>
				<td width="32%"  onClick="javascript:sortTable(<%=totCol+1-4%>, rsTable);"><%=tituCol[4]%></td>
