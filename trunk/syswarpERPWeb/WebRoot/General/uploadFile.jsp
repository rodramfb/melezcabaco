...
<TITLE>Carga de Archivos</TITLE> 
 ...
 function bajarPath(){
   var estadoUpload = <%= estadoUpload %>;   
	 if(estadoUpload && opener.document.frm.path){
	   opener.document.frm.path.value = '<%= path %>';
	 }
...
<form method="POST" enctype="multipart/form-data" action="../servlet/UploadFicheroNew?modulo=general&soloImagen=<%= soloImagen %>"> 
