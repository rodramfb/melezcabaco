...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idprocesoevento, procesoevento){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idprocesoevento)
			break;
	opener.document.forms[i].idprocesoevento.value = idprocesoevento;
	opener.document.forms[i].procesoevento.value = procesoevento; 
	window.close();
}
 </script>
</head>
...
<form action="lov_procesoevento2.jsp" method="POST" name="frm">
