...
String color_fondo ="";
//String titulo = "Expreso";
String titulo = "Proceso Negocio Next";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterClientestipoevento   = null;
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanWkfprocesonegocioAbm"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idprocesonegocionext, procesonegocionext){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idprocesonegocionext)
			break;
	opener.document.forms[i].idprocesonegocionext.value = idprocesonegocionext;
	opener.document.forms[i].procesonegocionext.value = procesonegocionext; 
	window.close();
}
 </script>
</head>
...
tituCol[0] = "Codigo";
tituCol[1] = "Proceso Negocio Next";

java.util.List clientesexpreso = new java.util.ArrayList();
clientesexpreso= BFFF.getWkfprocesonegocioList();
iterClientestipoevento = clientesexpreso.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_procesonegocionext.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterClientestipoevento.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterClientestipoevento.next(); 
