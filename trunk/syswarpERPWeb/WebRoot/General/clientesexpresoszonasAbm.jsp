...
%>
<html>
<jsp:useBean id="BCA"  class="ar.com.syswarp.web.ejb.BeanClientesexpresoszonasAbm"   scope="page"/>
...
Clientesexpresoszonas= BCA.getClientesexpresoszonasList();
iterClientesexpresoszonas = Clientesexpresoszonas.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="clientesexpresoszonasAbm.jsp" method="POST" name="frm">
