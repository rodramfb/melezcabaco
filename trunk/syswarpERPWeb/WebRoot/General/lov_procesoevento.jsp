...
String titulo = "Proceso evento next";
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanWkfprocesoseventosAbm"   scope="page"/>
...
tituCol[0] = "Codigo";
tituCol[1] = "Procedo evento next";

java.util.List clientesexpreso = new java.util.ArrayList();
clientesexpreso= BFFF.getWkfprocesoseventosList();
iterClientestipoevento = clientesexpreso.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_procesoevento.jsp" method="POST" name="frm">
