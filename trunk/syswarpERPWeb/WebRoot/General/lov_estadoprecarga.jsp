...
int i = 0;
Iterator iterGeneralestado   = null;
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanGeneralEstadosProspectoLov"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idestadoprecarga, estadoprecarga){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idestadoprecarga)
			break;
	opener.document.forms[i].idestadoprecarga.value = idestadoprecarga;
	opener.document.forms[i].estadoprecarga.value = estadoprecarga; 
	window.close();
}
 </script>
</head>
...
java.util.List generalestado = new java.util.ArrayList();
generalestado= BFFF.getGeneralestadoList();
iterGeneralestado = generalestado.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_estadoprecarga.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterGeneralestado.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterGeneralestado.next(); 
