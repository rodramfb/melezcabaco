...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanGlobalgruposLov"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idgrupo, grupo){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idgrupo)
			break;
	opener.document.forms[i].idgrupo.value = idgrupo;
	opener.document.forms[i].grupo.value = grupo; 
	window.close();
}
 </script>
</head>
