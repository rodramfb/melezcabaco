...
int i = 0;
Iterator iterGeneralcontador3   = null;
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanGeneralContadoresLov"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idconta_facturasc, conta_facturasc){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idconta_facturasc)
			break;
	opener.document.forms[i].idconta_facturasc.value = idconta_facturasc;
	opener.document.forms[i].conta_facturasc.value = conta_facturasc; 
	window.close();
}
 </script>
</head>
...
java.util.List generalcontador = new java.util.ArrayList();
generalcontador= BFFF.getContadoresList();
iterGeneralcontador3 = generalcontador.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_contador3.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterGeneralcontador3.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterGeneralcontador3.next(); 
