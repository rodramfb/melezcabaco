...
/* 
   Grilla para la entidad: wkftransacciones
...
String color_fondo ="";
String titulo = "Transacciones";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterWkftransacciones   = null;
...
%>
<html>
<jsp:useBean id="BWA"  class="ar.com.syswarp.web.ejb.BeanWkftransaccionesAbm"   scope="page"/>
...
tituCol[0] = "Codigo";
tituCol[1] = "Transaccion";
tituCol[2] = "Tipo transaccion";
tituCol[3] = "Proxima transaccion";
tituCol[4] = "Descripcion";
java.util.List Wkftransacciones = new java.util.ArrayList();
Wkftransacciones= BWA.getWkftransaccionesList();
iterWkftransacciones = Wkftransacciones.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="wkftransaccionesAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterWkftransacciones.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterWkftransacciones.next(); 
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-bold-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="idtransaccion" value="<%= sCampos[0]%>"></td>
