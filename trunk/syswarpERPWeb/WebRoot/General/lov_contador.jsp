...
int i = 0;
Iterator iterGeneralcontador1   = null;
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idconta_facturasa, conta_facturasa){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idconta_facturasa)
			break;
	opener.document.forms[i].idconta_facturasa.value = idconta_facturasa;
	opener.document.forms[i].conta_facturasa.value = conta_facturasa; 
	window.close();
}
 </script>
</head>
...
iterGeneralcontador1 = generalcontador.iterator();
%>
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterGeneralcontador1.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterGeneralcontador1.next(); 
