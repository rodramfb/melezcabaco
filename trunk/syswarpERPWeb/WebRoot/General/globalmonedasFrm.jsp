...
/* 
   Formulario de carga para la entidad: globalmonedas
...
<html>
<%-- INSTANCIAR BEAN --%>  
<jsp:useBean id="BGF"  class="ar.com.syswarp.web.ejb.BeanGlobalmonedasFrm"   scope="page"/>
<head>
 <title>FRMGlobalmonedas.jsp</title>
...
<div id="popupcalendar" class="text"></div>
 ...
 <% 
 String titulo = BGF.getAccion().toUpperCase() + " DE Monedas" ;
 ...
 %>
<form action="globalmonedasFrm.jsp" method="post" name="frm">
<input name="accion" type="hidden" value="<%=BGF.getAccion()%>" >
<input name="idmoneda" type="hidden" value="<%=BGF.getIdmoneda()%>" >
         ...
         <table width="100%"  border="0" cellspacing="0" cellpadding="0" align="center">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
              ...
              <tr class="fila-det">
                ...
                <td width="88%" class="fila-det-border"><input name="moneda" type="text" value="<%=BGF.getMoneda()%>" class="campo" size="50" maxlength="50"  ></td>
              </tr>
              <tr class="fila-det">
