...
%>
<html>
<jsp:useBean id="BGLA"  class="ar.com.syswarp.web.ejb.BeanReferenciaLov"   scope="page"/>
...
function bajarDatos(referencia, d_referencia){
    var j = opener.document.forms.length;
	for(var i = 0; i<j;i++){
	    //alert(j);
		if( opener.document.forms[i].d_referencia  ){
            opener.document.forms[i].referencia.value = referencia;
			opener.document.forms[i].d_referencia.value = d_referencia; 
...
<form action="lov_referencia.jsp" method="POST" name="frm">
