...
/* 
   Grilla para la entidad: globalgrupos
...
int i = 0;
Iterator iterGlobalgrupos   = null;
...
%>
<html>
<jsp:useBean id="BGA"  class="ar.com.syswarp.web.ejb.BeanGlobalgruposAbm"   scope="page"/>
...
tituCol[0] = "Codigo";
tituCol[1] = "Grupo";
tituCol[2] = "Habilitado";
java.util.List Globalgrupos = new java.util.ArrayList();
Globalgrupos= BGA.getGlobalgruposList();
iterGlobalgrupos = Globalgrupos.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="globalgruposAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterGlobalgrupos.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterGlobalgrupos.next(); 
