...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanGeneralPaisLov"   scope="page"/>
...
java.util.List generalpais = new java.util.ArrayList();
generalpais= BFFF.getGeneralpaisList();
iterGeneralpais = generalpais.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_pais.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterGeneralpais.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterGeneralpais.next(); 
