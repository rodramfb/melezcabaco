...
/* 
   Grilla para la entidad: tickets_categorias
...
String color_fondo ="";
String titulo = "Tickets Categorias";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterTickets_categorias   = null;
...
%>
<html>
<jsp:useBean id="BTA"  class="ar.com.syswarp.web.ejb.BeanTickets_categoriasAbm"   scope="page"/>
...
tituCol[0] = "Codigo";
tituCol[1] = "Categoria";
java.util.List Tickets_categorias = new java.util.ArrayList();
Tickets_categorias= BTA.getTickets_categoriasList();
iterTickets_categorias = Tickets_categorias.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="tickets_categoriasAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterTickets_categorias.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterTickets_categorias.next(); 
      // estos campos hay que setearlos segun la grilla 
      if (color_fondo.equals("fila-det-verde")) color_fondo = "fila-det";
      else color_fondo = "fila-det-verde";%>
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="idcategoria" value="<%= sCampos[0]%>"></td>
