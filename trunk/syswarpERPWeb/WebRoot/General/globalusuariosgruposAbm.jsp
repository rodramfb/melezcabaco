...
/* 
   Grilla para la entidad: globalusuariosgrupos
...
String color_fondo ="";
String titulo = "Usuarios Grupos";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterGlobalusuariosgrupos   = null;
...
%>
<html>
<jsp:useBean id="BGA"  class="ar.com.syswarp.web.ejb.BeanGlobalusuariosgruposAbm"   scope="page"/>
...
tituCol[0] = "Usuario";
tituCol[1] = "Grupo";
java.util.List Globalusuariosgrupos = new java.util.ArrayList();
Globalusuariosgrupos= BGA.getGlobalusuariosgruposList();
iterGlobalusuariosgrupos = Globalusuariosgrupos.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="globalusuariosgruposAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
     ...
     <td width="47%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[1]%></td>
   </tr>
   <%int r = 0;
   while(iterGlobalusuariosgrupos.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterGlobalusuariosgrupos.next(); 
      // estos campos hay que setearlos segun la grilla 
      if (color_fondo.equals("fila-det-verde")) color_fondo = "fila-det";
      else color_fondo = "fila-det-verde";%>
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
<td class="fila-det-border" ><input type="radio" name="idusuario" value="<%= sCampos[0]%>" onClick="document.frm.idgrupo.value = <%= sCampos[1]%>"></td>
...
<%
   ...
   <input name="idgrupo" value="" type="hidden">
