...
String color_fondo ="";
String titulo = "Planta";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterGeneralplanta   = null;
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanGeneralPlantasLov"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idplanta, planta){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idplanta)
			break;
	opener.document.forms[i].idplanta.value = idplanta;
	opener.document.forms[i].planta.value = planta; 
	window.close();
}
 </script>
</head>
...
java.util.List generalplanta = new java.util.ArrayList();
generalplanta= BFFF.getPlantasList();
iterGeneralplanta = generalplanta.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_planta.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterGeneralplanta.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterGeneralplanta.next(); 
