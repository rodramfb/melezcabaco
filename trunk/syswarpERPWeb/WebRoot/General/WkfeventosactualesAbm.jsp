...
/* 
   Grilla para la entidad: Wkfeventosactuales
...
String color_fondo ="";
String titulo = "Eventos Actuales";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterWkfeventosactuales   = null;
...
%>
<html>
<jsp:useBean id="BWA"  class="ar.com.syswarp.web.ejb.BeanWkfeventosactualesAbm"   scope="page"/>
...
tituCol[0] = "Codigo";
tituCol[1] = "Evento Resultado";
tituCol[2] = "Proceso Evento";
tituCol[3] = "Descripcion Transaccion";
tituCol[4] = "Fecha";
tituCol[5] = "Transaccion";
java.util.List Wkfeventosactuales = new java.util.ArrayList();
Wkfeventosactuales= BWA.getWkfeventosactualesList();
iterWkfeventosactuales = Wkfeventosactuales.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="WkfeventosactualesAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
     ...
     <td width="15%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[1]%></td>
   ...
   <%int r = 0;
   while(iterWkfeventosactuales.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterWkfeventosactuales.next(); 
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-bold-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="idventoactual" value="<%= sCampos[0]%>"></td>
