...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idtransaccion, destransaccion){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idtransaccion)
			break;
	opener.document.forms[i].idtransaccion.value = idtransaccion;
	opener.document.forms[i].destransaccion.value = destransaccion; 
	window.close();
}
 </script>
</head>
...
<form action="lov_transaccion.jsp" method="POST" name="frm">
