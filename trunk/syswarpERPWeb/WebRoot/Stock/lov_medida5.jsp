...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(unimed_st, d_unimed_st){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].unimed_st)
			break;
	opener.document.forms[i].unimed_st.value = unimed_st;
	opener.document.forms[i].d_unimed_st.value = d_unimed_st; 
	window.close();
}
 </script>
</head>
...
<form action="lov_medida5.jsp" method="POST" name="frm">
