...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanStockGruposPadreLov"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(codigo_gr_pa, d_codigo_gr_pa){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].codigo_gr_pa)
			break;
	opener.document.forms[i].codigo_gr_pa.value = codigo_gr_pa;
	opener.document.forms[i].d_codigo_gr_pa.value = d_codigo_gr_pa; 
	window.close();
}
 </script>
</head>
...
grupos= BFFF.getStockgrupopadreList();
itergrupos = grupos.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_grupo2.jsp" method="POST" name="frm">
