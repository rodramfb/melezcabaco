...
function bajarDatos(codigo_st, descrip_st){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].articulodesde)
			break;
	if(opener.document.forms[i].articulodesde) opener.document.forms[i].articulodesde.value = codigo_st;
	if(opener.document.forms[i].descrip_st)opener.document.forms[i].descrip_st.value = descrip_st; 
	window.close();
}
 </script>
</head>
...
<form action="lov_articulo.jsp" method="POST" name="frm">
