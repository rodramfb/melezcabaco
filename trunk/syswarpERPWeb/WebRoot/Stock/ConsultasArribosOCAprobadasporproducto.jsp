...
<html>
	<%-- INSTANCIAR BEAN --%>
	<jsp:useBean id="BPF"
		class="ar.com.syswarp.web.ejb.BeanConsultaArribosOCporProducto" scope="page" />
	<head>
	...
	<BODY>
		...
		<% 
 String titulo = "Consulta de Arribos de Articulos previstos para un Deposito por Orden de Compra por Producto";
 ...
 %>
		<form action="ConsultasArribosOCAprobadasporproducto.jsp" method="post" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable"   >
  ...
  <%r = 0;
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
     ...
     <td class="fila-det-border" ><div align="center"> <a href="javascript:abrirVentana('<%= link %>', '', 800, 600)"></a> <a href="javascript:abrirVentana('<%= link %>', '', 800, 600)"><img src="../imagenes/default/gnome_tango/apps/pdf.jpg" border="0" ></a></div>       <a href="javascript:abrirVentana('<%= link %>', '', 800, 600)"></a></td>
   </tr>
   <%
   }%>
  <!-- final -->  
