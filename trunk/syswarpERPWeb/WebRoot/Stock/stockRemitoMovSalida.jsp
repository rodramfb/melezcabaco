...
<html>
<head>
<title>MOVIMIENTO DE SALIDA</title>
 ...
 <jsp:useBean id="BSMER "  class="ar.com.syswarp.web.ejb.BeanStockMovSalidaRemito"   scope="page"/>
...
<table width="90%" height="426"  border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr class="fila-det">
    <td height="25">&nbsp;</td>
    <td>Movimiento de Salida N&ordm; :  <%= str.esNulo(request.getParameter("nint_ms_an")) %></td>
  </tr>
