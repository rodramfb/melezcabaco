...
<html>
	<%-- INSTANCIAR BEAN --%>
	<jsp:useBean id="BPF"
		class="ar.com.syswarp.web.ejb.BeanStockConsultaMovimientosArticulo" scope="page" />
	<head>
	...
	<BODY>
		...
		<% 
 String titulo = "Consulta de Movimientos por Articulo. ";
 ...
 %>
		<form action="stockConsultaMovimientosArticulo.jsp" method="post" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable"   >
  <tr class="fila-encabezado">  
     ...
     <td width="10%">C.Deposito</td>
     <td width="35%">Deposito</td>     
     <td width="10%"><div align="right">Cantidad</div></td>
     <td width="10%">Tipo</td>
     <td width="10%">Usuario Responsable</td>
  ...
  <%r = 0;
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" >
          <img src="../imagenes/default/gnome_tango/actions/<%=imagen%>"   width="22" height="22" onMouseOver="mostrarMasInfo('Observaciones: <%=sCampos[7]%>')">      </td>
