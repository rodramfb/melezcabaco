...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(iddepositohasta, depositohasta){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].iddepositohasta)
			break;
	opener.document.forms[i].iddepositohasta.value = iddepositohasta;
	opener.document.forms[i].depositohasta.value = depositohasta; 
	window.close();
}
 </script>
</head>
...
<form action="lov_deposito_hasta_informe.jsp" method="POST" name="frm">
