...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(unialt2_st, d_unialt2_st){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].unialt2_st)
			break;
	opener.document.forms[i].unialt2_st.value = unialt2_st;
	opener.document.forms[i].d_unialt2_st.value = d_unialt2_st; 
	window.close();
}
 </script>
</head>
...
<form action="lov_medida2.jsp" method="POST" name="frm">
