...
String color_fondo ="";
String titulo = "Familias";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterfamilias  = null;
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanStockFamiliaLov"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(codigo_fm, d_codigo_fm){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].codigo_fm)
			break;
	opener.document.forms[i].codigo_fm.value = codigo_fm;
	opener.document.forms[i].d_codigo_fm.value = d_codigo_fm; 
	window.close();
}
 </script>
</head>
...
java.util.List familias = new java.util.ArrayList();
familias= BFFF.getStockfamiliaList();
iterfamilias = familias.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_familia.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterfamilias.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterfamilias.next(); 
