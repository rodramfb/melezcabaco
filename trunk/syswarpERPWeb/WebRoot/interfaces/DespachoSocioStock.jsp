...
try{ 
    ...
    if(Integer.parseInt(ejecutar) == 2){ 
		  ...
		  if(seleccion!=null){
			    ...
			    resultado=repo.InterfaseDbBacoDeltaDespachoSocios(deposito1,	deposito2, htSeleccion , "OBS.", usuarioalt,  new BigDecimal(idempresa));
		      for(int j=0;j<3;j++)
		...
		//rsStockConjunto = repo.getTransaccion("spInterfacesStockConjunto", deposito2);
