...
String ejerciciodesde    = request.getParameter("ejerciciodesde");
String ejerciciohasta    = request.getParameter("ejerciciohasta");
...
System.out.println("nivel "+ _nivel);
	...
	if (ejerciciodesde==null)  ejerciciodesde="";
	if (ejerciciohasta==null)  ejerciciohasta="";
%>	
<html>
  <head>	
...
function validar(){  
  if (document.frm.ejerciciodesde.value.length==0){
     alert('No se puede dejar vacia el campo Ejercicio Desde');
     document.frm.ejerciciodesde.focus();
     return false;
}	 

  if (document.frm.ejerciciohasta.value.length==0){
     alert('No se puede dejar vacia el campo Ejercicio Hasta');
     document.frm.ejerciciohasta.focus();
     return false;
}	 
  
	if (confirm('Atencion:\n Confirma la la copia del Plan de Cuentas?') )
		 document.frm.submit();
	   return true;
}
...
<div id="popupcalendar" class="text"></div>
	<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
		<form action="frmCopiarplandecuentas.jsp" name="frm" method="post">
  ...
  <tr>
    <td>		  
		<table width="100%" border="0" cellpadding="0" cellspacing="0" >
          ...
          <tr > 
            <td width="10%" height="23" class="fila-det-border" >Ejercicio Desde</td>
            <td width="90%" class="fila-det-border" >
						    <input name="ejerciciodesde" type="text" class="campo" id="ejerciciodesde" size="10" maxlength="10"> 
            </td>
          </tr>
          <tr > 
            <td width="10%" height="23" class="fila-det-border" >Ejercicio Hasta</td>
            <td width="90%" class="fila-det-border" >
						    <input name="ejerciciohasta" type="text" class="campo" id="ejerciciohasta" size="10" maxlength="10"> 
            </td>
          </tr>
        </table>
