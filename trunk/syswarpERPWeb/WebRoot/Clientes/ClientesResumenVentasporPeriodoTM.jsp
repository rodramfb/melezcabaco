...
<html>
	<%-- INSTANCIAR BEAN --%>
	<jsp:useBean id="BPF"
		class="ar.com.syswarp.web.ejb.BeanClientesResumenVentasporPeriodoTM" scope="page" />
	<head>
		<title>Consuta de Resumen de Venta por Telemarketer</title> 
	...
	<BODY>
		...
		<% 
 String titulo = "Consuta de Resumen de Venta por Telemarketer";
 ...
 List Consulta1=null; //BPF.getMovimientosList() ;
 
 
 
  
 %>
	<form action="ClientesResumenVentasporPeriodoTM.jsp" method="post" name="frm">
...
<tr class="fila-det">
								<td width="17%" height="35" class="fila-det-border">Fecha Desde </td>
								<td width="16%" class="fila-det-border"><table width="86%" border="0">
                                  <tr class="fila-det-border">
                                    <td width="32%"><input name="fechaD" type="text" class="cal-TextBox"
													id="fechaD" onFocus="this.blur()"
													value="<%=BPF.getFechaD() %>" size="12"
                                    ...
                                    <td width="68%"><a class="so-BtnLink"
													...
													onclick="calSwapImg('BTN_date_6', 'img_Date_DOWN');showCalendar('frm','fechaD','BTN_date_6');return false;"><img
          ...
          <td width="15%" class="fila-det-border">Fecha Hasta</td>
		                        <td width="52%" class="fila-det-border"><table width="30%" border="0">
                                  <tr class="fila-det-border">
                                    <td width="32%"><input name="fechaH" type="text" class="cal-TextBox"
													id="fechaH" onFocus="this.blur()"
													value="<%=BPF.getFechaH() %>" size="12"
													maxlength="12" readonly>
                                    </td>
                                    <td width="68%"><a class="so-BtnLink"
													href="javascript:calClick();return false;"
													...
													onclick="calSwapImg('BTN_date_7', 'img_Date_DOWN');showCalendar('frm','fechaH','BTN_date_7');return false;"><img
														src="vs/calendar/btn_date_up.gif" title="Ver Calendario..."
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable"   >
   ...
   Iterator iterCon = Consulta1.iterator();
 
   
   while( iterCon.hasNext() ){       
      ++r;
      String[] sCampos = (String[]) iterCon.next();           
      if (color_fondo.equals("fila-det-verde")) color_fondo = "fila-det";
      else color_fondo = "fila-det-verde";%>
      
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" >
      <%for(int x=0; x < sCampos.length; ++x){ %>      
         <td class="fila-det-border" ><%=sCampos[x]%>&nbsp;</td>
      <%}%>
   </tr>   
 <%}%>   
</table>
