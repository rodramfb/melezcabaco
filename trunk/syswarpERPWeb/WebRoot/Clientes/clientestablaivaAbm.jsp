...
/* 
   Grilla para la entidad: clientestablaiva
...
String color_fondo ="";
String titulo = "Tipos de Iva";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterClientestablaiva   = null;
...
%>
<html>
<jsp:useBean id="BCA"  class="ar.com.syswarp.web.ejb.BeanClientestablaivaAbm"   scope="page"/>
...
tituCol[0] = "Codigo";
tituCol[1] = "Tipo iva";
tituCol[2] = "Porcentaje 1";
tituCol[3] = "Descrimina";
tituCol[4] = "Desglosa";
tituCol[5] = "Porcentaje 2";
tituCol[6] = "Letra";
tituCol[7] = "Cta Promo";
java.util.List Clientestablaiva = new java.util.ArrayList();
Clientestablaiva= BCA.getClientestablaivaList();
iterClientestablaiva = Clientestablaiva.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="clientestablaivaAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
     ...
     <td width="11%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[5]%></td>
   ...
   <%int r = 0;
   while(iterClientestablaiva.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterClientestablaiva.next(); 
      // estos campos hay que setearlos segun la grilla 
      if (color_fondo.equals("fila-det-verde")) color_fondo = "fila-det";
      else color_fondo = "fila-det-verde";%>
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="idtipoiva" value="<%= sCampos[0]%>"></td>
