...
String color_fondo ="";
String titulo = "Clientes Prospecto";
...
function bajarDatos(sdesde, dsdesde){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].sdesde)
			break;
	opener.document.forms[i].sdesde.value = sdesde;
	opener.document.forms[i].dsdesde.value = dsdesde; 
	window.close();
...
<form action="lov_clientes3.jsp" method="POST" name="frm">
