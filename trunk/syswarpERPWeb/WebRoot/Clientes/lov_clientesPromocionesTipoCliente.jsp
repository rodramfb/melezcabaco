...
%>
<html>
<jsp:useBean id="BCPA"  class="ar.com.syswarp.web.ejb.BeanClientesPromocionesXTipoClienteLov"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script language="JavaScript" src="<%=pathscript%>/forms.js"></script>
  <script >
	function bajarDatos(idpromocion, promocion){
		for(var i = 0; i<10;i++)
		  if(opener.document.forms[i].idpromocion){
			opener.document.forms[i].idpromocion.value = idpromocion;
			opener.document.forms[i].promocion.value = promocion; 
			break;
		}
		window.close();
	}
...
<form action="lov_clientesPromocionesTipoCliente.jsp" method="POST" name="frm">
...
<%
   ...
   <input name="idtipoclie" type="hidden" id="idtipoclie" value="<%=BCPA.getIdtipoclie()%>">
</form>
  </body>
</html>
<% 
