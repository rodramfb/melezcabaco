...
int i = 0;
Iterator iterClientesexpreso   = null;
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanClientesExpresoLov"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idexpreso, expreso){
	for(var i = 0; i<10;i++)
...
clientesexpreso= BFFF.getClientesexpresoList();
iterClientesexpreso = clientesexpreso.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_expreso.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterClientesexpreso.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterClientesexpreso.next(); 
