...
/* 
   Grilla para la entidad: clientesmotivos
...
%>
<html>
<jsp:useBean id="BCA"  class="ar.com.syswarp.web.ejb.BeanClientesmotivosAbm"   scope="page"/>
...
java.util.List Clientesmotivos = new java.util.ArrayList();
Clientesmotivos= BCA.getClientesmotivosList();
iterClientesmotivos = Clientesmotivos.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="clientesmotivosAbm.jsp" method="POST" name="frm">
