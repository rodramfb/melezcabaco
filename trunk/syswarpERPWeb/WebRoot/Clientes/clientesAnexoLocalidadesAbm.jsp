...
%>
<html>
<jsp:useBean id="BCALA"  class="ar.com.syswarp.web.ejb.BeanClientesAnexoLocalidadesAbm"   scope="page"/>
...
tituCol[6] = "Localidad";
tituCol[7] = "tarandexc";
tituCol[8] = "tarsoc1bulto";
tituCol[9] = "tarsocexc";
tituCol[10] = "cabeoinflu";
tituCol[11] = "norteosur";
tituCol[12] = "idempresa";
tituCol[13] = "Provincia";
...
<form action="clientesAnexoLocalidadesAbm.jsp" method="POST" name="frm">
                   ...
                   <td width="89%">
                      <table width="100%" border="0">
                         <tr>
                           ...
                           <td width="22%">
                              <input name="ocurrencia" type="text" value="<%=BCALA.getOcurrencia()%>" id="ocurrencia" size="30" maxlength="30">                           </td>
                           <td width="72%">
                                   ...
                                   <td>
                                     <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                        <tr class="text-globales">
                                          ...
                                          <td width="23%">&nbsp;Total de registros:&nbsp;<%=BCALA.getTotalRegistros()%></td>
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
	 ...
	 <td width="28%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[13]%></td>
    </tr>
   <%int r = 0;
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="idanexolocalidad" value="<%= sCampos[0]%>"></td>
