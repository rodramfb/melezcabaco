...
/* 
   Grilla para la entidad: clientesvendedorescomisiones
...
String color_fondo ="";
String titulo = "CLIENTESVENDEDORESCOMISIONES";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterClientesvendedorescomisiones   = null;
...
%>
<html>
<jsp:useBean id="BCA"  class="ar.com.syswarp.web.ejb.BeanClientesvendedorescomisionesAbm"   scope="page"/>
...
tituCol[2] = "Socio desde";
tituCol[3] = "Socio hasta";
tituCol[4] = "% desde";
tituCol[5] = "% hasta";
tituCol[6] = "Valor Asociacion";
tituCol[7] = "% cartera";
java.util.List Clientesvendedorescomisiones = new java.util.ArrayList();
Clientesvendedorescomisiones= BCA.getClientesvendedorescomisionesList();
iterClientesvendedorescomisiones = Clientesvendedorescomisiones.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="clientesvendedorescomisionesAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterClientesvendedorescomisiones.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterClientesvendedorescomisiones.next(); 
      // estos campos hay que setearlos segun la grilla 
      if (color_fondo.equals("fila-det-verde")) color_fondo = "fila-det";
      else color_fondo = "fila-det-verde";%>
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="idcomision" value="<%= sCampos[0]%>"></td>
      <td class="fila-det-border" ><div align="right">&nbsp;<%=sCampos[0]%></div></td>
      <td class="fila-det-border" ><div align="center">&nbsp;<%=sCampos[1]%></div></td>
