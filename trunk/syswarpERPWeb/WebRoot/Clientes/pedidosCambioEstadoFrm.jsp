...
<html>
<%-- INSTANCIAR BEAN --%>  
<jsp:useBean id="BPF"  class="ar.com.syswarp.web.ejb.BeanPedidosCambioEstadosFrm"   scope="page"/>
<head>
...
window.onload = function (){
  var location = opener ? opener.location.toString().toLowerCase() : '' ; // 
  var esListadoControl = location.indexOf('vclienteslcsas') > -1 ? true : false;
  var objBtn = document.getElementById('volver');
  if(esListadoControl){
    objBtn.name = 'cerrar';
    objBtn.id = 'cerrar';
	objBtn.type = 'button';
...
<div id="popupcalendar" class="text"></div>
 ...
 String titulo =  "CAMBIO DE ESTADO DEL PEDIDO:" + BPF.getIdpedido() + " / CLIENTE: " + BPF.getIdcliente() + " - " +   BPF.getCliente();

 %>
<form action="pedidosCambioEstadoFrm.jsp" method="post" name="frm">
