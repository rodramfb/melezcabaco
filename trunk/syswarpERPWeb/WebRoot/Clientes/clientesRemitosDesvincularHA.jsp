...
String color_fondo ="";
String titulo = "DESVINCULACION DE REMITOS DE HOJA DE ARMADO";
...
%>
<html>
<jsp:useBean id="BBOEA"  class="ar.com.syswarp.web.ejb.BeanClientesRemitosDesvincularHR"   scope="page"/>
...
<form action="clientesRemitosDesvincularHA.jsp" method="POST" name="frm">
            ...
            <table width="98%" border="0" cellpadding="0" cellspacing="0" >
                ...
                <tr>
                  <td width="1%" height="38"><table width="100%" border="0" class="text-globales">
                    <tr>
                      <td height="26" class="text-globales">Hoja de Armado: (*)</td>
                      <td><input name="nrohojaarmado" type="text" value="<%=BBOEA.getNrohojaarmado()%>" id="nrohojaarmado" size="20" maxlength="16" class="campo" style="text-align:right"></td>
                      <td>ATENCION: Este proceso solo desvincula el documento ingresado por pantalla. </td>
                    </tr>
                    <tr>
                      <td width="10%" height="26" class="text-globales"><p>Identificador: (*)</p></td>
                      <td width="25%"><input name="idctrlremito" type="text" value="<%=BBOEA.getIdctrlremito()%>" id="idctrlremito" size="20" maxlength="16" class="campo" style="text-align:right"></td>
                      ...
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td><input name="ir" type="button" class="boton" id="ir" value="  >>  " onClick="enviarFrm('buscar')">
                              <input name="nrohojaarmadoAnt" type="hidden" value="<%=BBOEA.getNrohojaarmado()%>" id="nrohojaarmadoAnt" size="20" maxlength="16" style="text-align:right">
  ...
  %>
	 <table width="90%" border="1" cellspacing="0" cellpadding="0">
         ...
         r= 0;
		   ...
		   //System.out.println("getHtRemitosInvolucrados: " + BBOEA.getHtRemitosInvolucrados(  ).get(comprobante) );
          
				 %>
         <tr class="fila-det">
           <td><div align="center">
             <input name="vecIdctrlremito" type="hidden" value="<%=BBOEA.getVecIdctrlremito() != null ? BBOEA.getVecIdctrlremito()[r] : ""%>" id="vecIdctrlremito" size="20" maxlength="16" class="campo" style="text-align:right">
             <%= comprobante %>&nbsp;</div>
             </td>
       ...
       <table width="100%" border="1" cellspacing="0" cellpadding="0">
		 ...
		 <tr valign="top" class="text-globales">
		   <td colspan="2"  ><input name="anula" type="button" class="boton" id="anula" value="  Desvincular" onClick="enviarFrm('anular')"></td>
		   </tr>
	 </table>
  <% } %>
