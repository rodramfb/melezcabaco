...
/* 
   Grilla para la entidad: bacotmresultados
...
String color_fondo ="";
String titulo = "RESULTADOS DE LLAMADOS";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterBacotmresultados   = null;
...
%>
<html>
<jsp:useBean id="BBA"  class="ar.com.syswarp.web.ejb.BeanBacotmresultadosAbm"   scope="page"/>
...
tituCol[0] = "Codigo";
tituCol[1] = "Resultado";
java.util.List Bacotmresultados = new java.util.ArrayList();
Bacotmresultados= BBA.getBacotmresultadosList();
iterBacotmresultados = Bacotmresultados.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="bacotmresultadosAbm.jsp" method="POST" name="frm">
                   ...
                   <td width="89%">
                      <table width="100%" border="0">
                         <tr>
                           ...
                           <td width="22%">
                              <input name="ocurrencia" type="text" value="<%=BBA.getOcurrencia()%>" id="ocurrencia" size="30" maxlength="30">                           </td>
                           <td width="72%">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterBacotmresultados.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterBacotmresultados.next(); 
      // estos campos hay que setearlos segun la grilla 
      if (color_fondo.equals("fila-det-verde")) color_fondo = "fila-det";
      else color_fondo = "fila-det-verde";%>
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="idresultado" value="<%= sCampos[0]%>"></td>
