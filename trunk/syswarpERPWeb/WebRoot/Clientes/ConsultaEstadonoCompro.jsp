...
<html>
	<%-- INSTANCIAR BEAN --%>
	<jsp:useBean id="BPF"
		class="ar.com.syswarp.web.ejb.BeanConsultaClientesEstadnoCompro" scope="page" />
	<head>
	...
	<BODY>
		...
		<% 
 String titulo = "Consulta Estado no Compro";
 ...
 %>
		<form action="ConsultaEstadonoCompro.jsp" method="post" name="frm">
...
<tr class="fila-det">
								<td width="16%" class="fila-det-border">Campa&ntilde;a</td>
								<td width="24%" class="fila-det-border"><table width="23%" border="0">
		  ...
		  <td width="48%" class="fila-det-border">&nbsp;</td>
...
<%}%>
   ...
   while(iterConsulta2.hasNext()){
      ++r;
      String[] sCampos2 = (String[]) iterConsulta2.next(); 
       String imagen2 ="";      
      if (color_fondo.equals("fila-det-verde")) color_fondo = "fila-det";
      else color_fondo = "fila-det-verde";%>
   <tr  class="text-dos-bold" >
     <td height="22" class="fila-det-border" >&nbsp;<%=sCampos2[0]%></td>
      <td width="54%" class="fila-det-border" ><%=sCampos2[1]%></td>
   </tr>
