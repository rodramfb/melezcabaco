...
<html>
	<%-- INSTANCIAR BEAN --%>
	<jsp:useBean id="BPF"
		class="ar.com.syswarp.web.ejb.BeanClientesResumenVentasporPeriodoOtrosSectores" scope="page" />
	<head>
		<title>Consuta de Resumen de Venta por Otros Sectores</title> 
	...
	<BODY>
		...
		<% 
 String titulo = "Consuta de Resumen de Venta por Otros Sectores";
 ...
 %>
	<form action="ClientesResumenVentasporPeriodoOtrosSectores.jsp" method="post" name="frm">
...
<% java.sql.ResultSetMetaData rm2 = Consulta1.getMetaData();  %>
       <tr class="fila-encabezado">
          <%for (int zz=1; zz < rm2.getColumnCount()+1; zz++){ %>
              <td width="12%"><%= rm2.getColumnName(zz) %></td>
          <%}%>        
       </tr>    
