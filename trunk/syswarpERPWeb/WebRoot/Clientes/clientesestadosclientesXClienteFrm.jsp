...
<html>
<%-- INSTANCIAR BEAN --%>  
<jsp:useBean id="BCF"  class="ar.com.syswarp.web.ejb.BeanClientesestadosclientesXClienteFrm"   scope="page"/>
<head>
 <title></title>
...
<div id="popupcalendar" class="text"></div>
 ...
 String titulo = BCF.getAccion().toUpperCase() + " de Estados Para Cliente: " + BCF.getRazon() ; 
 ...
 %>
 <form action="clientesestadosclientesXClienteFrm.jsp" method="post" name="frm">
         ...
         <table width="100%"  border="0" cellspacing="0" cellpadding="0" align="center">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
              <tr class="fila-det-bold-rojo">
                ...
                <td colspan="2" class="fila-det-border"><jsp:getProperty name="BCF" property="mensaje"/>
                  &nbsp; </td>
              </tr>
              <tr class="fila-det">
                <td width="22%" class="fila-det-border">Estado: (*) </td>
                <td width="37%" class="fila-det-border"><input name="estado" type="text" id="estado" size="50" maxlength="45" readonly="true" value="<%=BCF.getEstado()%>" class="campo"> </td>
                <td width="41%" class="fila-det-border"><a href="javascript:validarEstado()"><img src="../imagenes/default/gnome_tango/actions/filefind.png" title="Seleccion Estado" width="22" height="22" border="0">
              ...
              <tr class="fila-det">
                ...
                <td colspan="3" class="fila-det-border" ><input name="fechahasta" type="text" class="cal-TextBox" id="fechahasta" onFocus="this.blur()" value="<%=BCF.getFechahasta()%>" size="12" maxlength="12" readonly>
                  <a class="so-BtnLink" href="javascript:calClick();return false;"
                  onmouseover="calSwapImg('BTN_date_7', 'img_Date_OVER',true); "
                  onmouseout="calSwapImg('BTN_date_7', 'img_Date_UP',true);"
...
--%>
	 ...
	 <input name="razon" type="hidden" id="razon" value= "<%=BCF.getRazon()%>">	 
