...
/* 
   Grilla para la entidad: Lov tipotarjetas
...
String color_fondo ="";
String titulo = "Tipo Tarjetas";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator itertipotarjetastipotarjetas   = null;
...
%>
<html>
<jsp:useBean id="BGLA"  class="ar.com.syswarp.web.ejb.BeanClientesTipoTarjetasLov"   scope="page"/>
...
function bajarDatos(idtipotarjeta, tipotarjeta){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idtipotarjeta)
			break;
	opener.document.forms[i].idtipotarjeta.value = idtipotarjeta;
	opener.document.forms[i].tipotarjeta.value = tipotarjeta; 
	window.close();
...
tituCol[0] = "Codigo";
tituCol[1] = "Tipo Tarjeta";

java.util.List tipotarjetastipotarjetas = new java.util.ArrayList();
tipotarjetastipotarjetas = BGLA.getClientestipotarjetasList();
itertipotarjetastipotarjetas = tipotarjetastipotarjetas.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_tipotarjeta.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(itertipotarjetastipotarjetas.hasNext()){
      ++r;
      String[] sCampos = (String[]) itertipotarjetastipotarjetas.next(); 
