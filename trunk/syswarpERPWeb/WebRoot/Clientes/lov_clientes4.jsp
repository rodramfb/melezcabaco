...
String color_fondo ="";
String titulo = "Clientes Proospecto";
...
%>
<html>
<jsp:useBean id="BGLA"  class="ar.com.syswarp.web.ejb.BeanClientesPrecargaAbm"   scope="page"/>
...
function bajarDatos(shasta, dshasta){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].shasta)
			break;
	opener.document.forms[i].shasta.value = shasta;
	opener.document.forms[i].dshasta.value = dshasta; 
	window.close();
...
<form action="lov_clientes4.jsp" method="POST" name="frm">
