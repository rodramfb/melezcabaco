...
<html>
	<%-- INSTANCIAR BEAN --%>
	<jsp:useBean id="BPF"
		class="ar.com.syswarp.web.ejb.BeanConsultaVentasProductos" scope="page" />
	<head>
	...
	<BODY>
		...
		<% 
 String titulo = "Consulta Ventas por Productos Total";
 ...
 %>
	<form action="ConsultaVentasProductos.jsp" method="post" name="frm">
