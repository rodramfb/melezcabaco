...
<html>
	<%-- INSTANCIAR BEAN --%>
	<jsp:useBean id="BPF"
		class="ar.com.syswarp.web.ejb.BeanConsultaVendedoresNotasdeCreditoporCI" scope="page" />
	<head>
	...
	<BODY>
		...
		<% 
 String titulo = "Notas de Credito por CI";
 ...
 %>
		<form action="ConsultaLiquidacionVendedoresNotasdecreditoporci.jsp" method="post" name="frm">
  ...
  <% BigDecimal totalgeneral2 = new BigDecimal(0); %> 
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" >
     <td height="22" class="fila-det-border" >&nbsp;<%=sCampos[0]%></td>
      <td width="44%" class="fila-det-border" ><%=sCampos[1]%></td>
	  <td width="11%" class="fila-det-border" ><%=sCampos[2]%></td>
...
<%
     ...
     <tr class="fila-encabezado">
     <td width="18%">Total Imp.Total NC</td>  
	 ...
	 <td><div align="left"><span class="fila-det-border"><%=totalgeneral.toString()%></span></div></td>
        ...
        <tr class="fila-encabezado">
     <td width="18%">Total Suma de Cuotas</td>  
	 <td><div align="right"></div></td>
	 <td><div align="right"></div></td>
	 <td><div align="right"></div></td>
	 <td><div align="right"></div></td>
