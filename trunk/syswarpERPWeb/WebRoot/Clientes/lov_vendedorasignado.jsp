...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanClientesVendedorLov"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idvendedorasignado, vendedorasignado){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idvendedorasignado)
			break;
	opener.document.forms[i].idvendedorasignado.value = idvendedorasignado;
	opener.document.forms[i].vendedorasignado.value = vendedorasignado; 
	window.close();
}
 </script>
</head>
...
clientesvendedor= BFFF.getClientesvendedorList();
iterClientesvendedor = clientesvendedor.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_vendedorasignado.jsp" method="POST" name="frm">
