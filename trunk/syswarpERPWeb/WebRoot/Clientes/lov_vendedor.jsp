...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idvendedor, vendedor){
	for(var i = 0; i<10;i++){
		...
		if(opener.document.forms[i].filtroIdvendedor){
		  opener.document.forms[i].filtroIdvendedor.value = idvendedor;
		  opener.document.forms[i].filtroVendedor.value = vendedor; 
		  break;
		}
	}
	window.close();
...
<form action="lov_vendedor.jsp" method="POST" name="frm">
