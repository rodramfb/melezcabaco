...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanPedidosEstadosLov"   scope="page"/>
...
clientesestado= BFFF.getpedidosestadosList();
iterClientesestados = clientesestado.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_estadospedidos.jsp" method="POST" name="frm">
