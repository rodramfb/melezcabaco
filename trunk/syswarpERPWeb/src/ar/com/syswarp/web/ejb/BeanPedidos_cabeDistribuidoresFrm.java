...
public class BeanPedidos_cabeDistribuidoresFrm implements SessionBean,
		Serializable {
	...
	static Logger log = Logger
			.getLogger(BeanPedidos_cabeDistribuidoresFrm.class);
	...
	public BeanPedidos_cabeDistribuidoresFrm() {
		super();
	}
	...
	public void ejecutarSentenciaDML() {
		try {
			...
			this.mensaje = pedidos_cabe.pedidosDistribuidoresCreate(
					this.idestado, this.idcliente, this.idsucursal,
					this.idsucuclie, (Timestamp) Common.setObjectToStrOrTime(
							this.fechapedido, "StrToJSTs"), this.idcondicion,
					this.idvendedor, this.idexpreso, this.comision,
					this.ordencompra, this.observaciones, new BigDecimal(
	...
	public boolean ejecutarValidacion() {
		try {
			...
			this.listPrioridades = pedidos_cabe
					.getPedidosPrioridadesDistribuidoresAll(50, 0);
