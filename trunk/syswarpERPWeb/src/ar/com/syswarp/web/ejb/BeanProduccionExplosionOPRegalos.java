...
public class BeanProduccionExplosionOPRegalos implements SessionBean,
		Serializable {
	static Logger log = Logger
			.getLogger(BeanProduccionExplosionOPRegalos.class);
	...
	public BeanProduccionExplosionOPRegalos() {
		super();
	}
		...
		try {
			...
			if (!this.explosion.equalsIgnoreCase("")) {
				...
				if (mensaje.equals("")) {
					this.mensaje = produccionMovProdu
							.produccionGenerarExplosionOPRegalos(this.idop,
			...
			if (buscar) {
				...
				this.produccionMovProduList = produccionMovProdu
						.getProduccionMovProduRegalosPendientesOcu(this.limit,
				...
				this.produccionMovProduList = produccionMovProdu
						.getProduccionMovProduRegalosPendientesAll(this.limit,
