...
public class BeanConsultaSASIngresodeFichas implements SessionBean,
		Serializable {
	private SessionContext context;

	private BigDecimal idempresa = new BigDecimal(-1);

	static Logger log = Logger.getLogger(BeanConsultaSASIngresodeFichas.class);
	...
	public BeanConsultaSASIngresodeFichas() {
		super();
	}
	...
	public void ejecutarSentenciaDML() {
		try {
			...
			this.MovimientosList = Consulta.getConsultaIngresoFichas( fdesde.toString() , fhasta.toString(),this.idempresa);
