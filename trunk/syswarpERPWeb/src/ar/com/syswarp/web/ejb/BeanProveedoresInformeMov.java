...
public class BeanProveedoresInformeMov implements SessionBean, Serializable {
	private SessionContext context;

	private BigDecimal idempresa = new BigDecimal(-1);

	static Logger log = Logger.getLogger(BeanProveedoresInformeMov.class);
	...
	public BeanProveedoresInformeMov() {
		super();
	}
	...
	public void ejecutarSentenciaDML() {
		try {
			...
			if (this.mensaje.equalsIgnoreCase("")) {
				this.MovimientosList = Consulta.getProveedoInformeMovimientos(
