...
public class BeanConsultaEstadosActualFrm implements SessionBean, Serializable {
	private SessionContext context;

	static Logger log = Logger.getLogger(BeanConsultaEstadosActualFrm.class);
	...
	public BeanConsultaEstadosActualFrm() {
		super();
	}
