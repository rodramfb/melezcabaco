...
public class BeanConsultaEstadosActualMod implements SessionBean,
		Serializable {
	...
	static Logger log = Logger.getLogger(BeanConsultaEstadosActualMod.class);
	...
	public BeanConsultaEstadosActualMod() {
		super();
	}
	...
	public boolean ejecutarValidacion() {
		...
		try {
		    ...
		    if (this.accion.equalsIgnoreCase("modificacion")) {
			    if (idreactivacion == null) {
				    this.mensaje = "Debe seleccionar un registro.";
				} else { 
		    	    dispatcher = request.getRequestDispatcher("consestadoactualModFrm.jsp");
		     ...
		     if (!this.ocurrencia.trim().equalsIgnoreCase("")) {
		      ...
		      if (buscar) {
		          ...
		          this.totalRegistros = Consulta.getTotalEntidadOcuporempresaEstadoMod(campos, this.ocurrencia,this.idempresa);
		          ...
		          this.MovimientosList = Consulta.ClientesesstadosbajasuspensionlargaOcuMod(this.limit,this.offset,this.idempresa,this.ocurrencia);
		          } else {
		             this.totalRegistros = Consulta.getTotalEntidadporempresaEstadoMod(this.idempresa);
		             this.totalPaginas = (this.totalRegistros / this.limit) + 1; 
		             if (this.totalPaginas < this.paginaSeleccion)
		                this.paginaSeleccion = this.totalPaginas;
		             this.offset = (this.paginaSeleccion - 1) * this.limit;
			        ...
			        this.MovimientosList = Consulta.ClientesesstadosbajasuspensionlargaMod(this.limit,this.offset,this.idempresa);				
						//this.mensaje = "";
		          }
