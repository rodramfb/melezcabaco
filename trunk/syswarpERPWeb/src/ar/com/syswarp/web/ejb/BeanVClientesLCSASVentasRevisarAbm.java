/* 
   javabean para la entidad: vClientesLCSASVentasRevisar
   Copyrigth(r) sysWarp S.R.L. 
   Fecha de creacion: Thu Apr 26 13:49:01 ART 2012 
   
   Para manejar la pagina: vClientesLCSASVentasRevisarAbm.jsp
...
public class BeanVClientesLCSASVentasRevisarAbm implements SessionBean,
		Serializable {

	static Logger log = Logger
			.getLogger(BeanVClientesLCSASVentasRevisarAbm.class);
	...
	private List vClientesLCSASVentasRevisarList = new ArrayList();
	...
	public BeanVClientesLCSASVentasRevisarAbm() {
		super();
	}
	...
	public boolean ejecutarValidacion() {
		...
		try {
			...
			if (this.mes == 0) {
				...
				String filtro = " WHERE idestadopedido = 1 AND DATE_PART('YEAR', fechapedido) = "
						+ this.anio
						+ " AND  DATE_PART('MONTH', fechapedido) = "
						+ this.mes
						+ " AND idtipoclie = "
				...
				if (this.idcliente.longValue() > 0) {
					...
					this.totalRegistros = clientes.getTotalEntidadFiltro(
							"vClientesLCSASVentasRevisar", filtro,
							this.idempresa);
					...
					this.vClientesLCSASVentasRevisarList = clientes
							.getVClientesLCSASVentasRevisarXCliente(this.limit,
									this.offset, this.anio, this.mes,
									this.idtipoclie, this.idestado,
					...
					this.vClientesLCSASVentasRevisarList = clientes
							.getVClientesLCSASVentasRevisarAll(this.limit,
									this.offset, this.anio, this.mes,
									this.idtipoclie, this.idestado,
									this.idempresa);
				}
	...
	public List getVClientesLCSASVentasRevisarList() {
		return vClientesLCSASVentasRevisarList;
	}

	public void setVClientesLCSASVentasRevisarList(
			List vClientesLCSASVentasRevisarList) {
		this.vClientesLCSASVentasRevisarList = vClientesLCSASVentasRevisarList;
	}
