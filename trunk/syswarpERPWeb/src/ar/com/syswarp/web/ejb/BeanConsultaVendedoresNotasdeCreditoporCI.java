...
public class BeanConsultaVendedoresNotasdeCreditoporCI implements SessionBean,
		Serializable {
	...
	static Logger log = Logger
			.getLogger(BeanConsultaVendedoresNotasdeCreditoporCI.class);
	...
	public BeanConsultaVendedoresNotasdeCreditoporCI() {
		super();
	}
	...
	public boolean ejecutarValidacion() {
		try {
			...
			this.MovimientosList = Consulta
					.getCosnultaVendedoresNotasdecreditoporCI(this.anio,
