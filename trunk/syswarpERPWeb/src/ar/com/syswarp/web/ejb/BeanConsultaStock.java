...
public class BeanConsultaStock implements SessionBean, Serializable {
	private SessionContext context;

	private BigDecimal idempresa = new BigDecimal(-1);

	static Logger log = Logger.getLogger(BeanConsultaStock.class);
	...
	public boolean ejecutarValidacion() {
		try {
			...
			this.MovimientosList = Consulta.getConsultaStock(this.codigo_st,this.idempresa);
		} catch (Exception e) {
