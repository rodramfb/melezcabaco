...
public class BeanConsultaControlDisponible implements SessionBean,
		Serializable {
	private SessionContext context;

	private BigDecimal idempresa = new BigDecimal(-1);

	static Logger log = Logger.getLogger(BeanConsultaControlDisponible.class);
	...
	public BeanConsultaControlDisponible() {
		super();
	}
	...
	public boolean ejecutarValidacion() {
		try {
			...
			this.MovimientosList = Consulta.getConsultaControlDisponible(this.idempresa);
