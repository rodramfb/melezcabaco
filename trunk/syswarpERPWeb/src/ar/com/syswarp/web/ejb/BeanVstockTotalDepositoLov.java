...
public class BeanVstockTotalDepositoLov implements SessionBean, Serializable {
	static Logger log = Logger.getLogger(BeanVstockTotalDepositoLov.class);
	...
	public BeanVstockTotalDepositoLov() {
		super();
	}
	...
	public boolean ejecutarValidacion() {
		...
		try {
			...
			if (buscar) {
				...
				this.vstockTotalDepositoList = vstockTotalDeposito
						.getVstockTotalDepositoPK(this.codigo_st,
								this.idempresa);
			}
