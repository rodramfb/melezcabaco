...
public class BeanProduccionMovProduFrm implements SessionBean, Serializable {
	private SessionContext context;

	private BigDecimal idempresa = new BigDecimal(-1);

	static Logger log = Logger.getLogger(BeanProduccionMovProduFrm.class);
	...
	public BeanProduccionMovProduFrm() {
		super();
	}
		...
		try {
			...
			if (this.accion.equalsIgnoreCase("alta")) {
				this.mensaje = produccionMovProdu.produccionOrdenProdCreate(
						...
						this.codigo_st, this.idcontador, this.nrointerno, null,
	...
	public boolean ejecutarValidacion() {
		try {
			if (!this.volver.equalsIgnoreCase("")) {
				response.sendRedirect("produccionMovProduAbm.jsp");
				return true;
			}
