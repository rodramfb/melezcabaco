...
public class BeanStockDepositosLov implements SessionBean, Serializable {
	static Logger log = Logger.getLogger(BeanStockDepositosLov.class);
	...
	public boolean ejecutarValidacion() {
		...
		try {
			...
			if (buscar) {
				...
				this.stockdepositosList = stockdepositos
						.getStockdepositosLovOcu(this.limit, this.offset,
				...
				this.stockdepositosList = stockdepositos
						.getStockdepositosLovAll(this.limit, this.offset,
