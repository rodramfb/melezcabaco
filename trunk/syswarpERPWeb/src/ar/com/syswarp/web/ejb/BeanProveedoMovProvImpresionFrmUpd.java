...
public class BeanProveedoMovProvImpresionFrmUpd implements SessionBean,
		Serializable {
	...
	static Logger log = Logger
			.getLogger(BeanProveedoMovProvImpresionFrmUpd.class);
	...
	public BeanProveedoMovProvImpresionFrmUpd() {
		super();
	}
