...
public class BeanConsultaArribosOCporProducto implements SessionBean, Serializable {
	private SessionContext context;

	private BigDecimal idempresa = new BigDecimal(-1);

	static Logger log = Logger.getLogger(BeanConsultaArribosOCporProducto.class);
	...
	public BeanConsultaArribosOCporProducto() {
		super();
	}
	...
	public boolean ejecutarValidacion() {
		try {
			...
			this.MovimientosList   = Consulta.getConsultaOrdendeCompraporProducto(this.idempresa,this.producto);
		} catch (Exception e) {
