...
public class BeanVPedidosEstadoPreconform implements SessionBean, Serializable {

	static Logger log = Logger.getLogger(BeanVPedidosEstadoPreconform.class);
	...
	public BeanVPedidosEstadoPreconform() {
		super();
	}
	...
	public boolean ejecutarValidacion() {
		...
		try {
			...
			if (this.accion.equalsIgnoreCase("cambiarestado")) {
				dispatcher = request
						.getRequestDispatcher("pedidosCambioEstadoPreconform.jsp");
			...
			if (buscar) {
				...
				if (fechadesde == null || fechahasta == null) {
					this.vPedidosEstadoList = clie.getVPedidosEstadoPreconfAll(
							this.limit, this.offset, this.idestado,
