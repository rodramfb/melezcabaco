...
public class BeanReferenciaLov implements SessionBean, Serializable {
	static Logger log = Logger.getLogger(BeanReferenciaLov.class);
		...
		try {
			...
			if (buscar) {
				...
				this.clientesclientesList = clientesclientes
						.getClientesclientesLovOcu(this.limit, this.offset,
