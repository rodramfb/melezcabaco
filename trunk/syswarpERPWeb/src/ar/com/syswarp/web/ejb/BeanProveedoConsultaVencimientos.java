...
public class BeanProveedoConsultaVencimientos implements SessionBean, Serializable {
	private SessionContext context;

	private BigDecimal idempresa = new BigDecimal(-1);

	static Logger log = Logger.getLogger(BeanProveedoConsultaVencimientos.class);
	...
	//<---------------------------------------------------
	public BeanProveedoConsultaVencimientos() {
		super();
	}
	...
	//		    	this.SaldoAnteriorList = Consulta.getMovArticuloDepositoSaldoAnterior(this.codigo_st, this.iddeposito, this.fechadesde, this.fechahasta, idempresa);
			    	this.MovimientosList   = Consulta.getProveedoresVencimientos( this.fechadesde, this.fechahasta, idempresa);
	//		    	this.SaldoFinalList    = Consulta.getMovArticuloDepositoSaldoFinal(this.codigo_st, this.iddeposito, this.fechadesde, this.fechahasta, idempresa);
			    	...
			    	if (this.flag)
			    	{
			    		...
			    		general.setArchivo(this.MovimientosList, new BigDecimal(totCol), "ConsultasVencimientos");
			    	}
