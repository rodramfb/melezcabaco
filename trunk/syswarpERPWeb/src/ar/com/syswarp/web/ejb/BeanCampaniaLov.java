...
public class BeanCampaniaLov implements SessionBean, Serializable {
	static Logger log = Logger.getLogger(BeanCampaniaLov.class);
		...
		try {
			...
			if (buscar) {
				...
				this.clientescampaniaList = clientescampania
						.getCampaniaLovOcu(this.limit, this.offset,
								this.ocurrencia);
			} else {
				...
				this.clientescampaniaList = clientescampania
						.getCampaniaLovAll(this.limit, this.offset);
			}
