...
public class BeanClientesClientesAbm implements SessionBean, Serializable {
	...
	public BeanClientesClientesAbm() {
		super();
	}
		...
		try {
			...
			if (this.accion.equalsIgnoreCase("modificacion")) {
				if (idcliente.longValue() < 0) {
					...
					dispatcher = request
							.getRequestDispatcher("clientesClientesFrm.jsp");
			...
			if (!Common.setNotNull(this.filtroIdclienteKosher)
				...
				auxFiltro += "  AND idclientekosher = " + this.filtroIdclienteKosher;
			}
			...
			String entidad = "("
					+ "SELECT cl.idcliente, cl.idclientekosher, cl.razon, cl.nrodocumento, cl.idempresa"
