...
public class BeanClientesDetalleDomicilioFrm implements SessionBean,
		Serializable {
	private SessionContext context;

	static Logger log = Logger.getLogger(BeanClientesDetalleDomicilioFrm.class);
	...
	public BeanClientesDetalleDomicilioFrm() {
		super();
	}
	...
	public boolean ejecutarValidacion() {
		try {
			if (!this.volver.equalsIgnoreCase("")) {
				response.sendRedirect("ClientesDetalleDomicilioAbm.jsp");
				return true;
			}
