...
public class BeanVMovArtDepositoFecha implements SessionBean, Serializable {
	static Logger log = Logger.getLogger(BeanVMovArtDepositoFecha.class);
	...
	public BeanVMovArtDepositoFecha() {
		super();
	}
		...
		try {
			...
			if (buscar) {
				...
				this.totalRegistros = vMovArtFecha
						.getTotalStockAgrupadoDepositoFechaOcu(
				...
				this.vMovArtFechaList = vMovArtFecha
						.getVTotalArtDepositoFechaOcu(this.limit, this.offset,
								(java.sql.Date) (Common.setObjectToStrOrTime(
										this.fecha_ms, "strToJSDate")),
								this.ocurrencia, this.idempresa, this.getUsuario());
			} else {
				this.totalRegistros = vMovArtFecha
						.getTotalStockDepositoAgrupadoFecha(
								(java.sql.Date) Common.setObjectToStrOrTime(
										this.fecha_ms, "strToJSDate"),
				...
				this.vMovArtFechaList = vMovArtFecha
						.getVTotalArtDepositoFechaAll((java.sql.Date) (Common
								.setObjectToStrOrTime(this.fecha_ms,
										"strToJSDate")), this.limit,
								this.offset, this.idempresa, this.getUsuario());
			}
