...
public class BeanConsultaDiferenciasPedidos implements SessionBean,
		Serializable {
	private SessionContext context;

	private BigDecimal idempresa = new BigDecimal(-1);

	static Logger log = Logger.getLogger(BeanConsultaDiferenciasPedidos.class);
	...
	public BeanConsultaDiferenciasPedidos() {
		super();
	}
	...
	public void ejecutarSentenciaDML() {
		try {
			...
			this.MovimientosList = Consulta.getClientesDiferenciaenPedidos(
					this.anio , this.mes,this.codigo_fm, this.idempresa);
	...
	public boolean ejecutarValidacion() {
		try {
			...
			if (!this.validar.equalsIgnoreCase("")) {
				...
				if (this.d_codigo_fm == null || this.d_codigo_fm.equalsIgnoreCase("")){
