...
public class BeanLovClientesCobradoresAbm implements SessionBean, Serializable {
	static Logger log = Logger.getLogger(BeanLovClientesCobradoresAbm.class);
	...
	public BeanLovClientesCobradoresAbm() {
		super();
	}
	...
	public boolean ejecutarValidacion() {
		...
		Tesoreria clientesCobradores = Common.getTesoreria();
		try {
			...
			if (buscar) {
				...
				this.clientesCobradoresList = clientesCobradores
						.getLovClientesCobradoresOcu(this.limit, this.offset,
				...
				this.clientesCobradoresList = clientesCobradores
						.getLovClientesCobradoresAll(this.limit, this.offset,
								this.idempresa);
			}
