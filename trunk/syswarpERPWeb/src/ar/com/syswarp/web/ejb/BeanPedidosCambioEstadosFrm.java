...
public class BeanPedidosCambioEstadosFrm implements SessionBean, Serializable {
	private SessionContext context;

	static Logger log = Logger.getLogger(BeanPedidosCambioEstadosFrm.class);
	...
	public BeanPedidosCambioEstadosFrm() {
		super();
	}
		...
		try {
			...
			if (this.accion.equalsIgnoreCase("cambiarestado")) {
				...
				if (this.tipopedido.equalsIgnoreCase("N")) {
					...
					resultado[0] = "No es posible ejecutar esta acción desde este punto, este  pedido corresponde a Regalos Empresarios.";
		...
		try {
			...
			if (!this.validar.equalsIgnoreCase("")) {
				...
				if (!this.accion.equalsIgnoreCase("baja")) {
					...
					if (this.idestadonuevo.longValue() == 2) {
