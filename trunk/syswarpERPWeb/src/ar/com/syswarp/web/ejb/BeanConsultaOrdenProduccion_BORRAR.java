...
public class BeanConsultaOrdenProduccion_BORRAR implements SessionBean, Serializable {
	private SessionContext context;

	private BigDecimal idempresa = new BigDecimal(-1);

	static Logger log = Logger.getLogger(BeanConsultaOrdenProduccion_BORRAR.class);
	...
	public BeanConsultaOrdenProduccion_BORRAR() {
		super();
	}
	...
	public boolean ejecutarValidacion() {
		try {
			...
			this.MovimientosList = Consulta.getConsultaOrdenProduccion(this.codigo_st,this.idempresa);
		} catch (Exception e) {
