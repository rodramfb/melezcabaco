...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idretencion2, d_idretencion2){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idretencion2)
			break;
	opener.document.forms[i].idretencion2.value = idretencion2;
	opener.document.forms[i].d_idretencion2.value = d_idretencion2; 
	window.close();
}
 </script>
</head>
...
<form action="lov_retenciones2.jsp" method="POST" name="frm">
