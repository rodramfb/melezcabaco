...
String color_fondo ="";
String titulo = "Condicion Pago";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterProveedorescondicionpago   = null;
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanProveedorCondicionPagoLov"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idcondicionpago, d_idcondicionpago){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idcondicionpago)
			break;
	opener.document.forms[i].idcondicionpago.value = idcondicionpago;
	opener.document.forms[i].d_idcondicionpago.value = d_idcondicionpago; 
	window.close();
}
 </script>
</head>
...
java.util.List proveedorescondicionpago = new java.util.ArrayList();
proveedorescondicionpago= BFFF.getcondicionpagoList();
iterProveedorescondicionpago = proveedorescondicionpago.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_condpago.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterProveedorescondicionpago.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterProveedorescondicionpago.next(); 
