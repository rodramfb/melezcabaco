...
<html>
	<%-- INSTANCIAR BEAN --%>
	<jsp:useBean id="BPF"
		class="ar.com.syswarp.web.ejb.BeanProveedoConsultaSaldos" scope="page" />
	<head>
		<title>Consuta de Vencimientos de Proveedores</title>
	...
	<BODY>
		...
		<% 
 String titulo = "Consulta de Saldos Pendientes de Proveedores.";
 ...
 %>
		<form action="proveedoConsultaSaldos.jsp" method="post" name="frm">
...
&nbsp;																								</td>
							...
							<tr class="fila-det">
							  <td class="fila-det-border"> Fecha Movimiento Hasta (*) </td>
...
<table> 
<tr class="fila-det">
<td width="1096" class="fila-det-border">

						   El archivo se generó exitosamente. Haga click para descargar.
<img src="../imagenes/default/gnome_tango/apps/pdf.jpg" width="20" height="20" onClick="abrirVentana('../reportes/jasper/generaPDF.jsp?plantillaImpresionJRXML=proveed_saldos_pendientes&fechahasta=<%= BPF.getFechahasta() %>', 'pdf', 800, 600);">  Exportar a excel <a href="./manejarArchivosDatosToXls.jsp?file=../reportes/reportes/ConsultaSaldos.csv" >
<input type="image" src="../imagenes/default/gnome_tango/mimetypes/gnome-mime-application-vnd.ms-excel.png"/></a><%
			session.setAttribute("archivo","ConsultaSaldos.csv");%></td>
</tr> 
</table>    
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable"   >
  <tr class="fila-encabezado">  
     ...
     <td width="5%"><div align="right">Saldo a fecha</div></td>  
  ...
  int r = 0;
   while(iterConsulta2.hasNext()){
      ...
      totalSaldo = totalSaldo.add(new BigDecimal( sCampos[2]) );      
 ...
 <% } %>
    ...
    <tr class="fila-encabezado">  
     ...
     <td width="30%"></td>
     <td width="5%"><div align="right"><%=totalSaldo.toString()%></div></td>
