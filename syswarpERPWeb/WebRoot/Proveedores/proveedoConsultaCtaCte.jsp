...
<html>
<%-- INSTANCIAR BEAN --%>
<jsp:useBean id="BPF" class="ar.com.syswarp.web.ejb.BeanProveedoConsultaCtaCte" scope="page" />
<head>
...
<BODY>
		...
		<% 
		 ...
		 if (BPF.getTipo().equalsIgnoreCase("P") || BPF.getTipo().equalsIgnoreCase("H")){
 		...
 		%>
		<form action="proveedoConsultaCtaCte.jsp" method="post" name="frm">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr class="fila-det">
					<td width="20%" class="fila-det-border">Proveedor Desde: (*)</td>
				  	...
				  	<td width="20%" class="fila-det-border">Proveedor Hasta: (*)</td>
				  	<td class="fila-det-border">
						<!--<input name="dproveedorhasta" type="text" class="campo" id="dproveedorhasta" value="< %=BPF.getDproveedorhasta() %>" size="30" readonly="true">	
						<input name="idproveedorhasta" type="hidden" id="idproveedorhasta" value="< %=BPF.getIdproveedorhasta() %>">
						<img src="../imagenes/default/gnome_tango/actions/filefind.png" width="22" height="22" 	onClick="mostrarLOV('../Proveedores/lov_proveedores_hasta.jsp')" style="cursor:pointer">-->
				  	</td>								
				</tr>
				<tr class="fila-det">
				...
				<tr class="fila-det">
					...
					<td class="fila-det-border" colspan="3">
						<select name="tipo" class="cal-TextBox" >
...
<%
    ...
    <%if(BPF.getTipo().equalsIgnoreCase("H") && BPF.isFlag()) {%>     
       		...
       		<!--  <img src="../imagenes/default/gnome_tango/apps/pdf.jpg" width="20" height="20" onClick="abrirVentana('../reportes/reportes/generaPDF.jsp?plantillaImpresionJRXML=proveed_cuenta_corriente_historica&idproveedor=<%=BPF.getIdproveedordesde()%>&fechadesde=<%=BPF.getFechadesde()%>&fechahasta=<%=BPF.getFechahasta()%>', 'pdf', 800, 600);">Exportar a excel <a href="./manejarArchivosDatosToXls.jsp?file=../reportes/reportes/ConsultaCtaCteHistorico.csv" >
       		-->	<input type="image" src="../imagenes/default/gnome_tango/mimetypes/gnome-mime-application-vnd.ms-excel.png"/></a><%
