...
function passBack(idcuenta, cuenta) {  
  var opcion = "<%= opcion %>";
  var id     =  "<%= id %>";
  if(opcion == "byId"){
    opener.document.getElementById(id).value = idcuenta ;
		id = (parseInt(id)+1) + "" ;
    opener.document.getElementById(id).value = cuenta ;		
  }
	else{
		var i = 0;
		 for(i=0;i<10;i++)
...
<hr>
<form action="lov_cuentascont.jsp">
  <table width="59%" border="0" cellspacing="0" cellpadding="0" height="23">
    <tr> 
      ...
      <td width="54%" height="39"> 
        <input name="idcuenta" type="text" class="campo" value="<%=idcuenta%>" size="25">
      </td>
