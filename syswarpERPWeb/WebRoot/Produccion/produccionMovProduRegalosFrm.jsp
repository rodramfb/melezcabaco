...
<html>
<%-- INSTANCIAR BEAN --%>  
<jsp:useBean id="BPMPF"  class="ar.com.syswarp.web.ejb.BeanProduccionMovProduRegalosFrm"   scope="page"/>
<head>
...
<div id="popupcalendar" class="text"></div>
 ...
 <% 
 String titulo = BPMPF.getAccion().toUpperCase() + " DE ORDENES DE PRODUCCION DE REGALOS EMPRESARIOS" ;
 ...
 %>
<form action="produccionMovProduRegalosFrm.jsp" method="post" name="frm">
       ...
       <td>
         <table width="100%"  border="0" cellspacing="0" cellpadding="0" align="center">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center"> 
              ...
              <tr class="text-catorce">
                ...
                <td >
                    ...
                    <tr class="text-catorce"> 
                      ...
                      <td width="13%"> <img src="../imagenes/default/gnome_tango/actions/document-print-preview.png" width="22" height="22" onClick="abrirVentana('produccionCalculoNecesidadFrame.jsp?idop=<%= BPMPF.getIdop()%>&tipoPedido=R');" style="cursor:pointer" title="Impresi&oacute;n de orden con costos inclu&iacute;dos."></td>
                      <td width="39%"><div align="right">Sin Costos&nbsp; </div> </td>
                      <td width="9%"> <img src="../imagenes/default/gnome_tango/devices/yast_printer.png" width="22" height="22" onClick="abrirVentana('produccionCalculoNecesidadSinCostoFrame.jsp?idop=<%= BPMPF.getIdop()%>&tipoPedido=R');" style="cursor:pointer" title="Impresi&oacute;n de orden sin costos."></td>
                    </tr>
                  </table>								</td> 
                <td >&nbsp;</td>
              </tr>
              ...
              <tr class="fila-det">
                <td class="fila-det-border">Pedido de Regalos Asociado(*) </td>
                <td class="fila-det-border"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="11%"><input name="idpedido_regalos_cabe" type="text" class="campo" id="idpedido_regalos_cabe" value="<%=BPMPF.getIdpedido_regalos_cabe()%>" size="12" maxlength="8"  ></td>
                      <td width="89%">
					  <% if(  BPMPF.getAccion().equalsIgnoreCase("alta")  ){ %><img src="../imagenes/default/gnome_tango/actions/find.png" width="22" height="22" style="cursor:pointer" onClick="abrirVentana('../Clientes/pedidosRegalosHijos.jsp', 'EP', 800, 400)"> 
					  <% } else { %>
					  <img src="../imagenes/default/gnome_tango/apps/pdf.jpg" title="Reimprimir " width="18" height="18" onClick="abrirVentana('../reportes/jasper/generaPDF.jsp?plantillaImpresionJRXML=notas_pedido_regalos&idpedido_cabe=<%=BPMPF.getIdpedido_regalos_cabe()%>','pedido',750, 400)" style="cursor:pointer">
              ...
              <tr class="fila-det">
                ...
                <td width="22%" class="fila-det-border">&nbsp;
								  <% if( Double.parseDouble(BPMPF.getCantre_op())== 0 ){ %>
									  <%-- <img src="../imagenes/default/gnome_tango/actions/find.png" width="22" height="22" style="cursor:pointer" onClick="abrirVentana('lov_esquemaProducto.jsp', 'EP', 700, 400)"> --%>
                  <% } %>
