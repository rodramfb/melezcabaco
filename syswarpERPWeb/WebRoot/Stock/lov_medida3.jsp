...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(unialt3_st, d_unialt3_st){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].unialt3_st)
			break;
	opener.document.forms[i].unialt3_st.value = unialt3_st;
	opener.document.forms[i].d_unialt3_st.value = d_unialt3_st; 
	window.close();
}
 </script>
</head>
...
<form action="lov_medida3.jsp" method="POST" name="frm">
