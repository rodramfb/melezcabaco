...
String color_fondo ="";
String titulo = "STOCK A FECHA POR DEPOSITOS";
...
%>
<html>
<jsp:useBean id="BVMAFA"  class="ar.com.syswarp.web.ejb.BeanVMovArtDepositoFecha"   scope="page"/>
...
<form action="stockArtDepositoFecha.jsp" method="POST" name="frm">
