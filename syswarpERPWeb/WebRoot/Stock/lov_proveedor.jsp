...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanProveedorLov" scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(proveed_st, d_proveed_st){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].proveed_st)
			break;
	opener.document.forms[i].proveed_st.value = proveed_st;
	opener.document.forms[i].d_proveed_st.value = d_proveed_st; 
	window.close();
}
 </script>
</head>
...
java.util.List proveedor = new java.util.ArrayList();
proveedor= BFFF.getproveedoresList();
iterProveedor = proveedor.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_proveedor.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   while(iterProveedor.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterProveedor.next(); 
