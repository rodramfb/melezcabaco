...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(articulohasta, articulodesde){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].articulohasta)
			break;
	opener.document.forms[i].articulohasta.value = articulohasta;
	//opener.document.forms[i].articulodesde.value = articulodesde; 
	window.close();
}
 </script>
</head>
...
<form action="lov_articulo2.jsp" method="POST" name="frm">
