...
/* 
   Grilla para la entidad: tipo_parametro
...
String color_fondo ="";
String titulo = "TIPO PARAMETRO";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterTipo_parametro   = null;
...
%>
<html>
<jsp:useBean id="BTA"  class="ar.com.syswarp.web.ejb.report.BeanTipo_parametroAbm"   scope="page"/>
...
tituCol[0] = "Cód.";
tituCol[1] = "Tipo Parametro";
java.util.List Tipo_parametro = new java.util.ArrayList();
Tipo_parametro= BTA.getTipo_parametroList();
iterTipo_parametro = Tipo_parametro.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="tipo_parametroAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
     ...
     <td width="88%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[1]%></td>
   </tr>
   <%int r = 0;
   while(iterTipo_parametro.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterTipo_parametro.next(); 
      // estos campos hay que setearlos segun la grilla 
      if (color_fondo.equals("fila-det-verde")) color_fondo = "fila-det";
      else color_fondo = "fila-det-verde";%>
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="idtipoparametro" value="<%= sCampos[0]%>"></td>
