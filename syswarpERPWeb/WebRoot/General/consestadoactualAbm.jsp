...
String color_fondo ="";
String titulo = "Solicitud de Reactivacion";
...
%>
<html>
<jsp:useBean id="BCA"  class="ar.com.syswarp.web.ejb.BeanConsultaEstadosActual"   scope="page"/>
...
<form action="consestadoactualAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
	 ...
	 <td width="16%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);">Cuenta Corriente </td>
   </tr>
   <%int r = 0;
