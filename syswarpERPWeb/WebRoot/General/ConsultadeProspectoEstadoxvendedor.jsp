...
<html>
	<%-- INSTANCIAR BEAN --%>
	<jsp:useBean id="BPF"
		class="ar.com.syswarp.web.ejb.BeanConsultaPrecargaEstadosxVendedor" scope="page" />
	<head>
	...
	<BODY>
		...
		<% 
 String titulo = "Total de Precarga por Estado";
 ...
 %>
		<form action="ConsultadeProspectoEstadoxvendedor.jsp" method="post" name="frm">
...
<tr class="fila-det">
						    ...
						    <td width="11%" height="46" class="fila-det-border">Vendedor
					        <input name="idvendedor" type="hidden" id="idvendedor" value="<%=BPF.getIdvendedor()%>"></td>
						    <td width="26%" class="fila-det-border"><table width="23%" border="0">
                              <tr class="fila-det-border">
  ...
  <% BigDecimal totalgeneral = new BigDecimal(0); %> 
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" >
     <td height="22" class="fila-det-border" >&nbsp;<%=sCampos[0]%></td>
      <td width="24%" class="fila-det-border" ><div align="right"><%=sCampos[1]%></div></td>
   </tr>
   <%
   }%>
   </table>
