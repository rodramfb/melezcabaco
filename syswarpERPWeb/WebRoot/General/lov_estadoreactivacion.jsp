...
String color_fondo ="";
//String titulo = "Zona";
String titulo = "Estado Reactivacion";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterEstadosReactivaciones   = null;
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanGlobalEstadosReactivaciones"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idestadoreactivaciones, estadoreactivaciones){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idestadoreactivaciones)
			break;
	opener.document.forms[i].idestadoreactivaciones.value = idestadoreactivaciones;
	opener.document.forms[i].estadoreactivaciones.value = estadoreactivaciones; 
	window.close();
}
 </script>
</head>
...
clienteszona= BFFF.getestadoreactivacionesList();
iterEstadosReactivaciones = clienteszona.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_estadoreactivacion.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterEstadosReactivaciones.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterEstadosReactivaciones.next(); 
