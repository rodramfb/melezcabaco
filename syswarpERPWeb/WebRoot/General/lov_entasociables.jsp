...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(identidadorigen, entidadorigen){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].identidadorigen)
			break;
	opener.document.forms[i].identidadorigen.value = identidadorigen;
	opener.document.forms[i].entidadorigen.value = entidadorigen; 
	window.close();
}
 </script>
</head>
