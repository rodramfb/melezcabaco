...
int i = 0;
Iterator iterGeneralcontador7   = null;
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idconta_remitos3, conta_remitos3){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idconta_remitos3)
			break;
	opener.document.forms[i].idconta_remitos3.value = idconta_remitos3;
	opener.document.forms[i].conta_remitos3.value = conta_remitos3; 
	window.close();
}
 </script>
</head>
...
iterGeneralcontador7 = generalcontador.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_contador7.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterGeneralcontador7.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterGeneralcontador7.next(); 
