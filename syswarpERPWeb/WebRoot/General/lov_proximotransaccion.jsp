...
String titulo = "Proxima Transaccion";
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanWkftransaccionesAbm"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idproximatransaccion, proximatransaccion){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idproximatransaccion)
			break;
	opener.document.forms[i].idproximatransaccion.value = idproximatransaccion;
	opener.document.forms[i].proximatransaccion.value = proximatransaccion; 
	window.close();
}
 </script>
</head>
...
tituCol[0] = "Codigo";
tituCol[1] = "Proxima Transaccion";

java.util.List clientesexpreso = new java.util.ArrayList();
clientesexpreso= BFFF.getWkftransaccionesList();
iterClientestipoevento = clientesexpreso.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_proximoevento.jsp" method="POST" name="frm">
