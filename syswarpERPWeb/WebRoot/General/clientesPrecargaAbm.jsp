...
%>
<html>
<jsp:useBean id="BCCA"  class="ar.com.syswarp.web.ejb.BeanClientesPrecargaAbm"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 function confirmarPasaje(indice){ 
   if(confirm("Confirma el pasaje a Cliente?") ){
...
<form action="clientesPrecargaAbm.jsp" method="POST" name="frm" >
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
    ...
    <td width="0%" ><div align="center">Club</div></td>
    <td width="42%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[1]%></td>
    <td width="17%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[12]%></td>
  ...
  <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" >
    ...
    <td  class="fila-det-border" ><div align="center"><img src="<%=sCampos[45]%>" title="<%=sCampos[44]%>"></div></td>
...
<input name="referer" value="precarga" type="hidden">
</form>
  </body>
</html>
<% 
