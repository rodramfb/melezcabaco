...
/* 
   Formulario de carga para la entidad: globalgrupos
...
<html>
<%-- INSTANCIAR BEAN --%>  
<jsp:useBean id="BGF"  class="ar.com.syswarp.web.ejb.BeanGlobalgruposFrm"   scope="page"/>
<head>
 <title>FRMGlobalgrupos.jsp</title>
...
<div id="popupcalendar" class="text"></div>
 ...
 <% 
 String titulo = BGF.getAccion().toUpperCase() + " DE Grupos" ;
 ...
 %>
<form action="globalgruposFrm.jsp" method="post" name="frm">
<input name="accion" type="hidden" value="<%=BGF.getAccion()%>" >
<input name="idgrupo" type="hidden" value="<%=BGF.getIdgrupo()%>" >
         ...
         <table width="100%"  border="0" cellspacing="0" cellpadding="0" align="center">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
              ...
              <tr class="fila-det">
                ...
                <td width="88%" class="fila-det-border"><input name="grupo" type="text" value="<%=BGF.getGrupo()%>" class="campo" size="50" maxlength="50"  ></td>
              </tr>
              <tr class="fila-det">
