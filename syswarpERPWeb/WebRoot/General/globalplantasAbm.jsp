...
/* 
   Grilla para la entidad: globalplantas
...
String color_fondo ="";
String titulo = "Plantas";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterGlobalplantas   = null;
...
%>
<html>
<jsp:useBean id="BGA"  class="ar.com.syswarp.web.ejb.BeanGlobalplantasAbm"   scope="page"/>
...
tituCol[2] = "Domicilio";
tituCol[3] = "Localidad";
tituCol[4] = "Cod postal";
tituCol[5] = "Telefonos";
tituCol[6] = "Fax";
tituCol[7] = "Tarea que desarrolla";
tituCol[8] = "E-mail";
tituCol[9] = "es head quarter";
java.util.List Globalplantas = new java.util.ArrayList();
Globalplantas= BGA.getGlobalplantasList();
iterGlobalplantas = Globalplantas.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="globalplantasAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterGlobalplantas.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterGlobalplantas.next(); 
      // estos campos hay que setearlos segun la grilla 
      if (color_fondo.equals("fila-det-verde")) color_fondo = "fila-det";
      else color_fondo = "fila-det-verde";%>
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="idplanta" value="<%= sCampos[0]%>"></td>
