...
/* 
   Grilla para la entidad: clientespreferencias
...
String color_fondo ="";
String titulo = "Preferencias";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterClientespreferencias   = null;
...
%>
<html>
<jsp:useBean id="BCA"  class="ar.com.syswarp.web.ejb.BeanClientespreferenciasAbm"   scope="page"/>
...
tituCol[0] = "Codigo";
tituCol[1] = "Preferencia";
java.util.List Clientespreferencias = new java.util.ArrayList();
Clientespreferencias= BCA.getClientespreferenciasList();
iterClientespreferencias = Clientespreferencias.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="clientespreferenciasAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterClientespreferencias.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterClientespreferencias.next(); 
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-bold-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="idpreferencia" value="<%= sCampos[0]%>"></td>
