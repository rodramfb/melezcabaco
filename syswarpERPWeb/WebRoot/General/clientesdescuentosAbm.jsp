...
/* 
   Grilla para la entidad: clientesdescuentos
...
String color_fondo ="";
String titulo = "Clientes descuentos";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterClientesdescuentos   = null;
...
%>
<html>
<jsp:useBean id="BCA"  class="ar.com.syswarp.web.ejb.BeanClientesdescuentosAbm"   scope="page"/>
...
tituCol[0] = "codigo";
tituCol[1] = "Porcentaje de descuento";
java.util.List Clientesdescuentos = new java.util.ArrayList();
Clientesdescuentos= BCA.getClientesdescuentosList();
iterClientesdescuentos = Clientesdescuentos.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="clientesdescuentosAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterClientesdescuentos.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterClientesdescuentos.next(); 
      // estos campos hay que setearlos segun la grilla 
      if (color_fondo.equals("fila-det-verde")) color_fondo = "fila-det";
      else color_fondo = "fila-det-verde";%>
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="iddescuento" value="<%= sCampos[0]%>"></td>
