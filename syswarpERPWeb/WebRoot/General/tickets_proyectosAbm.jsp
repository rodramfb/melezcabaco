...
/* 
   Grilla para la entidad: tickets_proyectos
...
String color_fondo ="";
String titulo = "Tickets Proyectos";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterTickets_proyectos   = null;
...
%>
<html>
<jsp:useBean id="BTA"  class="ar.com.syswarp.web.ejb.BeanTickets_proyectosAbm"   scope="page"/>
...
tituCol[0] = "Codigo";
tituCol[1] = "Nombre";
tituCol[2] = "Description";
tituCol[3] = "Estado";
tituCol[4] = "Activo";
tituCol[5] = "Estado Vista";
java.util.List Tickets_proyectos = new java.util.ArrayList();
Tickets_proyectos= BTA.getTickets_proyectosList();
iterTickets_proyectos = Tickets_proyectos.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="tickets_proyectosAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterTickets_proyectos.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterTickets_proyectos.next(); 
      // estos campos hay que setearlos segun la grilla 
      if (color_fondo.equals("fila-det-verde")) color_fondo = "fila-det";
      else color_fondo = "fila-det-verde";%>
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="idproyecto" value="<%= sCampos[0]%>"></td>
