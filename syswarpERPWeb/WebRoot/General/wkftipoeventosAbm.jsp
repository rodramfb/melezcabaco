...
/* 
   Grilla para la entidad: wkftipoeventos
...
String color_fondo ="";
String titulo = "Tipo Eventos";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterWkftipoeventos   = null;
...
%>
<html>
<jsp:useBean id="BWA"  class="ar.com.syswarp.web.ejb.BeanWkftipoeventosAbm"   scope="page"/>
...
java.util.List Wkftipoeventos = new java.util.ArrayList();
Wkftipoeventos= BWA.getWkftipoeventosList();
iterWkftipoeventos = Wkftipoeventos.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="wkftipoeventosAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterWkftipoeventos.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterWkftipoeventos.next(); 
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-bold-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="idtipoevento" value="<%= sCampos[0]%>"></td>
