...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idproceso, proceso){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idproceso)
			break;
	opener.document.forms[i].idproceso.value = idproceso;
	opener.document.forms[i].proceso.value = proceso; 
	window.close();
}
 </script>
</head>
...
<form action="lov_proceso.jsp" method="POST" name="frm">
