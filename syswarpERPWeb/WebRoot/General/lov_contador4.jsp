...
int i = 0;
Iterator iterGeneralcontador4   = null;
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idconta_recibos, conta_recibos){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idconta_recibos)
			break;
	opener.document.forms[i].idconta_recibos.value = idconta_recibos;
	opener.document.forms[i].conta_recibos.value = conta_recibos; 
	window.close();
}
 </script>
</head>
...
iterGeneralcontador4 = generalcontador.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_contador4.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterGeneralcontador4.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterGeneralcontador4.next(); 
