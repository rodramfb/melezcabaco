...
/* 
   Grilla para la entidad: clientesexpresoszonas
...
String color_fondo ="";
String titulo = "Modificacion de Solicitud de Reactivacion";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterClientesexpresoszonas   = null;
...
%>
<html>
<jsp:useBean id="BCA"  class="ar.com.syswarp.web.ejb.BeanConsultaEstadosActualMod"   scope="page"/>
...
tituCol[4] = "motivo";
tituCol[5] = "vendedor";
java.util.List Clientesexpresoszonas = new java.util.ArrayList();
Clientesexpresoszonas= BCA.getMovimientosList();
iterClientesexpresoszonas = Clientesexpresoszonas.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="consestadoactualModAbm.jsp" method="POST" name="frm">
  ...
  <tr class="text-globales">
    <td width="100%" height="24" colspan="10" background="imagenes/dialogtop.gif">
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td width="11%" height="38"><table width="47%" border="0">
                    <tr>
                      <td width="27%">&nbsp;</td>
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
	 ...
	 <td width="9%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);">Cuenta Corriente </td>
   </tr>
   <%int r = 0;
   while(iterClientesexpresoszonas.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterClientesexpresoszonas.next(); 
      // estos campos hay que setearlos segun la grilla 
      if (color_fondo.equals("fila-det-verde")) color_fondo = "fila-det";
      else color_fondo = "fila-det-verde";%>
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td height="28" class="fila-det-border" ><input type="radio" name="idreactivacion" value="<%= sCampos[0]%>"></td>
	  ...
	  <td class="fila-det-border" >&nbsp;<img src="../imagenes/default/gnome_tango/actions/fileopen.png" title="Consulta Cuenta Corriente" width="22" height="22" onClick="ventana=abrirVentana('vclientesCtaCtesAbm.jsp?cliente=<%=sCampos[2]%>&idcliente=<%=sCampos[1]%>', 'ctacte', 800, 400)" style="cursor:pointer"></td>
   </tr>
<%
   }%>
   </table>
