...
<html>
<%-- INSTANCIAR BEAN --%>  
<jsp:useBean id="BCF"  class="ar.com.syswarp.web.ejb.BeanClientesdescuentosFrm"   scope="page"/>
<head>
 <title>FRMClientesdescuentos.jsp</title>
...
<div id="popupcalendar" class="text"></div>
 ...
 <% 
 String titulo = BCF.getAccion().toUpperCase() + " DE CLIENTESDESCUENTOS" ;
 ...
 %>
<form action="clientesdescuentosFrm.jsp" method="post" name="frm">
<input name="accion" type="hidden" value="<%=BCF.getAccion()%>" >
<input name="iddescuento" type="hidden" value="<%=BCF.getIddescuento()%>" >
       ...
       <td>
         <table width="100%"  border="0" cellspacing="0" cellpadding="0" align="center">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
              ...
              <tr class="fila-det">
                <td width="19%" class="fila-det-border">Porcentaje de descuento : (*) </td>
                <td width="81%" class="fila-det-border"><input name="por_desc" type="text" value="<%=BCF.getPor_desc()%>" class="campo" size="18" maxlength="18"  ></td>
              </tr>
              <tr class="fila-det">
                <td class="fila-det-border">&nbsp;</td>
