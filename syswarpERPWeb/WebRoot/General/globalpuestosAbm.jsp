...
/* 
   Grilla para la entidad: globalpuestos
...
int i = 0;
Iterator iterGlobalpuestos   = null;
...
%>
<html>
<jsp:useBean id="BGA"  class="ar.com.syswarp.web.ejb.BeanGlobalpuestosAbm"   scope="page"/>
...
tituCol[1] = "Puesto";
tituCol[2] = "Planta";
tituCol[3] = "Conta_facturasa";
tituCol[4] = "Conta_facturasb";
tituCol[5] = "Conta_facturasc";
tituCol[6] = "Conta_recibos";
tituCol[7] = "Conta_remitos1";
tituCol[8] = "Conta_remitos2";
tituCol[9] = "Conta_remitos3";
tituCol[10] = "Conta_remitos4";
java.util.List Globalpuestos = new java.util.ArrayList();
Globalpuestos= BGA.getGlobalpuestosList();
iterGlobalpuestos = Globalpuestos.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="globalpuestosAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterGlobalpuestos.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterGlobalpuestos.next(); 
      // estos campos hay que setearlos segun la grilla 
      if (color_fondo.equals("fila-det-verde")) color_fondo = "fila-det";
      else color_fondo = "fila-det-verde";%>
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="idpuesto" value="<%= sCampos[0]%>"></td>
