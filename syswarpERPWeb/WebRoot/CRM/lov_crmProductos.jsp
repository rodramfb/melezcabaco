...
<link href="<%=pathskin%>" rel="stylesheet" type="text/css">
 ...
 <script>
 function bajarDatos(nrolote, idtipocotizacion, tipocotizacion, superficie, valor_unitario, valor_total, precio_contado, precio_boleto, precio_cuota){
 
   opener.document.frm.nrolote.value = nrolote;
   opener.document.frm.idtipocotizacion.value = idtipocotizacion;
   opener.document.frm.tipocotizacion.value = tipocotizacion;
   opener.document.frm.superficie.value = superficie;
   opener.document.frm.valor_unitario.value = valor_unitario;
   opener.document.frm.valor_total.value = valor_total;
   opener.document.frm.precio_contado.value = precio_contado;
   opener.document.frm.precio_financiado.value = precio_cuota;  
...
<form action="lov_crmProductos.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  ...
  <tr class="fila-encabezado">
   ...
   while(iterCrmProductos.hasNext()){
	  ...
	  String parametros = "'" + sCampos[0] +  "', '" + sCampos[1] +  "', '" + sCampos[2] + "'," ;
      parametros += "'" + sCampos[8] +  "', '" + sCampos[9] +  "', '" + sCampos[10] + "'," ;
	  parametros += "'" + sCampos[11] +  "', '" + sCampos[12] +  "', '" + sCampos[13] + "'" ;
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-bold');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><%= sCampos[5].trim().equalsIgnoreCase("1") ? "<img src=\"imagenes/default/gnome_tango/actions/down.png\" width=\"18\" height=\"18\" onClick=\"bajarDatos(" + parametros + ")\";>" : "&nbsp;" %></td>
