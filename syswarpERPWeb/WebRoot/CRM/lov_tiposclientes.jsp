...
int i = 0;
Iterator iterCRMtipodeclientes   = null;
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanCrmtiposclientesAbm"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idtipocliente, tipocliente){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idtipocliente)
			break;
	opener.document.forms[i].idtipocliente.value = idtipocliente;
	opener.document.forms[i].tipocliente.value = tipocliente; 
	window.close();
}
 </script>
</head>
...
java.util.List crmtipocliente = new java.util.ArrayList();
crmtipocliente= BFFF.getCrmtiposclientesList();
iterCRMtipodeclientes = crmtipocliente.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_tiposclientes.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterCRMtipodeclientes.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterCRMtipodeclientes.next(); 
