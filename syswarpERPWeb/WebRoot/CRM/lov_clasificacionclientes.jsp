...
String color_fondo ="";
String titulo = "Clasificacion Cliente";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterClasificacionclientes   = null;
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanCrmclasificacionclientesAbm"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idclasificacioncliente, clasificacioncliente){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idclasificacioncliente)
			break;
	opener.document.forms[i].idclasificacioncliente.value = idclasificacioncliente;
	opener.document.forms[i].clasificacioncliente.value = clasificacioncliente; 
	window.close();
}
 </script>
</head>
...
tituCol[0] = "Codigo";
tituCol[1] = "Clasificacion cliente";

java.util.List clasificacioncliente = new java.util.ArrayList();
clasificacioncliente= BFFF.getCrmclasificacionclientesList();
iterClasificacionclientes = clasificacioncliente.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_clasificacionclientes.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterClasificacionclientes.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterClasificacionclientes.next(); 
