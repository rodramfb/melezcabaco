...
String color_fondo ="";
String titulo = "Gestion de cotizaciones";
...
%>
<html>
<jsp:useBean id="BCA"  class="ar.com.syswarp.web.ejb.BeanCrmcotizacionesAbm"   scope="page"/>
...
tituCol[8] = "V.Total";
tituCol[9] = "Contado";
tituCol[10] = "Financiado";  
tituCol[11] = "Individuo";
tituCol[12] = "emp";
tituCol[13] = "Id. Res.";  
...
<form action="crmcotizacionesAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
     ...
     <td width="10%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[10]%></td>
	      <td width="14%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[11]%></td>
          <td width="14%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[14]%>&nbsp;</td>
  </tr>
   <%int r = 0;
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="idcotizacion" value="<%= sCampos[0]%>"></td>
