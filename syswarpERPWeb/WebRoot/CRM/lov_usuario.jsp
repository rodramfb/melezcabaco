...
int i = 0;
Iterator iterGeneralusuario   = null;
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanGlobalusuariosLov"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idusuario, usuario){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idusuario)
			break;
	opener.document.forms[i].idusuario.value = idusuario;
	opener.document.forms[i].usuario.value = usuario; 
	window.close();
}
 </script>
</head>
...
generalusuario= BFFF.getGlobalusuarioList();
iterGeneralusuario = generalusuario.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_usuario.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterGeneralusuario.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterGeneralusuario.next(); 
