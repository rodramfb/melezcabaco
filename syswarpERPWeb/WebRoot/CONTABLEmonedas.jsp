...
String action = "CONTABLEmonedas.jsp";
String formulario = "frmCONTABLEmonedas.jsp";
...
String fechaalt   = "";
String fechaact   = "";
String ayudalink  = "ayuda.jsp?idayuda=8";   // link a las ayudas en linea de cada punto
  ...
  <tr >
     ...
     <table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>   >
      <tr class="fila-encabezado">
        ...
        <td width="6%"   onClick="javascript:sortTable(<%=totCol+1-4%>, rsTable);"><%=tituCol[1]%></td>
				<td width="18%"  onClick="javascript:sortTable(<%=totCol+1-4%>, rsTable);"><%=tituCol[2]%></td>
				<td width="18%"  onClick="javascript:sortTable(<%=totCol+1-4%>, rsTable);"><%=tituCol[3]%></td>
				<td width="18%"  onClick="javascript:sortTable(<%=totCol+1-4%>, rsTable);"><%=tituCol[4]%></td>
				<td width="28%"  onClick="javascript:sortTable(<%=totCol+1-4%>, rsTable);"><%=tituCol[5]%></td>
				<td width="7%"   onClick="javascript:sortTable(<%=totCol+1-4%>, rsTable);"><%=tituCol[6]%></td>		
		  </tr>
 <%int r = 0;
    while(iterMonedas.hasNext()){      
	 ...
	 if ( r >= posIni && r <= posFin ){
	    ...
	    String cmp_codigo = sCampos[0];
	           usuarioalt = sCampos[5] ;
	           usuarioact = sCampos[6] ;
	           fechaalt   = sCampos[7] ;
   	         fechaact   = sCampos[8] ;	 
