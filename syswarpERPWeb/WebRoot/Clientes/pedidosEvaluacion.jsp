...
String color_fondo ="";
String titulo = "EVALUACION DE PEDIDOS";
...
%>
<html>
<jsp:useBean id="BPCDA"  class="ar.com.syswarp.web.ejb.BeanPedidosEvaluacionAbm"   scope="page"/>
...
<form action="pedidosEvaluacion.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><div align="center"><%=Common.setNotNull(sCampos[0])%>&nbsp;</div></td>
      ...
      <td class="fila-det-border" >
       <div align="center">
       <% if(!Common.setNotNull(sCampos[0]).equals("")) {%>
            <img src="../imagenes/default/gnome_tango/mimetypes/gnome-mime-application-vnd.lotus-1-2-3.png" width="18" height="18" onClick="abrirVentana('pedidosHistoricoClienteDetalle.jsp?tipopedido=N&idpedido_cabe=<%=sCampos[0]%>&idcliente=<%=sCampos[3]%>&cliente=<%=sCampos[4]%>','detalle_pedido', 700, 400)" style="cursor:pointer" title="Detalle del Pedido">
      <% } else {%>
           <img src="../imagenes/default/gnome_tango/apps/gnome-session.png" title="Hist&oacute;rico de pedidos" width="18" height="18" onClick="ventana=abrirVentana('pedidosHistoricoCliente.jsp?cliente=<%= sCampos[4] %>&idcliente=<%= sCampos[3] %>', 'hist', 700, 400)" style="cursor:pointer">
      <% } %>
       </div>
      </td> 
      <td class="fila-det-border" ><div align="center"><img src="../imagenes/default/gnome_tango/apps/date.png" width="18" height="18" onClick="abrirVentana('../Clientes/clientesPeriodicidadEntregaFrm.jsp?idcliente=<%=sCampos[3]%>&accion=consulta', 'periodicidad', 700, 450)" style="cursor:pointer" title="Periodicidad del Socio"></div></td>
   </tr>
<%
   }%> 
   </table>
