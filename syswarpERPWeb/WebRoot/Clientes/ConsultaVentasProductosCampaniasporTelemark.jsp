...
<html>
	<%-- INSTANCIAR BEAN --%>
	<jsp:useBean id="BPF"
		class="ar.com.syswarp.web.ejb.BeanConsultaVentasProductosCampaniaporTelemark" scope="page" />
	<head>
		<title>Consulta Ventas por Productos y Campañas por Telemarketer</title>
	...
	<BODY>
		...
		<% 
 String titulo = "Consulta Ventas por Productos y Campañas por Telemarketer";
 ...
 BPF.setIdtelemark( session.getAttribute("usuario").toString() );
 ...
 %>
	<form action="ConsultaVentasProductosCampaniasporTelemark.jsp" method="post" name="frm">
...
<tr class="fila-det">
								<td width="17%" height="37" class="fila-det-border">Fecha Desde </td>
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable"   >
 ...
 <%}%>
   ...
   <% 
     if (Consulta2 != null && Consulta2.next()){ 
