...
<html>
	...
	<jsp:useBean id="BPFRE"
		class="ar.com.syswarp.web.ejb.BeanPedidosRegalos_cabeUpdate" scope="page" />
	<head>
	...
	<BODY >
		...
		<% 
 String titulo = "MODIFICACION DE PEDIDO DE REGALOS EMPRESARIOS NROº: " + BPFRE.getIdpedido_regalos_cabe();
...
function callInfoTransformacion(){
   ...
   mostrarMensaje('Solo corresponde seleccionar valor SI para Proceso de Transformación, cuando es un pedido padre. Si selecciona el valor NO, no necesariamente debe asignar Pedido Padre, si no selecciona ninguno el sistema asume que es Padre de si mismo.');
		...
		<form action="pedidosRegalosCabeUpdate.jsp" method="post" name="frm" onSubmit="setConfirmar()">
			...
			<%-- <input name="idestado" type="hidden" id="idestado" value="3"> --%>
			<input name="tipopedido" type="hidden"  value="R">
			<input name="idpedido_regalos_cabe" type="hidden" id="idpedido_regalos_cabe" value="<%=BPFRE.getIdpedido_regalos_cabe()%>"> 
				...
				<tr>
					<td>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<%-- <tr class="fila-det">
							  <td class="fila-det-border">R. Empresarios :(*) </td>
							  <td class="fila-det-border"><input name="tipopedido" type="radio" checked value="R" class="campo" < %= BPFRE.getTipopedido().equalsIgnoreCase("R") ? "checked" : "" % >></td>
                    ...
                    <tr>
                      ...
                      <td width="72%"><img src="../imagenes/default/gnome_tango/actions/filefind.png"
														width="18" height="18"
														onClick="ventana=abrirVentana('pedidosRegalosCliente.jsp?cliente=< %= BPFRE.getCliente() %>&idcliente=< %= BPFRE.getIdcliente() % >', 'hist', 800, 400)"
														style="cursor:pointer" ></td>
                    </tr> 
                  </table></td>
							</tr> --%>
							<tr class="fila-det">
							  <td height="27" class="fila-det-border">Cliente: (*)
							    <input name="idcliente" type="hidden" id="idcliente" 
													value="<%=BPFRE.getIdcliente()%>"  readonly maxlength="7">
                                  <input name="cliente" type="hidden" class="campo" id="cliente"
														value="<%=BPFRE.getCliente()%>"     ></td>
							  <td class="fila-det-border"><%=BPFRE.getCliente()%> </td>
							  <td valign="bottom" class="fila-det-border"><%-- if(BPFRE.getIdcampacabe().longValue()<0) {% ><img src="../imagenes/default/gnome_tango/actions/filefind.png"
														width="18" height="18"
  ...
  &nbsp;</td>
							  ...
							  <td class="fila-det-border"><table width="100%" border="0" cellspacing="0" cellpadding="0"> 
                                <tr class="fila-det">
                                  <td width="28%">
								  <%=Common.setNotNull(BPFRE.getIdpedido_regalos_padre())%>
								  <input name="idpedido_regalos_padre" type="hidden" class="campo" id="idpedido_regalos_padre"
														value="<%=Common.setNotNull(BPFRE.getIdpedido_regalos_padre())%>" size="10" readonly  style="text-align:right"></td>
                                  <td width="72%"><%-- <img src="../imagenes/default/gnome_tango/actions/filefind.png"
														width="18" height="18"
							...
							<tr class="fila-det">
							  ...
							  <td width="13%" valign="bottom" class="fila-det-border">
							   <table width="200" border="0" cellspacing="0" cellpadding="0">
                                  <tr class="fila-det">
                                    <td width="20%" > <%= BPFRE.getTransformacion().equalsIgnoreCase("S") ? "SI" : "NO" %><input name="transformacion" id="transformacion" type="hidden" value="<%= BPFRE.getTransformacion() %>">
                                        
                                    </td>
                                    <td width="80%" ><img src="../imagenes/default/gnome_tango/actions/stock_undo.png" width="18" height="18" onClick="callInfoTransformacion()" style="cursor:pointer"></td>
                                  </tr>
                              </table></td>
							  <td width="13%" valign="bottom" class="fila-det-border">&nbsp;</td>
								<td width="18%" class="fila-det-border">Fecha (*)</td>
                  ...
                  <option value="0">Seleccionar</option>
                    ...
                    <tr>
                      <td width="66%">
					  <select name="iddomicilio" id="iddomicilio" class="campo" style="width:200px" onChange="selectDomicilio(this);"  onFocus="indiceActualLista = this.selectedIndex " >
                        <option value="-1">Seleccionar</option>
                        <% 
                    ...
                    <%  
							  ...
							  <td width="23%" class="fila-det-border"><input name="telefonos" type="text" class="campo" id="telefonos" style="border-width:0px" value="<%= BPFRE.getTelefonos() %>" size="40" readonly ></td>
							</tr>
										...
										int indice = 0;
												if(htArticulosInOutOK != null && !htArticulosInOutOK.isEmpty()){													
													 ...
													 while(en.hasMoreElements()){
														 ...
														 */
														 // -->
														 // 20101203 - EJV - Por ser modificacion, mandan los datos recuperados, no la herencia por familia
														 boolean flagFirstLoad = Boolean.parseBoolean(art[33]);
														 //boolean flagFirstLoad = false;
														 art[33] = "false"; 
