...
String color_fondo ="";
String titulo = "Tipo Sucursales";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator itertiposucursal   = null;
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanClientesSucursalesLov"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idtiposucursal, tiposucursal){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idtiposucursal)
			break;
	opener.document.forms[i].idtiposucursal.value = idtiposucursal;
	opener.document.forms[i].tiposucursal.value = tiposucursal; 
	window.close();
}
 </script>
</head>
...
java.util.List tiposucursal = new java.util.ArrayList();
tiposucursal= BFFF.getClientessusursalesList();
itertiposucursal = tiposucursal.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_tiposucursal.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
     ...
     <td width="87%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[1]%></td>
   </tr>
   <%int r = 0;
   while(itertiposucursal.hasNext()){
      ++r;
      String[] sCampos = (String[]) itertiposucursal.next(); 
