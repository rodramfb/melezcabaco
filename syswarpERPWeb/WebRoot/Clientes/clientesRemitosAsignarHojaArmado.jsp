                            ...
                            <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td>
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                       <tr class="text-globales">
                                         <td width="19%" height="44"><div align="center" id="consolida">
                                         ...
                                         <td width="26%">&nbsp;Total de registros:&nbsp;<%=BPA.getTotalRegistros() + ""%></td>
                                         <td width="13%" >Visualizar:</td>
                                         <td width="15%">
                                            <select name="limit" >
                                               <%for(i=350; i<= 3500 ; i+=350){%>
                                                   <%if(i==BPA.getLimit()){%>
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  ...
  <tr class="text-globales"> 
    <td colspan="10" >Imprimir Hoja de Armado Generada: <img src="../imagenes/default/gnome_tango/apps/pdf.jpg" border="0" style="cursor:pointer" onClick="abrirVentana('remitos/<%= BPA.getNameFile() %>', 'remitoscliente', 750, 500);">&nbsp;</td>
  </tr>
  <%
   }%>
  <tr class="text-globales">
   ...
   while(iterPedidos_cabe.hasNext()){
      ...
      if(!grupoArmado.equals(sCampos[22])){
        ...
        grupoArmado = sCampos[22]; 
		 ...
		 %>
	<tr height="3px" >
     <td colspan="10" bgcolor="<%= colorGrupo %>"  class="fila-det-border" height="3px" ></td>
    </tr>
		 <% 
...
%>
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" >
     <td rowspan="2" bgcolor="<%= colorGrupo %>"  class="fila-det-border" ><div align="center" onMouseOver="mostrarMensaje('<%= grupoArmado %>')">&nbsp;</div></td> 
      ...
      <td width="2%" rowspan="2" class="fila-det-border" ><div align="center">
          <input name="idremitocliente" type="checkbox" id="idremitocliente" value="<%=sCampos[0]%>">
      </div></td>
      <td width="4%" rowspan="2" class="fila-det-border" ><img src="<%=Common.setNotNull(sCampos[26])%>" title="<%=Common.setNotNull(sCampos[25])%>"></td>
   </tr>
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" >
