...
<html>
	<%-- INSTANCIAR BEAN --%>
	<jsp:useBean id="BPF"
		class="ar.com.syswarp.web.ejb.BeanConsultaVentasProductosCampania" scope="page" />
	<head>
	...
	<BODY>
		...
		<% 
 String titulo = "Consulta Ventas por Productos y Campañas";
 ...
 %>
	<form action="ConsultaVentasProductosCampanias.jsp" method="post" name="frm">
