...
/* 
   Grilla para la entidad: sasmotivoscontactos
...
String color_fondo ="";
String titulo = "SAS - MOTIVOS DE CONTACTOS";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterSasmotivoscontactos   = null;
...
%>
<html>
<jsp:useBean id="BSA"  class="ar.com.syswarp.web.ejb.BeanSasmotivoscontactosAbm"   scope="page"/>
...
tituCol[0] = "Cód.";
tituCol[1] = "Motivo del contacto";
tituCol[2] = "Tipo de contacto";
tituCol[3] = "Canal de contacto";
java.util.List Sasmotivoscontactos = new java.util.ArrayList();
Sasmotivoscontactos= BSA.getSasmotivoscontactosList();
iterSasmotivoscontactos = Sasmotivoscontactos.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="sasmotivoscontactosAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
     ...
     <td width="27%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[2]%></td>
   ...
   <%int r = 0;
   while(iterSasmotivoscontactos.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterSasmotivoscontactos.next(); 
      // estos campos hay que setearlos segun la grilla 
      if (color_fondo.equals("fila-det-verde")) color_fondo = "fila-det";
      else color_fondo = "fila-det-verde";%>
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="idmotivocontacto" value="<%= sCampos[0]%>"></td>
