...
<html>
	<%-- INSTANCIAR BEAN --%>
	<jsp:useBean id="BPF"
		class="ar.com.syswarp.web.ejb.BeanConsultaPedidosPendientesRevisar" scope="page" />
	<head>
	...
	<BODY>
		...
		<% 
 String titulo = "Consulta Pedidos Pendientes de Revisar";
 ...
 %>
		<form action="ConsultaPedidospendientesrevisar.jsp" method="post" name="frm">
...
<tr class="fila-det">
								<td width="13%" height="40" class="fila-det-border">
									Fecha Desde(*) </td>
								<td width="25%" class="fila-det-border"><table width="48%" border="0" cellpadding="0" cellspacing="0">
                                  <tr class="fila-det-border">
                                    <td width="34%"><input name="fechadesde" type="text" class="cal-TextBox"
													id="fechadesde" onFocus="this.blur()"
													value="<%=BPF.getFechadesde() %>" size="12"
													maxlength="12" readonly>                                    </td>
                                    <td width="66%"><a class="so-BtnLink"
								...
								<td width="13%" class="fila-det-border">Fecha Hasta(*) </td>
								<td width="49%" class="fila-det-border"><table width="22%" border="0" cellpadding="0" cellspacing="0">
                                  <tr class="fila-det-border">
						    ...
						    <td width="13%" height="34" class="fila-det-border">Estado(*)
					        <input name="idestado" type="hidden" id="idestado" value="<%=BPF.getIdestado()%>"></td>
						    <td width="25%" class="fila-det-border"><table width="23%" border="0" cellpadding="0" cellspacing="0">
                              <tr class="fila-det-border">
                                <td width="61%" ><input name="estado" type="text" class="campo" id="estado" value="<%=str.esNulo(BPF.getEstado())%>" size="25" readonly></td>
		                  ...
		                  <tr class="fila-det">
		                    <td height="38" class="fila-det-border">Tipo Cliente(*)	                        
	                        <input name="idtipoclie" type="hidden" id="idtipoclie" value="<%=BPF.getIdtipoclie()%>"></td>
		                    <td class="fila-det-border"><table width="23%" border="0" cellpadding="0" cellspacing="0">
                              <tr class="fila-det-border">
                                <td width="61%" ><input name="tipoclie" type="text" class="campo" id="tipoclie" value="<%=str.esNulo(BPF.getTipoclie())%>" size="25" readonly></td>
  ...
  <tr class="fila-encabezado">
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" >
     <td height="22" class="fila-det-border" >&nbsp;<%=sCampos[0]%></td>
      <td width="20%" class="fila-det-border" ><%=sCampos[1]%></td>
	  <td width="39%" class="fila-det-border" ><%=sCampos[2]%></td>
      <td width="14%" class="fila-det-border" ><%=sCampos[3]%></td>
      <td width="5%" class="fila-det-border" ><img src="../imagenes/default/gnome_tango/apps/gnome-session.png" title="Hist&oacute;rico de pedidos" width="18" height="18" onClick="ventana=abrirVentana('pedidosHistoricoCliente.jsp?idcliente=<%= sCampos[3] %>', 'hist', 700, 400)" style="cursor:pointer"></td>
      <td width="8%" class="fila-det-border" ><img src="../imagenes/default/gnome_tango/apps/date.png" width="18" height="18" onClick="abrirVentana('../Clientes/clientesPeriodicidadEntregaFrm.jsp?idcliente=<%=sCampos[3]%>&accion=consulta', 'periodicidad', 700, 450)" style="cursor:pointer" title="Periodicidad del Socio"></td>
  </tr>
<%
   }%>
   </table>
...
<table width="100%" border="1" cellspacing="1" cellpadding="1" name="rsTable"   >
  <tr class="fila-encabezado">
    <td width="20%">Total Registros </td>
    <td width="80%"><%=r%></td>
  </tr>
</table>
<p>&nbsp;  </p>
