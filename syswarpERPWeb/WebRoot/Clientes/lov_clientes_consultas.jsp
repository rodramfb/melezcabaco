...
/* 
   ...
   Fecha de creacion: Fri Nov 10 09:31:04 GMT-03:00 2006 
   Observaciones: 
...
String color_fondo ="";
String titulo = "Ayuda de Clientes";
...
function passBack(idcliente, cliente) {
  var i = 0;
   for(i=0;i<10;i++) if(opener.document.forms[i].idcliente) break;    
...
<form action="lov_clientes_consultas.jsp" method="POST" name="frm">
