...
int i = 0;
Iterator iterclientesprovincias   = null;
...
%>
<html>
<jsp:useBean id="BGLA"  class="ar.com.syswarp.web.ejb.BeanClientesProvinciaLov"   scope="page"/>
...
function bajarDatos(idprovincia, d_idprovincia){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idprovincia)
			break;
	opener.document.forms[i].idprovincia.value = idprovincia;
	if(opener.document.forms[i].d_idprovincia) opener.document.forms[i].d_idprovincia.value = d_idprovincia;
  if(opener.document.forms[i].provincia) opener.document.forms[i].provincia.value = d_idprovincia; 
	window.close();
...
java.util.List clientesprovincias = new java.util.ArrayList();
clientesprovincias = BGLA.getClientesprovinciaList();
iterclientesprovincias = clientesprovincias.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_provincia.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterclientesprovincias.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterclientesprovincias.next(); 
