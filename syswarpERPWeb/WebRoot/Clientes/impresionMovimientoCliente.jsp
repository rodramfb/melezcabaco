...
String nrointernomovcliente = request.getParameter("nrointernomovcliente");
String tipo = request.getParameter("tipo");
String plantillaImpresionJRXML = request.getParameter("plantillaImpresionJRXML");
String titulo = "Comprobantes de Movimientos de Clientes";
...
<form action="" method="POST" name="frm">
  ...
  <% 
   String link = "../reportes/jasper/generaPDF.jsp?nrointerno=" + nrointernomovcliente + "&plantillaImpresionJRXML=" + plantillaImpresionJRXML + "&idempresa=" + idempresa ;   
    %>
  <tr class="fila-det" >
    <td class="fila-det-border" >&nbsp;<a href="javascript:abrirVentana('<%= link %>', '', 800, 600)"></a></td>
