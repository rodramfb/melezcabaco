...
<div id="popupcalendar" class="text"></div>
 ...
 %>
<form action="clientetarjetascreditoFrm2.jsp" method="post" name="frm">
              ...
              <tr class="fila-det">
                ...
                <td width="83%" class="fila-det-border"><table width="23%" border="0">
                  <tr class="fila-det-border">
                    ...
                    <td width="39%"><img src="../imagenes/default/gnome_tango/actions/filefind.png" width="22" height="22" onClick="abrirVentana('../Clientes/lov_clientes2.jsp', 'cliente', 700, 400)" style="cursor:pointer"></td>
