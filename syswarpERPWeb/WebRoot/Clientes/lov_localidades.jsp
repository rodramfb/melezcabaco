...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idlocalidad, localidad, idprovincia, provincia, cp){
	for(var i = 0; i<10;i++)
...
//--M733EJV20110722  
  if(opener.document.forms[i].cpostal) {
    opener.document.forms[i].cpostal.value = cp;
  }
...
<form action="lov_localidades.jsp" method="POST" name="frm">
