...
%>
<html>
<jsp:useBean id="BPAA"  class="ar.com.syswarp.web.ejb.BeanLovArticulosListaPreciosPedidos"   scope="page"/>
...
<form action="lovArticulosListaPreciosPedidos.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
     ...
     <td width="26%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><%=tituCol[13]%></td>
     <td width="9%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><div align="right"><%=tituCol[14]%></div></td>
     <td width="4%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><div align="right"><%=tituCol[15]%></div></td>
     <td width="4%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><div align="right"><%=tituCol[4]%>&nbsp;</div></td>
     <td width="2%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><div align="right"><%=tituCol[5]%>&nbsp;</div></td>
     <td width="12%" onClick="javascript:sortTable(<%=totCol-4%>, rsTable);"><div align="right">Final&nbsp;</div></td>
   ...
   while(iterProveedoArticulos.hasNext()){
	  ...
	  String datosCatalogo = "PUNTAJE: " + sCampos[17] + " - COMPROMETIDO: " + sCampos[18]+ " - UTILIZADO: " + sCampos[19];
	  %>
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      ...
      <td class="fila-det-border" title="<%=sCampos[2]%>"><%=sCampos[3]%>&nbsp;</td>
      ...
      <td class="fila-det-border" ><% if(BPAA.getIdlista().intValue() == 17){ %><img src="../imagenes/default/gnome_tango/colors.orange.icon.gif" width="10" height="10"  title="  <%= datosCatalogo %>"  %><% } else out.write("&nbsp;"); %></td>
   </tr>
<%
   }%> 
  </table>
