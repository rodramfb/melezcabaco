...
<html>
	<%-- INSTANCIAR BEAN --%>
	<jsp:useBean id="BPF"
		class="ar.com.syswarp.web.ejb.BeanConsultaCumpleanioProspecto" scope="page" />
	<head>
	...
	<BODY>
		...
		<% 
 String titulo = "Consulta Cumpleaños";
 ...
 %>
		<form action="ConsultaCumpleanioProspecto.jsp" method="post" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable"   >
  <tr class="fila-encabezado">
	 ...
	 <td><div align="center">Fecha de Nacimento</div></td>
  </tr> 
   <%int r = 0;
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" >
     <td height="22" class="fila-det-border" >&nbsp;<%=sCampos[0]%></td>
	  ...
	  <td width="38%" class="fila-det-border" ><%=Common.setObjectToStrOrTime(java.sql.Timestamp.valueOf(sCampos[2]), "JSTsToStr")%></td>
     </tr>
<%
   }%>
   </table>
