...
String color_fondo ="";
String titulo = "Tarjeta de Credito";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterClientestarjetacredito   = null;
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanClientesTarjetasMarcasLov"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idtarjetacredito, tarjetacredito){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idtarjetacredito)
			break;
...
tituCol[0] = "Codigo";
tituCol[1] = "tarjetacredito";

java.util.List clientestarjetacredito = new java.util.ArrayList();
clientestarjetacredito= BFFF.getClientestarjetasmarcasList();
iterClientestarjetacredito = clientestarjetacredito.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_tarjetamarcas.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterClientestarjetacredito.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterClientestarjetacredito.next(); 
