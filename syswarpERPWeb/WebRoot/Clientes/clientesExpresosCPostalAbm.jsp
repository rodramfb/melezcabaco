...
String color_fondo ="";
String titulo = "CONSULTA CLIENTES - EXPRESOS POR CODIGO POSTAL";
...
%>
<html>
<jsp:useBean id="BCECPA"  class="ar.com.syswarp.web.ejb.BeanClientesExpresosCPostalAbm"   scope="page"/>
...
<form action="clientesExpresosCPostalAbm.jsp" method="POST" name="frm">
                  ...
                  <td width="5%" height="38">&nbsp;</td>
                   <td width="95%">
                      <table width="100%" border="0">
                         <tr>
                           <td width="9%" height="26" class="text-globales">Buscar CP </td>
                           <td width="22%" class="text-globales"><input name="cpostal" type="text" value="<%=BCECPA.getCpostal()%>" id="cpostal" size="20" maxlength="30"></td>
                           <td width="69%">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" >
     ...
     <td colspan="5" class="fila-det-border" ><%=sCampos[12]%>&nbsp;</td>
    </tr>
<%
   }%>
   </table>
