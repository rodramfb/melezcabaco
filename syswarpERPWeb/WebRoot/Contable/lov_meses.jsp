...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanGlobalMesesLov"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(mes, des_mes){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].mes)
			break;
	opener.document.forms[i].mes.value = mes;
	opener.document.forms[i].des_mes.value = des_mes;
	window.close();
}
 </script>
</head>
...
java.util.List globalmeses = new java.util.ArrayList();
globalmeses= BFFF.getGlobalMesesList();
iterGlobalmeses = globalmeses.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_meses.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterGlobalmeses.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterGlobalmeses.next(); 
