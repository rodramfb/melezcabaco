...
/* 
   Grilla para la entidad: contablerubieuso
...
String color_fondo ="";
String titulo = "Rubros Bienes de Uso";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterContablerubieuso   = null;
...
%>
<html>
<jsp:useBean id="BCA"  class="ar.com.syswarp.web.ejb.BeanContablerubieusoAbm"   scope="page"/>
...
tituCol[1] = "Rubro";
tituCol[2] = "Años";
java.util.List Contablerubieuso = new java.util.ArrayList();
Contablerubieuso= BCA.getContablerubieusoList();
iterContablerubieuso = Contablerubieuso.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="contablerubieusoAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterContablerubieuso.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterContablerubieuso.next(); 
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-bold-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="idrubro" value="<%= sCampos[0]%>"></td>
