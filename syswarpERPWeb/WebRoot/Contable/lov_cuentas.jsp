...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanContableCuentasLov"   scope="page"/>
...
<%
 ...
 if(mes!=null){
  ...
  BFFF.setMes(new BigDecimal(mes));
 */
 BFFF.setIdejercicio( new BigDecimal( session.getAttribute("ejercicioActivo").toString() ));
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(cuenta_pl, d_cuenta_pl){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].cuenta_pl)
			break;
	opener.document.forms[i].cuenta_pl.value = cuenta_pl;
	opener.document.forms[i].d_cuenta_pl.value = d_cuenta_pl;
	window.close();
}
 </script>
</head>
...
java.util.List cuenta = new java.util.ArrayList();
cuenta= BFFF.getCuentasList();
iterCuentas = cuenta.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_cuentas.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
	  ...
	  <img src="../imagenes/default/audit.gif" width="21" height="17" onClick="bajarDatos('<%=sCampos[0]%>', '<%=sCampos[1]%>' )"<% } %> ></td>
