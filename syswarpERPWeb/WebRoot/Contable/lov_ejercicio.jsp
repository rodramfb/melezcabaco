...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(ejerciciodesde,d_ejerciciodesde){
	for(var i = 0; i<10;i++){
		if(opener.document.forms[i].ejerciciodesde){
			opener.document.forms[i].ejerciciodesde.value = ejerciciodesde;
			opener.document.forms[i].d_ejerciciodesde.value = d_ejerciciodesde; 
			break;
    } 
		if(opener.document.forms[i].ejercicioOrigen){
			opener.document.forms[i].ejercicioOrigen.value = ejerciciodesde;
			opener.document.forms[i].d_ejerciciodesde.value = d_ejerciciodesde; 
			break;
    } 
	}
...
<form action="lov_ejercicio.jsp" method="POST" name="frm">
