...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(legajo){
	
	var nroquincena = 1;
	
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].hastaLegajo)
			break;
	opener.document.forms[i].hastaLegajo.value = legajo; 
	window.close();
}
 </script>
</head>
...
<form action="lov_personal_hasta.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><img src="../imagenes/default/audit.gif" width="21" height="17" onClick="bajarDatos('<%=sCampos[0]%>')"></td>
