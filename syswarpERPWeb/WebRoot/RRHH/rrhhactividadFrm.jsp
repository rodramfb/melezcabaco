...
<html>
<%-- INSTANCIAR BEAN --%>  
<jsp:useBean id="BRF"  class="ar.com.syswarp.web.ejb.BeanRrhhactividadFrm"   scope="page"/>
<head>
 <title>FRMRrhhactividad.jsp</title>
...
<div id="popupcalendar" class="text"></div>
 ...
 <% 
 String titulo = BRF.getAccion().toUpperCase() + " DE Actividades" ;
 ...
 %>
<form action="rrhhactividadFrm.jsp" method="post" name="frm">
<input name="accion" type="hidden" value="<%=BRF.getAccion()%>" >
<input name="idactividad" type="hidden" value="<%=BRF.getIdactividad()%>" >
       ...
       <td>
         <table width="100%"  border="0" cellspacing="0" cellpadding="0" align="center">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
              ...
              <tr class="fila-det">
                <td width="12%" class="fila-det-border">Actividad: (*) </td>
                <td width="88%" class="fila-det-border"><input name="actividad" type="text" value="<%=BRF.getActividad()%>" class="campo" size="50" maxlength="50"  ></td>
              </tr>
              <tr class="fila-det">
                <td class="fila-det-border">&nbsp;</td>
