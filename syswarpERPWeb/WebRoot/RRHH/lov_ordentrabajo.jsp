...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanRrhhordentrabajoLov"   scope="page"/>
...
ordentrabajo= BFFF.getestadosotList();
iterordentrabajo = ordentrabajo.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_ordentrabajo.jsp" method="POST" name="frm">
