...
String color_fondo ="";
String titulo = "Modalidad de Contrato";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator itermodalidadcontrato   = null;
...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanRrhhmodalidadcontratoAbm"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idmodalidadcontrato, modalidadcontrato){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idmodalidadcontrato)
			break;
	opener.document.forms[i].idmodalidadcontrato.value = idmodalidadcontrato;
	opener.document.forms[i].modalidadcontrato.value = modalidadcontrato; 
	window.close();
}
 </script>
</head>
...
java.util.List modalidadcontrato = new java.util.ArrayList();
modalidadcontrato= BFFF.getrrhhmodalidadcontratoList();
itermodalidadcontrato = modalidadcontrato.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_modalidadcontrato.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(itermodalidadcontrato.hasNext()){
      ++r;
      String[] sCampos = (String[]) itermodalidadcontrato.next(); 
