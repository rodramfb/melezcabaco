...
/* 
   Grilla para la entidad: rrhhformulas
...
String color_fondo ="";
String titulo = "Recursos Humanos: Fórmulas para cálculos";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterRrhhformulas   = null;
...
%>
<html>
<jsp:useBean id="BRA"  class="ar.com.syswarp.web.ejb.BeanRrhhformulasAbm"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(formula){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].formula)
			break;
	opener.document.forms[i].formula.value += " "+formula;
	window.close();
}
 </script>
</head>
...
tituCol[3] = "Sql";
tituCol[4] = "idempresa";
java.util.List Rrhhformulas = new java.util.ArrayList();
Rrhhformulas= BRA.getRrhhformulasList();
iterRrhhformulas = Rrhhformulas.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_formula.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterRrhhformulas.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterRrhhformulas.next(); 
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><img src="../imagenes/default/audit.gif" width="21" height="17" onClick="bajarDatos('<%=sCampos[1]%>' )"></td>
