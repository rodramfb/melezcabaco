...
%>
<html>
<jsp:useBean id="BFFF"  class="ar.com.syswarp.web.ejb.BeanRrhhartAbm"   scope="page"/>
...
<title><%=titulo%></title>
 ...
 <script >
function bajarDatos(idart, art){
	for(var i = 0; i<10;i++)
		if(opener.document.forms[i].idart)
			break;
	opener.document.forms[i].idart.value = idart;
	opener.document.forms[i].art.value = art; 
	window.close();
}
 </script>
</head>
...
generalusuario= BFFF.getRrhhartList();
iterafjp = generalusuario.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="lov_art.jsp" method="POST" name="frm">
