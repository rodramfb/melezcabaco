...
/* 
   Grilla para la entidad: rrhhestadosempleado
...
String color_fondo ="";
String titulo = "RRHHESTADOSEMPLEADO";
// variables de entorno
String pathskin = session.getAttribute("pathskin").toString();
String pathscript = session.getAttribute("pathscript").toString();
// variables de paginacion
int i = 0;
Iterator iterRrhhestadosempleado   = null;
...
%>
<html>
<jsp:useBean id=""  class="ar.com.syswarp.web.ejb.BeanRrhhestadosempleado"   scope="page"/>
...
tituCol[0] = "idestadoempleado";
tituCol[1] = "legajo";
tituCol[2] = "apellido";
tituCol[3] = "esempleado";
tituCol[4] = "idmotivo";
tituCol[5] = "idrazon";
tituCol[6] = "observacion";
tituCol[7] = "fecha";
java.util.List Rrhhestadosempleado = new java.util.ArrayList();
Rrhhestadosempleado= BRA.getRrhhestadosempleadoList();
iterRrhhestadosempleado = Rrhhestadosempleado.iterator();
%>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
<form action="rrhhestadosempleadoAbm.jsp" method="POST" name="frm">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" name="rsTable" id=rsTable cols=<%=totCol+2-4%>  >
  <tr class="fila-encabezado">
   ...
   <%int r = 0;
   while(iterRrhhestadosempleado.hasNext()){
      ++r;
      String[] sCampos = (String[]) iterRrhhestadosempleado.next(); 
      // estos campos hay que setearlos segun la grilla 
      if (color_fondo.equals("fila-det-verde")) color_fondo = "fila-det";
      else color_fondo = "fila-det-verde";%>
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><input type="radio" name="idestadoempleado" value="<%= sCampos[0]%>"></td>
