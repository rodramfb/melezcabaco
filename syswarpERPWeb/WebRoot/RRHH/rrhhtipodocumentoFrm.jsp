...
/* 
   Formulario de carga para la entidad: rrhhtipodocumento
   Copyrigth(r) sysWarp S.R.L. 
   Fecha de creacion: Thu Apr 26 15:01:23 GMT-03:00 2007 
   Observaciones: 
...
<html>
<%-- INSTANCIAR BEAN --%>  
<jsp:useBean id="BRF"  class="ar.com.syswarp.web.ejb.BeanRrhhtipodocumentoFrm"   scope="page"/>
<head>
 <title>FRMRrhhtipodocumento.jsp</title>
...
<div id="popupcalendar" class="text"></div>
 ...
 <% 
 String titulo = BRF.getAccion().toUpperCase() + " DE Tipo Documento" ;
 ...
 %>
<form action="rrhhtipodocumentoFrm.jsp" method="post" name="frm">
<input name="accion" type="hidden" value="<%=BRF.getAccion()%>" >
<input name="idtipodocumento" type="hidden" value="<%=BRF.getIdtipodocumento()%>" >
       ...
       <td>
         <table width="100%"  border="0" cellspacing="0" cellpadding="0" align="center">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
              ...
              <tr class="fila-det">
                <td width="17%" class="fila-det-border">&nbsp;Tipo documento: (*) </td>
                <td width="83%" class="fila-det-border"><input name="tipodocumento" type="text" value="<%=BRF.getTipodocumento()%>" class="campo" size="50" maxlength="50"  ></td>
              </tr>
              <tr class="fila-det">
                <td class="fila-det-border">&nbsp;</td>
