...
%>
<html>
<jsp:useBean id="BCIA"  class="ar.com.syswarp.web.ejb.BeanLovCajaIdentificadoresSalidaOtrosMov" scope="page"/>
...
<form action="lov_cajaIdentificadoresSalidaOtrosMov.jsp" method="POST" name="frm">
  ...
  <tr class="fila-encabezado">
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><div align="center">
			<%if( (sCampos[6].equalsIgnoreCase("C") && 
			       sCampos[7].equalsIgnoreCase("N")
            ) 
            || 
            (sCampos[6].equalsIgnoreCase("D") && 
			       sCampos[7].equalsIgnoreCase("N")
            )
            || 
            (sCampos[6].equalsIgnoreCase("S"))          
          ){  %>
...
&nbsp;
  ...
  Hashtable htIdentificadoresContrapartida = (Hashtable) session.getAttribute("htIdentificadoresContrapartida");
  Hashtable htMovimientosCancelarOK = (Hashtable) session.getAttribute("htMovimientosCancelarOK");
	if((htIdentificadoresContrapartida != null && !htIdentificadoresContrapartida.isEmpty() ) 
	   || 
				...
				if(htIdentificadoresContrapartida != null && !htIdentificadoresContrapartida.isEmpty() ){		 
	   			en = htIdentificadoresContrapartida.keys();
					...
					while (en.hasMoreElements()) {
						...
						String [] identificador = (String []) htIdentificadoresContrapartida.get(key);
        	  //for(int m=0;m<identificador.length;m++) System.out.println("~ü-> identificador[" + m + "]: " + identificador[ m ]); 
						  %>
     <tr class="fila-det">
     ...
     <tr class="permiso-cuatro" >
       <td height="3" class="fila-det-border" colspan="20">
		...
		while (en.hasMoreElements()) {
   	  ...
   	  // for(int m=0;m<movimientos.length;m++) System.out.println("~¦~> movimientos[" + m + "]: " + movimientos[ m ]); 
						  %>
     <tr class="fila-det">
       <td height="22" class="fila-det-border">
         <input name="delKey" type="checkbox" id="delKey" value="<%= key %>" class="campo">
       ...
       <td class="fila-det-border"> <%= key %>
           <input  name="keyHashDatosIdentificador" type="hidden" value="<%= key %>"></td>
       <td class="fila-det-border">
				 <input name="cc1" type="text" value="<%= movimientos[20] %>" class="campo" id="cc1" size="5" maxlength="10" readonly></td>
       <td class="fila-det-border">
				 <input name="cc2" type="text" value="<%= movimientos[21] %>" class="campo" id="cc2" size="5" maxlength="10" readonly></td>
       <td class="fila-det-border">
