...
try
    ...
    String color_fondo = "";
    String titulo      = "PAGOS A PROVEEDORES";
...
%>
    ...
    <html>
        <jsp:useBean id = "BVCA" class = "ar.com.syswarp.web.ejb.BeanCajaPagosAbm" scope = "page"/>
    ...
    %>
        ...
        <body leftmargin = "0" topmargin = "0" marginwidth = "0" marginheight = "0">
            ...
            <form action = "CajaPagosAbm.jsp" method = "POST" name = "frm">
                ...
                <table width = "100%" border = "0" cellspacing = "0" cellpadding = "0">
                    <tr>
                      <td class = "fila-det-bold-rojo">
                            <jsp:getProperty name = "BVCA" property = "mensaje"/>  <% if(!BVCA.getNrointerno().equals("")) {%><img src="../imagenes/default/gnome_tango/apps/pdf.jpg" width="20" height="20" onClick="abrirVentana('../reportes/jasper/generaPDF.jsp?nrointerno=<%= BVCA.getNrointerno() %>&totalAdelanto=<%= BVCA.getTotalAdelanto() %>&plantillaImpresionJRXML=caja_pagos_frame', 'pagos', '750', '450');" style="cursor:pointer"><% } %></td>
                    </tr>
                </table>
                        ...
                        <td>
                            <table width = "100%" border = "0" align = "center" cellpadding = "0"
                                ...
                                <tr class = "text-globales">
                                    ...
                                    <td width = "91%">
                                    <%
                                        if (( htComprobantesProvOK == null || htComprobantesProvOK.isEmpty() ) &&  BVCA.getIdproveedor() == null)
                                            {
                                    %>
                                ...
                                <tr>
                                    <td width = "9%"
                                        class = "fila-titulo-dos"><input name = "idproveedor"
                                                                         ...
                                                                         id = "idproveedor"
                                                                         size = "10"
                                                                         value = "<%= str.esNulo(BVCA.getIdproveedor() + "") %>"></td>
                    ...
                    <tr>
                        <td>
                            <table width = "100%" border = "0" align = "center" cellpadding = "0"
                                ...
                                <tr class = "text-globales">
                                    <td width = "22%" class = "fila-titulo-dos">Comprobantes a Aplicar
                                    </td>
                                    ...
                                    <td width = "78%" class = "fila-titulo-dos">
                                        ...
                                        <input name = "btncomprobantes"
                                               ...
                                               id = "btncomprobantes"
                                               style = "cursor:pointer"
                                               onClick = "abrirVentana('lov_proveedoresMovProvAbm.jsp?idproveedor=' + document.frm.idproveedor.value + '&proveedor=' + document.frm.proveedor.value, 'buscar', 800, 400)"
                                               value = ">>"></td>
                                </tr>
                                ...
                                <tr>
                                    <td colspan = "2" class = "fila-titulo-dos">
                                        ...
                                        <%
                                            if (htComprobantesProvOK != null
                                                    && !htComprobantesProvOK.isEmpty())
                                                {
                                                ...
                                                while (en.hasMoreElements())
                                                    ...
                                                    String [] comprobantes =
                                                                  (String [])htComprobantesProvOK.get(key);
                                        ...
                                        %>
                                                    ...
                                                    <tr class = "fila-det">
                                                        ...
                                                        <td width = "25%" class = "fila-det-border">
                                                            <%= !key.equalsIgnoreCase("adelanto") ? Common.strZero(comprobantes[4], 4 ) + " - "  + Common.strZero(comprobantes[5], 8) : comprobantes[0] %>&nbsp;</td>
