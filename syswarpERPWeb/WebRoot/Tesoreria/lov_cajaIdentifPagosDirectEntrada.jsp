...
%>
<html>
<jsp:useBean id="BCIA"  class="ar.com.syswarp.web.ejb.BeanLovCajaIdentifPagosDirectEntrada"   scope="page"/>
...
<form action="lov_cajaIdentifPagosDirectEntrada.jsp" method="POST" name="frm">
  ...
  <tr class="fila-encabezado">
   ...
   <tr onMouseOver="mOvr(this,this.className='fila-det-rojo');" onMouseOut="mOut(this,this.className='<%=color_fondo%>');" class="<%=color_fondo%>" scope="col" > 
      <td class="fila-det-border" ><div align="center">
			<%if(
            (sCampos[6].equalsIgnoreCase("T") && sCampos[7].equalsIgnoreCase("S") ) ||
						(sCampos[6].equalsIgnoreCase("D") && sCampos[7].equalsIgnoreCase("S") ) 	 		
					){  
					 
					String tipcart_mt = "";
					
					if(sCampos[6].equalsIgnoreCase("T")) tipcart_mt = "J";
					else if(sCampos[6].equalsIgnoreCase("D")) tipcart_mt = "M";
					else tipcart_mt = sCampos[6];
					%>
					 <img src="../imagenes/default/gnome_tango/actions/edit-find.png" width="18" height="18" title="<%=sCampos[1].replace ('.', ' ')%> a cancelar." onClick="abrirVentana('lov_cajaMovimientosCancelarPagosEntrada.jsp?tipcart_mt=<%= tipcart_mt %>&cartera_mt=<%= sCampos[2] %>&cartera=<%= sCampos[1] %>', 'buscarmov', 700, 350)"> 
...
&nbsp;
  ...
  Hashtable htIdentificaEntradaPagosDirect = (Hashtable) session.getAttribute("htIdentificaEntradaPagosDirect");
  Hashtable htMovimientosEntradaCancelarOK = (Hashtable) session.getAttribute("htMovimientosEntradaCancelarOK");
	if((htIdentificaEntradaPagosDirect != null && !htIdentificaEntradaPagosDirect.isEmpty() ) 
	   || 
     (htMovimientosEntradaCancelarOK != null && !htMovimientosEntradaCancelarOK.isEmpty() )		  
		){ %>
   <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="1">
     <tr class="text-globales">

       <td width="4%" height="20">Sel</td>
       <td width="6%"><div align="center">Ide</div></td>
       <td width="8%"><div align="center">N&uacute;mero</div></td>  
       <td width="25%"><div align="center">Detalle</div></td>
       <td width="35%">Cuentas. </td>
       <td width="6%">Fecha</td>
       <td width="5%"><div align="center">Cuotas</div></td>
       <td width="6%"><div align="justify">Importe</div></td>
       <td width="5%">Clearing</td>
     </tr>
     <%
				...
				if(htIdentificaEntradaPagosDirect != null && !htIdentificaEntradaPagosDirect.isEmpty() ){		 
	   			en = htIdentificaEntradaPagosDirect.keys();
					...
					while (en.hasMoreElements()) {
						...
						String [] identificador = (String []) htIdentificaEntradaPagosDirect.get(key);
     ...
     <tr class="fila-det">
       ...
       <td class="fila-det-border"> <%= identificador[2] %>
         <input name="cc2" type="hidden" value="<%= identificador[21] %>" class="campo" id="cc2" size="5" maxlength="10" <%= !str.esNulo(identificador[23]).equalsIgnoreCase("S") ? "readonly" :  "" %>>
         ...
         <input  name="keyHashDatosIdentificador" type="hidden" id="keyHashDatosIdentificador" value="<%= key %>"></td>
       ...
       <td valign="middle" class="fila-det-border">
         ...
         <% } else out.write("&nbsp;");%>         </td><td class="fila-det-border"><input name="fecha" type="text" value="<%= identificador[31] %>" class="campo" id="fecha" size="10" maxlength="10" <%= str.esNulo( identificador[6] ).equalsIgnoreCase("C") ? "": "readonly"%> title="Formato: dd/mm/yyyy "></td>
       <td class="fila-det-border"><div align="center">
       ...
       <td class="fila-det-border"><div align="justify">
         <input name="importeingreso" type="text" value="<%= identificador[28] %>" class="campo" size="10" maxlength="15">
       </div></td>
       <td class="fila-det-border">
 ...
 <% 
	...
	if(htMovimientosEntradaCancelarOK != null && !htMovimientosEntradaCancelarOK.isEmpty()){
	    %>
     <tr class="permiso-cuatro" >
       ...
       <td class="fila-det-border"></td>
			...
			<%
		en = htMovimientosEntradaCancelarOK.keys();
		while (en.hasMoreElements()) {
			String key = (String) en.nextElement();
			String [] movimientos = (String []) htMovimientosEntradaCancelarOK.get(key);
						  %>
     <tr class="fila-det">
       <td height="22" class="fila-det-border">&nbsp;
         <input name="delKey" type="checkbox" id="delKey" value="<%= key %>" class="campo"></td>
       <td class="fila-det-border"> &nbsp;<%= key %>
       <input name="cc2" type="hidden" value="<%= movimientos[21] %>" class="campo" id="cc2" size="5" maxlength="10" readonly>
       ...
       <td class="fila-det-border">&nbsp;
				 <input name="chequenro" type="text" value="<%= movimientos[30] %>" class="campo" id="chequenro" size="10" maxlength="10" readonly></td>
       <td class="fila-det-border">&nbsp;
   ...
   <% 
    ...
    <input name="identificador" value="" type="hidden" >
   <%  
