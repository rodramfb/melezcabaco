...
public class UploadFicheroProObsequios extends HttpServlet {

	static Logger log = Logger.getLogger(UploadFicheroProObsequios.class);
	...
	public boolean procesaFicheros(HttpServletRequest request,
		...
		try {
			...
			props.load(UploadFicheroProObsequios.class
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			if (procesaFicheros(request, response)) {
				response
						.sendRedirect("../Clientes/bacoProObsequiosUploadFile.jsp?estadoUpload=true&mensaje="
								+ mensaje
								+ "&path="
								+ pathURL
								+ "&tipoArchivo="
				...
				response
						.sendRedirect("../Clientes/bacoProObsequiosUploadFile.jsp?estadoUpload=false&mensaje="
