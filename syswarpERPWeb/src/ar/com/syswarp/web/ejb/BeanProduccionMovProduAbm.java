...
public class BeanProduccionMovProduAbm implements SessionBean, Serializable {
	static Logger log = Logger.getLogger(BeanProduccionMovProduAbm.class);
	...
	public BeanProduccionMovProduAbm() {
		super();
	}
		...
		try {
			...
			if (this.accion.equalsIgnoreCase("modificacion")) {
				if (idop == null || idop.longValue() < 0) {
					...
					dispatcher = request
							.getRequestDispatcher("produccionMovProduFrm.jsp");
			...
			if (buscar) {
				...
				this.produccionMovProduList = produccionMovProdu
						.getProduccionMovProduAll(this.limit, this.offset,
								this.idempresa);
			}
