...
public class BeanConsultaPrecargaEstadosxVendedor implements SessionBean,
		Serializable {
	private SessionContext context;

	private BigDecimal idempresa = new BigDecimal(-1);

	static Logger log = Logger.getLogger(BeanConsultaPrecargaEstadosxVendedor.class);
	...
	public BeanConsultaPrecargaEstadosxVendedor() {
		super();
	}
	...
	public void ejecutarSentenciaDML() {
		try {
			...
			this.MovimientosList = Consulta.getClientesConsultaPrecargaVendedor( fdesde.toString() , fhasta.toString(),this.idvendedor,
					this.idempresa);
	...
	public boolean ejecutarValidacion() {
		try {
			...
			if (!this.validar.equalsIgnoreCase("")) {
				...
				if (this.idvendedor.compareTo(new BigDecimal(0)) == 0) {
					this.mensaje = "Ingrese un vendedor.";
					return false;
				}
