...
public class BeanConsultaVentasProductos implements SessionBean,
		Serializable {
	private SessionContext context;

	private BigDecimal idempresa = new BigDecimal(-1);

	static Logger log = Logger.getLogger(BeanConsultaVentasProductos.class);
	...
	public BeanConsultaVentasProductos() {
		super();
	}
	...
	public void ejecutarSentenciaDML() {   
		try {
			...
			if (this.accion.equalsIgnoreCase("consulta"))
              ...
              this.MovimientosList = Consulta.getClientesVentasporProductos(
