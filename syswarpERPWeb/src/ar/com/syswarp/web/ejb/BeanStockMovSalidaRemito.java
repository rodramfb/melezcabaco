...
public class BeanStockMovSalidaRemito implements SessionBean, Serializable {
	private SessionContext context;

	private BigDecimal idempresa = new BigDecimal(-1);

	static Logger log = Logger.getLogger(BeanStockMovSalidaRemito.class);
	...
	public BeanStockMovSalidaRemito() {
		super();
	}
