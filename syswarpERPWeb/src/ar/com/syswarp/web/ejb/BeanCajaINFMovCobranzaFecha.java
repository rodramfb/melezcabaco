...
public class BeanCajaINFMovCobranzaFecha implements SessionBean, Serializable {
	static Logger log = Logger.getLogger(BeanCajaINFMovCobranzaFecha.class);
	...
	private List cajaMovCobranzaFecha = new ArrayList();
	...
	public BeanCajaINFMovCobranzaFecha() {
		super();
	}
	...
	public boolean ejecutarValidacion() {
		...
		try {
			...
			if (!aceptar.equals("")) {
				...
				this.cajaMovCobranzaFecha = saldoFecha.getMovCobranzaFecha(
				...
				if (this.cajaMovCobranzaFecha.size() < 1)
	...
	public List getCajaMovCobranzaFecha() {
		return cajaMovCobranzaFecha;
	}

	public void setCajaMovCobranzaFecha(List cajaMovCobranzaFecha) {
		this.cajaMovCobranzaFecha = cajaMovCobranzaFecha;
	}
