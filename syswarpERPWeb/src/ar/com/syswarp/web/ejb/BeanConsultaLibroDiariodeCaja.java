...
public class BeanConsultaLibroDiariodeCaja implements SessionBean,
		Serializable {
	private SessionContext context;

	private BigDecimal idempresa = new BigDecimal(-1);

	static Logger log = Logger.getLogger(BeanConsultaLibroDiariodeCaja.class);
	...
	public BeanConsultaLibroDiariodeCaja() {
		super();
	}
	...
	public void ejecutarSentenciaDML() {
		try {
			Tesoreria Consulta = Common.getTesoreria();
			...
			this.MovimientosList = Consulta.getCosnultaLibroDiariodeCaja( fdesde.toString() , fhasta.toString(),
					this.idempresa);
