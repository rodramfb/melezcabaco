...
public class BeanProveedoresInformeComprasProveedores implements SessionBean, Serializable {
	private SessionContext context;

	private BigDecimal idempresa = new BigDecimal(-1);

	static Logger log = Logger.getLogger(BeanProveedoresInformeComprasProveedores.class);
	...
	public BeanProveedoresInformeComprasProveedores() {
		super();
	}
