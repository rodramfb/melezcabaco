...
public class BeanConsultaCumpleanioProspecto implements SessionBean,
		Serializable {
	private SessionContext context;

	private BigDecimal idempresa = new BigDecimal(-1);

	static Logger log = Logger.getLogger(BeanConsultaCumpleanioProspecto.class);
	...
	public BeanConsultaCumpleanioProspecto() {
		super();
	}
	...
	public void ejecutarSentenciaDML() {
		try {
			...
			this.MovimientosList = Consulta.getCosnultaCumpleanioProspecto(
					this.limit, this.offset, fdesde.toString() , fhasta.toString(),
					this.idempresa);
