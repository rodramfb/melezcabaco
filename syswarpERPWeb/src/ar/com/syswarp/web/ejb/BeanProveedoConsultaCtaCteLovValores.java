...
public class BeanProveedoConsultaCtaCteLovValores implements SessionBean, Serializable {
	...
	//20110817 - CAMI - Asientos contables para informe  de cta cte.-------->

	private BigDecimal nrocomprobante = new BigDecimal(-1);
	...
	public BeanProveedoConsultaCtaCteLovValores() {
		super();
	}
	...
	public boolean ejecutarValidacion() {
		...
		try {
			...
			if (!this.ocurrencia.trim().equalsIgnoreCase("")) {
				...
				this.stockdepositosList = proveedores.getProveedoConsultaCtaCteLovValoresAll(limit, offset, nrocomprobante, idempresa);
				if (this.stockdepositosList.size()<1)
				{
