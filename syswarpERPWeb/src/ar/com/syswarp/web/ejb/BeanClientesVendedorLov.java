...
public class BeanClientesVendedorLov implements SessionBean, Serializable {
	static Logger log = Logger.getLogger(BeanClientesVendedorLov.class);
	...
	public BeanClientesVendedorLov() {
		super();
	}
	...
	public boolean ejecutarValidacion() {
		...
		try {
			...
			if (buscar) {
				...
				this.totalRegistros = clientesvendedor.getTotalEntidadOcu(
						"clientesvendedor", campos, this.ocurrencia,
						this.idempresa);
