...
public class BeanGlobalgruposLov implements SessionBean, Serializable {
	static Logger log = Logger.getLogger(BeanGlobalgruposLov.class);
	...
	public boolean ejecutarValidacion() {
		...
		try {
			...
			if (buscar) {
				...
				this.totalRegistros = globalgrupo.getTotalEntidadOcu(
				...
				this.globalgrupoList = globalgrupo.getGlobalgrupoOcu(
						this.limit, this.offset, this.ocurrencia);
			} else {
				this.totalRegistros = globalgrupo
				...
				this.globalgrupoList = globalgrupo.getGlobalgrupoLovAll(
