...
public class BeanProveedorLov implements SessionBean, Serializable {
	static Logger log = Logger.getLogger(BeanProveedorLov.class);
	...
	public boolean ejecutarValidacion() {
		...
		Stock proveedores = Common.getStock();
		try {
			...
			if (buscar) {
				...
				this.proveedoresList = proveedores.getProveedoresOcu(
				...
				this.proveedoresList = proveedores.getProveedoresAll(
