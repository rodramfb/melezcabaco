...
public class BeanLovContableInfiPlanAbm implements SessionBean, Serializable {
	static Logger log = Logger.getLogger(BeanLovContableInfiPlanAbm.class);
	...
	public BeanLovContableInfiPlanAbm() {
		super();
	}
	...
	public boolean ejecutarValidacion() {
		...
		Tesoreria contableInfiPlan = Common.getTesoreria();
		try {
			...
			if (buscar) {
				...
				this.contableInfiPlanList = contableInfiPlan
						.getLovContableInfiPlanOcu(this.limit, this.offset,
				...
				this.contableInfiPlanList = contableInfiPlan
						.getLovContableInfiPlanAll(this.limit, this.offset,
