...
public class BeanCrmindividuosFrm implements SessionBean, Serializable {
	private SessionContext context;

	static Logger log = Logger.getLogger(BeanCrmindividuosFrm.class);
	...
	public void ejecutarSentenciaDML() {
		try {
			...
			if (this.accion.equalsIgnoreCase("alta"))
				this.mensaje = crmindividuos.crmindividuosCreate(
				...
				this.mensaje = crmindividuos.crmindividuosUpdate(
	...
	public void getDatosCrmindividuos() {
		try {
			CRM crmindividuos = Common.getCrm();
			List listCrmindividuos = crmindividuos.getCrmindividuosPK(
					this.idindividuos, this.idempresa);
	...
	public boolean ejecutarValidacion() {
		try {
			if (!this.volver.equalsIgnoreCase("")) {
				response.sendRedirect("crmindividuosAbm.jsp");
				return true;
			}
