...
public class BeanConsultadeProspectoEntrefechasXfechaingreso implements
	...
	static Logger log = Logger
			.getLogger(BeanConsultadeProspectoEntrefechasXfechaingreso.class);
	...
	public BeanConsultadeProspectoEntrefechasXfechaingreso() {
		super();
	}
	...
	public void ejecutarSentenciaDML() {
		try {
			...
			this.MovimientosList = Common.getGeneral()
					.getClientesConsultadePrecargaXFechaingreso(
							fdesde.toString(), fhasta.toString(), this.idtipoclie,
							this.idempresa);
	...
	public boolean ejecutarValidacion() {
		try {
			...
			this.listTipoClie = Common.getClientes().getClientestipoclieAll(500, 0,
					this.idempresa);
