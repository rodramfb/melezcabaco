...
public class BeanPedidosRegalosCliente implements SessionBean, Serializable {
	static Logger log = Logger.getLogger(BeanPedidosRegalosCliente.class);
	...
	public BeanPedidosRegalosCliente() {
		super();
	}
	...
	public boolean ejecutarValidacion() {
		...
		try {
			...
			String entidad = ""
					...
					+ "                 AND pc.idpedido_regalos_padre IS NULL ) pedidos";
			...
			if (buscar) {
				...
				this.pedidos_CabeList = pedidos_Cabe
						.getPedidosRegalosClienteOcu(this.limit, this.offset,
				...
				this.pedidos_CabeList = pedidos_Cabe
						.getPedidosRegalosClienteAll(this.limit, this.offset,
