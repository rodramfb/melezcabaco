...
public class BeanClientesCallReportes implements SessionBean, Serializable {
	static Logger log = Logger.getLogger(BeanClientesCallReportes.class);
	...
	public BeanClientesCallReportes() {
		super();
	}
