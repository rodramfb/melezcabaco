...
public class BeanProveedoConsultaCtaCte implements SessionBean, Serializable {
	private SessionContext context;

	private BigDecimal idempresa = new BigDecimal(-1);

	static Logger log = Logger.getLogger(BeanProveedoConsultaCtaCte.class);
	...
	public BeanProveedoConsultaCtaCte() {
		super();
	}
	...
	public void ejecutarSentenciaDML() {
		try {
			...
			this.MovimientosList = Consulta.getProveedoresCtaCteDetalle(
					this.idproveedordesde, this.tipo,
			...
			if (flag) {
				...
				if (this.tipo.equalsIgnoreCase("H")) {
					general.setArchivo(this.MovimientosList, new BigDecimal(
	...
	public boolean ejecutarValidacion() {
		try {
			...
			if (!this.accion.equalsIgnoreCase("")) {
				 ...
				 * this.dproveedorhasta.equalsIgnoreCase("")) { this.mensaje =
				 * "No se puede dejar vacio el campo Proveedor Hasta."; correcto
				 * = false; return false; } if
				 * (idproveedorhasta.compareTo(idproveedordesde)<0) {
				 * this.mensaje =
				 * "El proveedor desde debe ser mayor al proveedor hasta.";
	...
	/**
	 * public BigDecimal getIdproveedorhasta() { return idproveedorhasta; }
	 * 
	...
	/**
	 * public String getDproveedorhasta() { return dproveedorhasta; }
	 * 
