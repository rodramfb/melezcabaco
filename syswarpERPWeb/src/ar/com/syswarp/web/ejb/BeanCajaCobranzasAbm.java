...
public class BeanCajaCobranzasAbm implements SessionBean, Serializable {
	static Logger log = Logger.getLogger(BeanCajaCobranzasAbm.class);
	...
	public void ejecutarSentenciaDML() {
		try {
			...
			this.mensaje = cobranzas.cobranzasMovClienteCreate(idcliente,
					idcobrador, fechamovimiento, totalCobranza,
			...
			if (Common.esNumerico(this.mensaje)) {
				...
				*/
				...
				response
				.sendRedirect("impresionMovimientoTesoreria.jsp?comprobante="
						+ mensaje + "&plantillaImpresionJRXML=modelo.recibo" );
			}
	...
	public boolean ejecutarValidacion() {
		...
		try {
			...
			if (!this.confirmar.equals("")) {
				...
				if (this.totalCobranza.compareTo(this.totalIngresos) != 0) {
