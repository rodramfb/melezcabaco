...
public class BeanContableSumasSaldosRPT implements SessionBean, Serializable {
	static Logger log = Logger.getLogger(BeanContableSumasSaldosRPT.class);
	...
	public BeanContableSumasSaldosRPT() {
		super();
	}
	...
	public boolean ejecutarValidacion() {
		...
		try {
			...
			if (!this.validar.equals("")) {
				...
				} else if (this.mesHasta < this.mesDesde) {
			...
			if (buscar) {
				...
				String filtro = " WHERE ejercicio =  " + anio
				...
				this.listSaldoCuentas = contable.getSumasSaldos(this.anio,
						this.mesDesde, this.mesHasta, this.idempresa);
