...
public class BeanStockDesarmaProdEsquema implements SessionBean, Serializable {
	private SessionContext context;

	private BigDecimal idempresa = new BigDecimal(-1);

	static Logger log = Logger.getLogger(BeanStockDesarmaProdEsquema.class);
	...
	public BeanStockDesarmaProdEsquema() {
		super();
	}
	...
	public void ejecutarSentenciaDML() {
		try {
			...
			if (this.accion.equalsIgnoreCase("desarmar")) {
				...
				resultado = stock.callStockMovDesarmadoProductosEsquema(
