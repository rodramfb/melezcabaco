...
public class BeanClientesTipocompLov implements SessionBean, Serializable {
	static Logger log = Logger.getLogger(BeanClientesTipocompLov.class);
	...
	public BeanClientesTipocompLov() {
		super();
	}
		...
		try {
			...
			if (buscar) {
				...
				this.totalRegistros = clientestipocomp.getTotalEntidadOcu(
						"clientestipocomp", campos, this.ocurrencia,this.idempresa);
				...
				this.totalRegistros = clientestipocomp
						.getTotalEntidad("clientestipocomp",this.idempresa);
				this.totalPaginas = (this.totalRegistros / this.limit) + 1;
				if (this.totalPaginas < this.paginaSeleccion)
					this.paginaSeleccion = this.totalPaginas;
				this.offset = (this.paginaSeleccion - 1) * this.limit;
				...
				this.clientestipocompList = clientestipocomp
						.getClientestipocompAll(this.limit, this.offset,this.idempresa);
			}
