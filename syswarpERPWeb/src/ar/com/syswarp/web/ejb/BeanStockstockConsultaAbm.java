/* 
 ...
 Para manejar la pagina: StockstockConsultaAbm.jsp
...
public class BeanStockstockConsultaAbm implements SessionBean, Serializable {
	static Logger log = Logger.getLogger(BeanStockstockConsultaAbm.class);
	...
	public BeanStockstockConsultaAbm() {
		super();
	}
		...
		try {
			...
			if (this.accion.equalsIgnoreCase("modificacion")) {
				if (codigo_st == null) {
					...
					dispatcher = request
							.getRequestDispatcher("StockstockConsultaFrm.jsp");
					dispatcher.forward(request, response);
					return true;
				}
			}
			if (this.accion.equalsIgnoreCase("alta")) {
				dispatcher = request.getRequestDispatcher("StockstockConsultaFrm.jsp");
				dispatcher.forward(request, response);
				return true;
			}
