...
public class BeanStockstockConsultaFrm implements SessionBean, Serializable {
	private SessionContext context;

	private BigDecimal idempresa = new BigDecimal(-1);

	static Logger log = Logger.getLogger(BeanStockstockConsultaFrm.class);
	...
	public BeanStockstockConsultaFrm() {
		super();
	}
	...
	public boolean ejecutarValidacion() {
		try {
			if (!this.volver.equalsIgnoreCase("")) {
				response.sendRedirect("StockstockConsultaAbm.jsp");
				return true;
			}
